// BluefinPayconex SDK utility: fetcher - the default URLSession transport,
...
func defaultHttpFetch(_ fullurl: String, _ fetchdef: VMap) throws -> Value {
  ...
  if !hasUA {
    req.setValue("Mozilla/5.0 (compatible; BluefinPayconexSDK/1.0)", forHTTPHeaderField: "User-Agent")
  }
