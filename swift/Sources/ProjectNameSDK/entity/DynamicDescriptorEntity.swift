...
public final class DynamicDescriptorEntity: BluefinPayconexEntityBase {
  public init(_ client: BluefinPayconexSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "dynamic_descriptor")
  }

  public override func make() -> Entity {
    return DynamicDescriptorEntity(client, cloneOpts())
  }
