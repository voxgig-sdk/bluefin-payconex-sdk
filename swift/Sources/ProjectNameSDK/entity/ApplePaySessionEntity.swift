...
public final class ApplePaySessionEntity: BluefinPayconexEntityBase {
  public init(_ client: BluefinPayconexSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "apple_pay_session")
  }

  public override func make() -> Entity {
    return ApplePaySessionEntity(client, cloneOpts())
  }
