...
public final class ApplePayMerchantDetailEntity: BluefinPayconexEntityBase {
  public init(_ client: BluefinPayconexSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "apple_pay_merchant_detail")
  }

  public override func make() -> Entity {
    return ApplePayMerchantDetailEntity(client, cloneOpts())
  }
