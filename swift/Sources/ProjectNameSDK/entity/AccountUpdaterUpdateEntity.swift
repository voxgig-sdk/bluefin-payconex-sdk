...
public final class AccountUpdaterUpdateEntity: BluefinPayconexEntityBase {
  public init(_ client: BluefinPayconexSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "account_updater_update")
  }

  public override func make() -> Entity {
    return AccountUpdaterUpdateEntity(client, cloneOpts())
  }
