...
public final class ThreeDSecureStatusEntity: BluefinPayconexEntityBase {
  public init(_ client: BluefinPayconexSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "three_d_secure_status")
  }

  public override func make() -> Entity {
    return ThreeDSecureStatusEntity(client, cloneOpts())
  }
