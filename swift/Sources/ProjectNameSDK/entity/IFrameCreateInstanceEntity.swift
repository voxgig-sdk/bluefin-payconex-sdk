...
public final class IFrameCreateInstanceEntity: BluefinPayconexEntityBase {
  public init(_ client: BluefinPayconexSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "i_frame_create_instance")
  }

  public override func make() -> Entity {
    return IFrameCreateInstanceEntity(client, cloneOpts())
  }
