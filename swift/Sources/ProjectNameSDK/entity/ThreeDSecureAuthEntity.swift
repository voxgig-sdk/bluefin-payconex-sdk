...
public final class ThreeDSecureAuthEntity: BluefinPayconexEntityBase {
  public init(_ client: BluefinPayconexSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "three_d_secure_auth")
  }

  public override func make() -> Entity {
    return ThreeDSecureAuthEntity(client, cloneOpts())
  }
