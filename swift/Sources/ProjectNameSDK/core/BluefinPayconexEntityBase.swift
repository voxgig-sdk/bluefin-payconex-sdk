// BluefinPayconexEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinPayconexEntityBase: Entity {
  var name: String
  var client: BluefinPayconexSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinPayconexSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinPayconexEntityBase(client, cloneOpts(), name)
  }
