// BluefinPayconex SDK - operation context.
//
...
public final class Context {
  ...
  public var client: BluefinPayconexSDK?
  ...
  public init(_ ctxmap: [String: Any?]?, _ basectx: Context?) {
    ...
    // Client
    if let sdk = ctxProp(ctxmap, "client") as? BluefinPayconexSDK { client = sdk }
  ...
  public func makeError(_ code: String, _ msg: String) -> BluefinPayconexError {
