// list_api_key_scopes_entry direct API test (generated from the API model).

import XCTest

@testable import BluefinPayconexSdk

final class ListApiKeyScopesEntryDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/list_api_key_scopes_entry")
