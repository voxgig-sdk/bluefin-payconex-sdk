// account_updater_update direct API test (generated from the API model).

import XCTest

@testable import BluefinPayconexSdk

final class AccountUpdaterUpdateDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/account_updater_update")
