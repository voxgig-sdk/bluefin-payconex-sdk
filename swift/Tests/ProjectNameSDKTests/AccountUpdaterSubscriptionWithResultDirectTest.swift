// account_updater_subscription_with_result direct API test (generated from the API model).

import XCTest

@testable import BluefinPayconexSdk

final class AccountUpdaterSubscriptionWithResultDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinPayconexSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/account_updater_subscription_with_result")
