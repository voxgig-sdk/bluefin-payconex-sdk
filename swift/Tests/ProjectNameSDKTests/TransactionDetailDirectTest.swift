// transaction_detail direct API test (generated from the API model).

import XCTest

@testable import BluefinPayconexSdk

final class TransactionDetailDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/transaction_detail")
