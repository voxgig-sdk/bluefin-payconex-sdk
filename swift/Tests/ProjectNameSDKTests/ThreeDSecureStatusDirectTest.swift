// three_d_secure_status direct API test (generated from the API model).

import XCTest

@testable import BluefinPayconexSdk

final class ThreeDSecureStatusDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/three_d_secure_status")
