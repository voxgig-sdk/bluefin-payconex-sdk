// account_updater_schedule_with_result direct API test (generated from the API model).

import XCTest

@testable import BluefinPayconexSdk

final class AccountUpdaterScheduleWithResultDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/account_updater_schedule_with_result")
