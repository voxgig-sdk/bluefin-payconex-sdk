// apple_pay_merchant_detail direct API test (generated from the API model).

import XCTest

@testable import BluefinPayconexSdk

final class ApplePayMerchantDetailDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/apple_pay_merchant_detail")
