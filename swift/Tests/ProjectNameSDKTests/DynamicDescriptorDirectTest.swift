// dynamic_descriptor direct API test (generated from the API model).

import XCTest

@testable import BluefinPayconexSdk

final class DynamicDescriptorDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let args = VMap()
    args.entries["path"] = .string("/dynamic_descriptor")
