...
const testSeed = `map[string]any{"entity": map[string]any{"account_updater": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "account_updater_schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "account_updater_schedule_with_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "account_updater_subscription_with_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "account_updater_update": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "apple_pay_merchant_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "apple_pay_session": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dynamic_descriptor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "i_frame_create_instance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "i_frame_instance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "iframe": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "init": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list_api_key_scopes_entry": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "payment_iframe": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "three_d_secure_auth": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "three_d_secure_browser_init": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "three_d_secure_status": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transaction_detail": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
