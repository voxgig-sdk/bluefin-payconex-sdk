...
// BluefinPayconex SDK rbac feature
...
class BluefinPayconexRbacFeature extends BluefinPayconexBaseFeature
{
    ...
    private function _required(BluefinPayconexContext $ctx): ?string
    {
    ...
    private function _reject(BluefinPayconexContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinPayconexContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
