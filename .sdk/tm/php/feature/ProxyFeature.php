...
class BluefinPayconexProxyFeature extends BluefinPayconexBaseFeature
{
    ...
    public function init(BluefinPayconexContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinPayconexContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
