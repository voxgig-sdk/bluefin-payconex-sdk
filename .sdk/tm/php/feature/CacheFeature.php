...
// BluefinPayconex SDK cache feature
...
class BluefinPayconexCacheFeature extends BluefinPayconexBaseFeature
{
    ...
    private function _through(BluefinPayconexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
