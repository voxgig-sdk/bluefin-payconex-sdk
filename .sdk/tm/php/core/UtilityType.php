...
// BluefinPayconex SDK utility type

class BluefinPayconexUtility
{
    ...
    public static function copy(BluefinPayconexUtility $src): BluefinPayconexUtility
    {
        $u = new BluefinPayconexUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
