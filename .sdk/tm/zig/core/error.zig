// BluefinPayconexError: the SDK error type (mirrors go core/error.go / the rust
...
pub const BluefinPayconexError = struct {
    sdk: []const u8 = "BluefinPayconex",
    code: []const u8,
    msg: []const u8,
    ...
    pub fn make(code: []const u8, msg: []const u8) *BluefinPayconexError {
        const e = mem.a().create(BluefinPayconexError) catch unreachable;
        e.* = .{ .sdk = "BluefinPayconex", .code = code, .msg = msg };
        return e;
    }
};
