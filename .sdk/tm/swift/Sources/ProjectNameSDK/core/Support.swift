// BluefinPayconex SDK - shared value helpers for the loose object model.
//
...
// does not define.
func unsupportedOp(_ opname: String, _ entityname: String) -> BluefinPayconexError {
...
func errMessage(_ e: Error) -> String {
  if let se = e as? BluefinPayconexError { return se.message }
