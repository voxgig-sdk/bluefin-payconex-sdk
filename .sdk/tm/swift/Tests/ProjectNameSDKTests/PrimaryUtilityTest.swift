...
final class PrimaryUtilityTest: XCTestCase {
  ...
  private var client: BluefinPayconexSDK!
  private var utility: Utility!

  override func setUp() {
    super.setUp()
    primary = SdkRunner.loadPrimary()
    client = BluefinPayconexSDK.testSDK(nil, nil)
  ...
  private func makeTestCtx(_ client: BluefinPayconexSDK, _ utility: Utility,
  ...
  private func makeTestFullCtx(_ client: BluefinPayconexSDK, _ utility: Utility) -> Context {
  ...
  func testFeatureHookBasic() {
    let hookClient = BluefinPayconexSDK.testSDK(nil, nil)
  ...
  func testFeatureInitBasic() {
    let initClient = BluefinPayconexSDK.testSDK(nil, nil)
  ...
  func testFetcherLive() throws {
    ...
    let liveClient = BluefinPayconexSDK(opts)
  ...
  func testFetcherBlockedTestMode() {
    ...
    let opts = VMap()
    opts.entries["system"] = .map(vm(("fetch", .nat(fetch))))
    let blockedClient = BluefinPayconexSDK(opts)
  ...
  func testMakeSpecBasic() {
    ...
    let specClient = BluefinPayconexSDK.testSDK(nil, setupOpts)
  ...
  func testPrepareAuthBasic() {
    ...
    let authClient = BluefinPayconexSDK.testSDK(nil, setupOpts)
