...
using static BluefinPayconexSdk.Feature.FeatureOptions;

namespace BluefinPayconexSdk.Feature;

public class ClienttrackFeature : BaseFeature
{
    private BluefinPayconexSDK? _client;
    ...
    {
        var name = FoptStr(_options, "clientName", "BluefinPayconex-SDK");
