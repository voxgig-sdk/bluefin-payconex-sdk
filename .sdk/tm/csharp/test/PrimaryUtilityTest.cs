...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinPayconexSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinPayconexSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinPayconexSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinPayconexSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinPayconexSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinPayconexSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinPayconexSDK(new Dictionary<string, object?>
        {
            ["system"] = new Dictionary<string, object?>
            {
                ["fetch"] = (Func<string, Dictionary<string, object?>, Dictionary<string, object?>>)
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinPayconexSDK.TestSDK(null, setupOpts);
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinPayconexSDK.TestSDK(null, setupOpts);
