// Shared Value helpers for the BluefinPayconex SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinPayconexEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinPayconexError {
    BluefinPayconexError::new(
        "unsupported_op",
        &format!(
