...
impl Utility {
    ...
    pub fn done(&self, ctx: &Rc<Context>) -> Result<Value, BluefinPayconexError> {
    ...
    pub fn make_error(
        &self,
        ctx: &Rc<Context>,
        err: Option<BluefinPayconexError>,
    ) -> Result<Value, BluefinPayconexError> {
    ...
    pub fn make_fetch_def(&self, ctx: &Rc<Context>) -> Result<Value, BluefinPayconexError> {
    ...
    pub fn make_request(
        &self,
        ctx: &Rc<Context>,
    ) -> Result<Rc<RefCell<Response>>, BluefinPayconexError> {
    ...
    pub fn make_result(
        &self,
        ctx: &Rc<Context>,
    ) -> Result<Rc<RefCell<SdkResult>>, BluefinPayconexError> {
        u::make_result::make_result_util(ctx)
    }

    pub fn make_point(&self, ctx: &Rc<Context>) -> Result<Value, BluefinPayconexError> {
        u::make_point::make_point_util(ctx)
    }

    pub fn make_spec(&self, ctx: &Rc<Context>) -> Result<Rc<RefCell<Spec>>, BluefinPayconexError> {
        u::make_spec::make_spec_util(ctx)
    }

    pub fn make_url(&self, ctx: &Rc<Context>) -> Result<String, BluefinPayconexError> {
    ...
    pub fn prepare_auth(&self, ctx: &Rc<Context>) -> Result<Rc<RefCell<Spec>>, BluefinPayconexError> {
