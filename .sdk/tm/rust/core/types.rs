...
/// BluefinPayconexEntity: the full CRUD contract every generated entity
/// implements. Ops the API spec doesn't define are runtime-error stubs.
pub trait BluefinPayconexEntity: Entity {
...
pub type FetcherFn =
    Rc<dyn Fn(&Rc<Context>, &str, &Value) -> Result<Value, BluefinPayconexError>>;
