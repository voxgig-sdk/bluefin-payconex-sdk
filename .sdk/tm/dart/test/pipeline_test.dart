...
import '../lib/BluefinPayconexError.dart';
...
void tests() {
  ...
  describe('pipeline:makeRequest', () {
    ...
    test('an Error transport result is carried on the response', (t) async {
      final boom = BluefinPayconexError('boom', 'boom', null);
      final ctx = base({
    ...
    test('a fetchdef error surfaces as a response error', (t) async {
      final u = Utility();
      u.makeFetchDef = (dynamic c) => BluefinPayconexError('fetchdef_boom', 'boom', null);
      final ctx = base({
        'utility': u,
        'spec': {'step': 's', 'method': 'GET', 'headers': {}}
      });
