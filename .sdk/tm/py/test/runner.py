...
class BluefinPayconexTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = BluefinPayconexTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = BluefinPayconexTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = BluefinPayconexTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
