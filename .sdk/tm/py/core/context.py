...
from core.control import BluefinPayconexControl
...
class BluefinPayconexContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BluefinPayconexControl()
        ...
        if isinstance(sp, BluefinPayconexSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BluefinPayconexResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BluefinPayconexResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BluefinPayconexOperation({})
    ...
    def make_error(self, code, msg):
        return BluefinPayconexError(code, msg, self)
