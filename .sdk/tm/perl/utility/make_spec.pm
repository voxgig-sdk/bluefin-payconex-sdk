# BluefinPayconex SDK utility: make_spec
...
$REGISTRY{make_spec} = sub {
  ...
  my $base = BluefinPayconexHelpers::gp($options, 'base');
  $base = '' unless defined $base;
  my $prefix = BluefinPayconexHelpers::gp($options, 'prefix');
  $prefix = '' unless defined $prefix;
  my $suffix = BluefinPayconexHelpers::gp($options, 'suffix');
  $suffix = '' unless defined $suffix;

  my $parts = [];
  $parts = BluefinPayconexHelpers::gp($point, 'parts') if $point;
  ...
  my $allow_method = BluefinPayconexHelpers::gpath($options, 'allow.method');
