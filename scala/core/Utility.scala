...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefinpayconexsdk.utility.StructUtility.type = voxgig.bluefinpayconexsdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefinpayconexsdk.utility.Register.registerAll(this)
  }
