...
class ApplePaySessionEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("apple_pay_session", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ApplePaySessionEntity(this.client, opts)
  }
