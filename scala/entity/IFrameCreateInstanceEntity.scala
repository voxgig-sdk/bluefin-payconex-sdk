...
class IFrameCreateInstanceEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("i_frame_create_instance", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new IFrameCreateInstanceEntity(this.client, opts)
  }
