...
class TransactionDetailEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("transaction_detail", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new TransactionDetailEntity(this.client, opts)
  }
