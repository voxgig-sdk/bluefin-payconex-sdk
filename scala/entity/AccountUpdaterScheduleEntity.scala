...
class AccountUpdaterScheduleEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("account_updater_schedule", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new AccountUpdaterScheduleEntity(this.client, opts)
  }
