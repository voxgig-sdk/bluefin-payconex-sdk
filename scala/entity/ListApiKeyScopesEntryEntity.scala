...
class ListApiKeyScopesEntryEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("list_api_key_scopes_entry", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ListApiKeyScopesEntryEntity(this.client, opts)
  }
