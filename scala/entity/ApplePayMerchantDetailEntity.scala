...
class ApplePayMerchantDetailEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("apple_pay_merchant_detail", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ApplePayMerchantDetailEntity(this.client, opts)
  }
