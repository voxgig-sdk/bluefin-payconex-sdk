...
class AccountUpdaterEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("account_updater", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new AccountUpdaterEntity(this.client, opts)
  }
