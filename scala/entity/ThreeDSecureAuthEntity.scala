...
class ThreeDSecureAuthEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("three_d_secure_auth", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ThreeDSecureAuthEntity(this.client, opts)
  }
