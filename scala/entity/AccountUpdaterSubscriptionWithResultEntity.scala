...
class AccountUpdaterSubscriptionWithResultEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("account_updater_subscription_with_result", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new AccountUpdaterSubscriptionWithResultEntity(this.client, opts)
  }
