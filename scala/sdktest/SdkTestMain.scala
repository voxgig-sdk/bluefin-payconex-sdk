// Runtime test suite for the BluefinPayconex SDK — a dependency-free scala-cli
...
import voxgig.bluefinpayconexsdk.core._
import voxgig.bluefinpayconexsdk.feature._
...
object SdkTestMain {
  ...
  final class FhHarness {
    var client: BluefinPayconexSDK = null
