package voxgig.bluefinpayconexsdk.feature

import java.util.{LinkedHashMap, Map => JMap}
import java.util.concurrent.ThreadLocalRandom
import voxgig.bluefinpayconexsdk.core.{Context, SdkClient}
...
class ClienttrackFeature extends BaseFeature("clienttrack", "0.0.1", true) {
  ...
  private def agentName(): String = {
    val name = FeatureOptions.foptStr(this.options, "clientName", "BluefinPayconex-SDK")
