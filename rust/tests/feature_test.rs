...
use bluefin_payconex_sdk::core::helpers::{get_bool, get_str, getp, ja, jo, vfn};
use bluefin_payconex_sdk::feature::audit::AuditFeature;
use bluefin_payconex_sdk::feature::cache::CacheFeature;
use bluefin_payconex_sdk::feature::clienttrack::ClienttrackFeature;
use bluefin_payconex_sdk::feature::debug::DebugFeature;
use bluefin_payconex_sdk::feature::idempotency::IdempotencyFeature;
use bluefin_payconex_sdk::feature::metrics::MetricsFeature;
use bluefin_payconex_sdk::feature::netsim::NetsimFeature;
use bluefin_payconex_sdk::feature::paging::PagingFeature;
use bluefin_payconex_sdk::feature::proxy::ProxyFeature;
use bluefin_payconex_sdk::feature::ratelimit::RatelimitFeature;
use bluefin_payconex_sdk::feature::rbac::RbacFeature;
use bluefin_payconex_sdk::feature::retry::RetryFeature;
use bluefin_payconex_sdk::feature::streaming::StreamingFeature;
use bluefin_payconex_sdk::feature::telemetry::TelemetryFeature;
use bluefin_payconex_sdk::feature::timeout::TimeoutFeature;
use bluefin_payconex_sdk::utility::voxgigstruct as vs;
use bluefin_payconex_sdk::{Context, FeatureRef, Value};

fn fr<T: bluefin_payconex_sdk::Feature + 'static>(f: &Rc<RefCell<T>>) -> FeatureRef {
...
fn feature_retry_retries_transport_error_then_returns_it() {
    ...
    let nc = n.clone();
    let server: bluefin_payconex_sdk::FetcherFn = Rc::new(move |ctx: &Rc<Context>, _u, _f| {
        *nc.borrow_mut() += 1;
...
fn feature_retry_retries_nil_transport_result() {
    ...
    let n = Rc::new(RefCell::new(0));
    let nc = n.clone();
    let server: bluefin_payconex_sdk::FetcherFn = Rc::new(move |_c: &Rc<Context>, _u, _f| {
        *nc.borrow_mut() += 1;
        if *nc.borrow() < 2 {
            Ok(Value::Noval)
        } else {
...
fn feature_timeout_slow_request_times_out() {
    ...
    let server: bluefin_payconex_sdk::FetcherFn = Rc::new(|_c: &Rc<Context>, _u, _f| {
