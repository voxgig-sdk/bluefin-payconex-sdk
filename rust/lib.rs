// BluefinPayconex SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinPayconexError;
...
pub use crate::core::sdk::{test_sdk, BluefinPayconexSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinPayconexEntity,
};
...
// No-argument convenience constructors: `bluefin_payconex_sdk::new()` /
// `bluefin_payconex_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinPayconexSDK> {
    BluefinPayconexSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinPayconexSDK> {
