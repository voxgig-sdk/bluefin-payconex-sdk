// IFrameInstance entity client (generated — mirrors the go Entity fragment).
...
pub struct IFrameInstanceEntity {
    name: String,
    #[allow(dead_code)]
...
impl IFrameInstanceEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<IFrameInstanceEntity> {
        ...
        let e = Rc::new(IFrameInstanceEntity {
            name: "i_frame_instance".to_string(),
            client: client.clone(),
...
impl Entity for IFrameInstanceEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        IFrameInstanceEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for IFrameInstanceEntity {
