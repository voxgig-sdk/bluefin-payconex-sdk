// ThreeDSecureAuth entity client (generated — mirrors the go Entity fragment).
...
pub struct ThreeDSecureAuthEntity {
    name: String,
    #[allow(dead_code)]
...
impl ThreeDSecureAuthEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<ThreeDSecureAuthEntity> {
        ...
        let e = Rc::new(ThreeDSecureAuthEntity {
            name: "three_d_secure_auth".to_string(),
            client: client.clone(),
...
impl Entity for ThreeDSecureAuthEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ThreeDSecureAuthEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for ThreeDSecureAuthEntity {
