// AccountUpdaterScheduleWithResult entity client (generated — mirrors the go Entity fragment).
...
pub struct AccountUpdaterScheduleWithResultEntity {
    name: String,
    #[allow(dead_code)]
...
impl AccountUpdaterScheduleWithResultEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<AccountUpdaterScheduleWithResultEntity> {
        ...
        let e = Rc::new(AccountUpdaterScheduleWithResultEntity {
            name: "account_updater_schedule_with_result".to_string(),
            client: client.clone(),
...
impl Entity for AccountUpdaterScheduleWithResultEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        AccountUpdaterScheduleWithResultEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for AccountUpdaterScheduleWithResultEntity {
    fn load(&self, _reqmatch: Value, _ctrl: Value) -> Result<Value, BluefinPayconexError> {
        Err(crate::core::helpers::unsupported_op("load", &self.name))
    }


    fn list(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinPayconexError> {
        let ctx = self.utility.make_context(
            CtxSpec {
    ...
    fn update(&self, _reqdata: Value, _ctrl: Value) -> Result<Value, BluefinPayconexError> {
