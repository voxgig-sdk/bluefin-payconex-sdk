// ListApiKeyScopesEntry entity client (generated — mirrors the go Entity fragment).
...
pub struct ListApiKeyScopesEntryEntity {
    name: String,
    #[allow(dead_code)]
...
impl ListApiKeyScopesEntryEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<ListApiKeyScopesEntryEntity> {
        ...
        let e = Rc::new(ListApiKeyScopesEntryEntity {
            name: "list_api_key_scopes_entry".to_string(),
            client: client.clone(),
...
impl Entity for ListApiKeyScopesEntryEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ListApiKeyScopesEntryEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for ListApiKeyScopesEntryEntity {
    ...
    fn create(&self, _reqdata: Value, _ctrl: Value) -> Result<Value, BluefinPayconexError> {
