// PaymentIframe entity client (generated — mirrors the go Entity fragment).
...
pub struct PaymentIframeEntity {
    name: String,
    #[allow(dead_code)]
...
impl PaymentIframeEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<PaymentIframeEntity> {
        ...
        let e = Rc::new(PaymentIframeEntity {
            name: "payment_iframe".to_string(),
            client: client.clone(),
...
impl Entity for PaymentIframeEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        PaymentIframeEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for PaymentIframeEntity {
