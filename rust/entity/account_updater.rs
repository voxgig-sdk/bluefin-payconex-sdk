// AccountUpdater entity client (generated — mirrors the go Entity fragment).
...
pub struct AccountUpdaterEntity {
    name: String,
    #[allow(dead_code)]
...
impl AccountUpdaterEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<AccountUpdaterEntity> {
        ...
        let e = Rc::new(AccountUpdaterEntity {
            name: "account_updater".to_string(),
            client: client.clone(),
...
impl Entity for AccountUpdaterEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        AccountUpdaterEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for AccountUpdaterEntity {
