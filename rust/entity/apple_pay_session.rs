// ApplePaySession entity client (generated — mirrors the go Entity fragment).
...
pub struct ApplePaySessionEntity {
    name: String,
    #[allow(dead_code)]
...
impl ApplePaySessionEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<ApplePaySessionEntity> {
        ...
        let e = Rc::new(ApplePaySessionEntity {
            name: "apple_pay_session".to_string(),
            client: client.clone(),
...
impl Entity for ApplePaySessionEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ApplePaySessionEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for ApplePaySessionEntity {
