// DynamicDescriptor entity client (generated — mirrors the go Entity fragment).
...
pub struct DynamicDescriptorEntity {
    name: String,
    #[allow(dead_code)]
...
impl DynamicDescriptorEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<DynamicDescriptorEntity> {
        ...
        let e = Rc::new(DynamicDescriptorEntity {
            name: "dynamic_descriptor".to_string(),
            client: client.clone(),
...
impl Entity for DynamicDescriptorEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        DynamicDescriptorEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for DynamicDescriptorEntity {
    ...
    fn remove(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinPayconexError> {
        let ctx = self.utility.make_context(
            CtxSpec {
