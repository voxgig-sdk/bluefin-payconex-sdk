// AccountUpdaterUpdate entity client (generated — mirrors the go Entity fragment).
...
pub struct AccountUpdaterUpdateEntity {
    name: String,
    #[allow(dead_code)]
...
impl AccountUpdaterUpdateEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<AccountUpdaterUpdateEntity> {
        ...
        let e = Rc::new(AccountUpdaterUpdateEntity {
            name: "account_updater_update".to_string(),
            client: client.clone(),
...
impl Entity for AccountUpdaterUpdateEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        AccountUpdaterUpdateEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for AccountUpdaterUpdateEntity {
