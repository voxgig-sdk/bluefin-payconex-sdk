// ApiKey entity client (generated — mirrors the go Entity fragment).
...
impl ApiKeyEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<ApiKeyEntity> {
...
impl Entity for ApiKeyEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ApiKeyEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for ApiKeyEntity {
