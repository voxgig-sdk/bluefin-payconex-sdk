// AccountUpdaterSchedule entity client (generated — mirrors the go Entity fragment).
...
pub struct AccountUpdaterScheduleEntity {
    name: String,
    #[allow(dead_code)]
...
impl AccountUpdaterScheduleEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<AccountUpdaterScheduleEntity> {
        ...
        let e = Rc::new(AccountUpdaterScheduleEntity {
            name: "account_updater_schedule".to_string(),
            client: client.clone(),
...
impl Entity for AccountUpdaterScheduleEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        AccountUpdaterScheduleEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for AccountUpdaterScheduleEntity {
