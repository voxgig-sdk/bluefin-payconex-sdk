// ApplePayMerchantDetail entity client (generated — mirrors the go Entity fragment).
...
pub struct ApplePayMerchantDetailEntity {
    name: String,
    #[allow(dead_code)]
...
impl ApplePayMerchantDetailEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<ApplePayMerchantDetailEntity> {
        ...
        let e = Rc::new(ApplePayMerchantDetailEntity {
            name: "apple_pay_merchant_detail".to_string(),
            client: client.clone(),
...
impl Entity for ApplePayMerchantDetailEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ApplePayMerchantDetailEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for ApplePayMerchantDetailEntity {
