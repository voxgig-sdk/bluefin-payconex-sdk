// Webhook entity client (generated — mirrors the go Entity fragment).
...
impl WebhookEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<WebhookEntity> {
...
impl Entity for WebhookEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        WebhookEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for WebhookEntity {
