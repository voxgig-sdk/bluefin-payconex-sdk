// TransactionDetail entity client (generated — mirrors the go Entity fragment).
...
pub struct TransactionDetailEntity {
    name: String,
    #[allow(dead_code)]
...
impl TransactionDetailEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<TransactionDetailEntity> {
        ...
        let e = Rc::new(TransactionDetailEntity {
            name: "transaction_detail".to_string(),
            client: client.clone(),
...
impl Entity for TransactionDetailEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TransactionDetailEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for TransactionDetailEntity {
