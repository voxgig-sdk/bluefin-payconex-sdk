// IFrameCreateInstance entity client (generated — mirrors the go Entity fragment).
...
pub struct IFrameCreateInstanceEntity {
    name: String,
    #[allow(dead_code)]
...
impl IFrameCreateInstanceEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<IFrameCreateInstanceEntity> {
        ...
        let e = Rc::new(IFrameCreateInstanceEntity {
            name: "i_frame_create_instance".to_string(),
            client: client.clone(),
...
impl Entity for IFrameCreateInstanceEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        IFrameCreateInstanceEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for IFrameCreateInstanceEntity {
