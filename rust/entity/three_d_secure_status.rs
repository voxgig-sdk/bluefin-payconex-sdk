// ThreeDSecureStatus entity client (generated — mirrors the go Entity fragment).
...
pub struct ThreeDSecureStatusEntity {
    name: String,
    #[allow(dead_code)]
...
impl ThreeDSecureStatusEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<ThreeDSecureStatusEntity> {
        ...
        let e = Rc::new(ThreeDSecureStatusEntity {
            name: "three_d_secure_status".to_string(),
            client: client.clone(),
...
impl Entity for ThreeDSecureStatusEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ThreeDSecureStatusEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for ThreeDSecureStatusEntity {
