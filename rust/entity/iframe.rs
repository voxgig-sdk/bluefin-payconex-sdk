// Iframe entity client (generated — mirrors the go Entity fragment).
...
impl IframeEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<IframeEntity> {
...
impl Entity for IframeEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        IframeEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for IframeEntity {
