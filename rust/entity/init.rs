// Init entity client (generated — mirrors the go Entity fragment).
...
impl InitEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<InitEntity> {
...
impl Entity for InitEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        InitEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for InitEntity {
