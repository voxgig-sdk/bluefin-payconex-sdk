// ThreeDSecureBrowserInit entity client (generated — mirrors the go Entity fragment).
...
pub struct ThreeDSecureBrowserInitEntity {
    name: String,
    #[allow(dead_code)]
...
impl ThreeDSecureBrowserInitEntity {
    pub fn new(client: &Rc<BluefinPayconexSDK>, entopts: Value) -> Rc<ThreeDSecureBrowserInitEntity> {
        ...
        let e = Rc::new(ThreeDSecureBrowserInitEntity {
            name: "three_d_secure_browser_init".to_string(),
            client: client.clone(),
...
impl Entity for ThreeDSecureBrowserInitEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ThreeDSecureBrowserInitEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinPayconexEntity for ThreeDSecureBrowserInitEntity {
