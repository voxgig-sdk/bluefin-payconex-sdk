# BluefinPayconex SDK utility: transform_response
...
$REGISTRY{transform_response} = sub {
  ...
  my $resform = BluefinPayconexHelpers::gp($transform, 'res');
  return undef unless BluefinPayconexHelpers::rb_truthy($resform);
