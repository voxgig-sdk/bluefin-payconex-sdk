...
package AccountUpdaterSubscriptionWithResultEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'account_updater_subscription_with_result',
    _client => $client,
...
sub make {
  ...
  return AccountUpdaterSubscriptionWithResultEntity->new($self->{_client}, $opts);
}
...
# Returns the current AccountUpdaterSubscriptionWithResult data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of AccountUpdaterSubscriptionWithResult fields).
sub match_get {
  my ($self) = @_;
...
#
# reqmatch: match criteria hashref (id/query fields; AccountUpdaterSubscriptionWithResultLoadMatch
...
# Returns the loaded AccountUpdaterSubscriptionWithResult data (hashref); dies with BluefinPayconexError
# on failure.
sub load {
...
#
# reqdata: body data hashref (AccountUpdaterSubscriptionWithResultCreateData shape). ctrl: optional
# per-call control. Returns the created AccountUpdaterSubscriptionWithResult data (hashref); dies
...
#
# reqdata: body data hashref (AccountUpdaterSubscriptionWithResultUpdateData shape). ctrl: optional
# per-call control. Returns the updated AccountUpdaterSubscriptionWithResult data (hashref); dies
# with BluefinPayconexError on failure.
sub update {
  my ($self, $reqdata, $ctrl) = @_;
  my $utility = $self->{_utility};
