...
package AccountUpdaterScheduleWithResultEntity;
...
sub new {
  ...
  my $self = bless {
    _name => 'account_updater_schedule_with_result',
    _client => $client,
...
sub make {
  ...
  return AccountUpdaterScheduleWithResultEntity->new($self->{_client}, $opts);
}
...
# Returns the current AccountUpdaterScheduleWithResult data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of AccountUpdaterScheduleWithResult fields).
sub match_get {
  my ($self) = @_;
...
#
# reqmatch: match filter hashref (any subset of AccountUpdaterScheduleWithResult fields;
# AccountUpdaterScheduleWithResultListMatch shape); defaults to undef, treated as an empty match
# that lists all. ctrl: optional per-call control.
# Returns the matching AccountUpdaterScheduleWithResult items as an arrayref; dies with
...
#
# reqdata: body data hashref (AccountUpdaterScheduleWithResultCreateData shape). ctrl: optional
# per-call control. Returns the created AccountUpdaterScheduleWithResult data (hashref); dies
