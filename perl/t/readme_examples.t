#!perl
# BluefinPayconex SDK - documentation example COMPLETENESS gate.
#
...
#      (BluefinPayconexSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinPayconexSDK';
...
# becomes BluefinPayconexSDK->test(<fixtures>); a block that only uses $client gets
