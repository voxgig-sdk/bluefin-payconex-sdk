// Command BluefinPayconex-mcp is an MCP server exposing the BluefinPayconex
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinPayconex_list  — list records of an entity
//	BluefinPayconex_load  — load a single record of an entity
//
