...
class AccountUpdaterScheduleEntity
  ...
  def make
    opts = @_entopts.dup
    AccountUpdaterScheduleEntity.new(@_client, opts)
  end
  ...
  # @return [AccountUpdaterSchedule, Hash] the current AccountUpdaterSchedule data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AccountUpdaterSchedule fields)
  def match_get
  ...
  #
  # @param reqdata [AccountUpdaterScheduleCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AccountUpdaterSchedule, Hash] the created AccountUpdaterSchedule; raises BluefinPayconexError on failure
