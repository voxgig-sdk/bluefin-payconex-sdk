...
class ApplePaySessionEntity
  ...
  def make
    opts = @_entopts.dup
    ApplePaySessionEntity.new(@_client, opts)
  end
  ...
  # @return [ApplePaySession, Hash] the current ApplePaySession data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApplePaySession fields)
  def match_get
  ...
  #
  # @param reqdata [ApplePaySessionCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApplePaySession, Hash] the created ApplePaySession; raises BluefinPayconexError on failure
