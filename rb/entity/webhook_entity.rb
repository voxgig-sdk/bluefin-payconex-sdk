...
class WebhookEntity
  ...
  # @return [Webhook, Hash] the loaded Webhook; raises BluefinPayconexError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Webhook>, Array] the matching Webhook items; raises BluefinPayconexError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the created Webhook; raises BluefinPayconexError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the updated Webhook; raises BluefinPayconexError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Webhook, Hash] the removed Webhook; raises BluefinPayconexError on failure
