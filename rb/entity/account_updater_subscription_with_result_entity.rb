...
class AccountUpdaterSubscriptionWithResultEntity
  ...
  def make
    opts = @_entopts.dup
    AccountUpdaterSubscriptionWithResultEntity.new(@_client, opts)
  end
  ...
  # @return [AccountUpdaterSubscriptionWithResult, Hash] the current AccountUpdaterSubscriptionWithResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AccountUpdaterSubscriptionWithResult fields)
  def match_get
  ...
  #
  # @param reqmatch [AccountUpdaterSubscriptionWithResultLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.AccountUpdaterSubscriptionWithResult.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [AccountUpdaterSubscriptionWithResult, Hash] the loaded AccountUpdaterSubscriptionWithResult; raises BluefinPayconexError on failure
  ...
  #
  # @param reqdata [AccountUpdaterSubscriptionWithResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AccountUpdaterSubscriptionWithResult, Hash] the created AccountUpdaterSubscriptionWithResult; raises BluefinPayconexError on failure
  ...
  #
  # @param reqdata [AccountUpdaterSubscriptionWithResultUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AccountUpdaterSubscriptionWithResult, Hash] the updated AccountUpdaterSubscriptionWithResult; raises BluefinPayconexError on failure
