...
class AccountUpdaterUpdateEntity
  ...
  def make
    opts = @_entopts.dup
    AccountUpdaterUpdateEntity.new(@_client, opts)
  end
  ...
  # @return [AccountUpdaterUpdate, Hash] the current AccountUpdaterUpdate data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AccountUpdaterUpdate fields)
  def match_get
  ...
  #
  # @param reqmatch [AccountUpdaterUpdateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.AccountUpdaterUpdate.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [AccountUpdaterUpdate, Hash] the loaded AccountUpdaterUpdate; raises BluefinPayconexError on failure
