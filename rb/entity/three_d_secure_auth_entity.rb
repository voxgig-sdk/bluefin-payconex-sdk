...
class ThreeDSecureAuthEntity
  ...
  def make
    opts = @_entopts.dup
    ThreeDSecureAuthEntity.new(@_client, opts)
  end
  ...
  # @return [ThreeDSecureAuth, Hash] the current ThreeDSecureAuth data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ThreeDSecureAuth fields)
  def match_get
  ...
  #
  # @param reqdata [ThreeDSecureAuthCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ThreeDSecureAuth, Hash] the created ThreeDSecureAuth; raises BluefinPayconexError on failure
