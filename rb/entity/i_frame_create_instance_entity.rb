...
class IFrameCreateInstanceEntity
  ...
  def make
    opts = @_entopts.dup
    IFrameCreateInstanceEntity.new(@_client, opts)
  end
  ...
  # @return [IFrameCreateInstance, Hash] the current IFrameCreateInstance data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IFrameCreateInstance fields)
  def match_get
  ...
  #
  # @param reqdata [IFrameCreateInstanceCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [IFrameCreateInstance, Hash] the created IFrameCreateInstance; raises BluefinPayconexError on failure
