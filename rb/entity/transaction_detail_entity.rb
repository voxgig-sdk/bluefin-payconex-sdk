...
class TransactionDetailEntity
  ...
  def make
    opts = @_entopts.dup
    TransactionDetailEntity.new(@_client, opts)
  end
  ...
  # @return [TransactionDetail, Hash] the current TransactionDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of TransactionDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [TransactionDetailLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.TransactionDetail.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [TransactionDetail, Hash] the loaded TransactionDetail; raises BluefinPayconexError on failure
  ...
  #
  # @param reqdata [TransactionDetailUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [TransactionDetail, Hash] the updated TransactionDetail; raises BluefinPayconexError on failure
