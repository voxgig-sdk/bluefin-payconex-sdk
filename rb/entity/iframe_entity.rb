...
class IframeEntity
  ...
  # @return [Iframe, Hash] the current Iframe data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Iframe fields)
  def match_get
  ...
  #
  # @param reqmatch [IframeLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Iframe.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Iframe, Hash] the loaded Iframe; raises BluefinPayconexError on failure
  ...
  #
  # @param reqmatch [IframeListMatch, Hash, nil] match filter (any subset of
  #   Iframe fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Iframe>, Array] the matching Iframe items; raises BluefinPayconexError on failure
  ...
  # Create a new Iframe.
  #
  # @param reqdata [IframeCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Iframe, Hash] the created Iframe; raises BluefinPayconexError on failure
  ...
  #
  # @param reqdata [IframeUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Iframe, Hash] the updated Iframe; raises BluefinPayconexError on failure
