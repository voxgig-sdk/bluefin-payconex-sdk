...
class ThreeDSecureStatusEntity
  ...
  def make
    opts = @_entopts.dup
    ThreeDSecureStatusEntity.new(@_client, opts)
  end
  ...
  # @return [ThreeDSecureStatus, Hash] the current ThreeDSecureStatus data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ThreeDSecureStatus fields)
  def match_get
  ...
  #
  # @param reqmatch [ThreeDSecureStatusLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ThreeDSecureStatus.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ThreeDSecureStatus, Hash] the loaded ThreeDSecureStatus; raises BluefinPayconexError on failure
