...
class ApplePayMerchantDetailEntity
  ...
  def make
    opts = @_entopts.dup
    ApplePayMerchantDetailEntity.new(@_client, opts)
  end
  ...
  # @return [ApplePayMerchantDetail, Hash] the current ApplePayMerchantDetail data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ApplePayMerchantDetail fields)
  def match_get
  ...
  #
  # @param reqmatch [ApplePayMerchantDetailListMatch, Hash, nil] match filter (any subset of
  #   ApplePayMerchantDetail fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApplePayMerchantDetail>, Array] the matching ApplePayMerchantDetail items; raises BluefinPayconexError on failure
  ...
  #
  # @param reqdata [ApplePayMerchantDetailCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApplePayMerchantDetail, Hash] the created ApplePayMerchantDetail; raises BluefinPayconexError on failure
