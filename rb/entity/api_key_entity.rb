...
class ApiKeyEntity
  ...
  #
  # @param reqmatch [ApiKeyLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ApiKey.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiKey, Hash] the loaded ApiKey; raises BluefinPayconexError on failure
  ...
  #
  # @param reqmatch [ApiKeyListMatch, Hash, nil] match filter (any subset of
  #   ApiKey fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ApiKey>, Array] the matching ApiKey items; raises BluefinPayconexError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiKey, Hash] the created ApiKey; raises BluefinPayconexError on failure
  ...
  #
  # @param reqdata [ApiKeyUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiKey, Hash] the updated ApiKey; raises BluefinPayconexError on failure
  ...
  #
  # @param reqmatch [ApiKeyRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [ApiKey, Hash] the removed ApiKey; raises BluefinPayconexError on failure
