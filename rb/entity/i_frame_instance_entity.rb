...
class IFrameInstanceEntity
  ...
  def make
    opts = @_entopts.dup
    IFrameInstanceEntity.new(@_client, opts)
  end
  ...
  # @return [IFrameInstance, Hash] the current IFrameInstance data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of IFrameInstance fields)
  def match_get
  ...
  #
  # @param reqmatch [IFrameInstanceLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.IFrameInstance.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [IFrameInstance, Hash] the loaded IFrameInstance; raises BluefinPayconexError on failure
