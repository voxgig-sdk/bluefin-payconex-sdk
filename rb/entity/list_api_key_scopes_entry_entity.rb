...
class ListApiKeyScopesEntryEntity
  ...
  def make
    opts = @_entopts.dup
    ListApiKeyScopesEntryEntity.new(@_client, opts)
  end
  ...
  # @return [ListApiKeyScopesEntry, Hash] the current ListApiKeyScopesEntry data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ListApiKeyScopesEntry fields)
  def match_get
  ...
  #
  # @param reqmatch [ListApiKeyScopesEntryListMatch, Hash, nil] match filter (any subset of
  #   ListApiKeyScopesEntry fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ListApiKeyScopesEntry>, Array] the matching ListApiKeyScopesEntry items; raises BluefinPayconexError on failure
