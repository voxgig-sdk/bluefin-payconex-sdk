...
class ThreeDSecureBrowserInitEntity
  ...
  def make
    opts = @_entopts.dup
    ThreeDSecureBrowserInitEntity.new(@_client, opts)
  end
  ...
  # @return [ThreeDSecureBrowserInit, Hash] the current ThreeDSecureBrowserInit data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ThreeDSecureBrowserInit fields)
  def match_get
  ...
  #
  # @param reqdata [ThreeDSecureBrowserInitCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [ThreeDSecureBrowserInit, Hash] the created ThreeDSecureBrowserInit; raises BluefinPayconexError on failure
