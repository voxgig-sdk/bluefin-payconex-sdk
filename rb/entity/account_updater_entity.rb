...
class AccountUpdaterEntity
  ...
  def make
    opts = @_entopts.dup
    AccountUpdaterEntity.new(@_client, opts)
  end
  ...
  # @return [AccountUpdater, Hash] the current AccountUpdater data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AccountUpdater fields)
  def match_get
  ...
  #
  # @param reqmatch [AccountUpdaterRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [AccountUpdater, Hash] the removed AccountUpdater; raises BluefinPayconexError on failure
