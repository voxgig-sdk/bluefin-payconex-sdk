...
class PaymentIframeEntity
  ...
  def make
    opts = @_entopts.dup
    PaymentIframeEntity.new(@_client, opts)
  end
  ...
  # @return [PaymentIframe, Hash] the current PaymentIframe data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of PaymentIframe fields)
  def match_get
  ...
  #
  # @param reqmatch [PaymentIframeRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [PaymentIframe, Hash] the removed PaymentIframe; raises BluefinPayconexError on failure
