...
class AccountUpdaterScheduleWithResultEntity
  ...
  def make
    opts = @_entopts.dup
    AccountUpdaterScheduleWithResultEntity.new(@_client, opts)
  end
  ...
  # @return [AccountUpdaterScheduleWithResult, Hash] the current AccountUpdaterScheduleWithResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of AccountUpdaterScheduleWithResult fields)
  def match_get
  ...
  #
  # @param reqmatch [AccountUpdaterScheduleWithResultListMatch, Hash, nil] match filter (any subset of
  #   AccountUpdaterScheduleWithResult fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<AccountUpdaterScheduleWithResult>, Array] the matching AccountUpdaterScheduleWithResult items; raises BluefinPayconexError on failure
  ...
  #
  # @param reqdata [AccountUpdaterScheduleWithResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [AccountUpdaterScheduleWithResult, Hash] the created AccountUpdaterScheduleWithResult; raises BluefinPayconexError on failure
