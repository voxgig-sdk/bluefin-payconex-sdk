...
class InitEntity
  ...
  # @return [Init, Hash] the current Init data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Init fields)
  def match_get
  ...
  # Create a new Init.
  #
  # @param reqdata [InitCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Init, Hash] the created Init; raises BluefinPayconexError on failure
