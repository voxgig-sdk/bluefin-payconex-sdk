...
class WebhookEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BLUEFINPAYCONEX_TEST_WEBHOOK_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def webhook_basic_setup(extra)
  ...
  entid_env_raw = ENV["BLUEFINPAYCONEX_TEST_WEBHOOK_ENTID"]
