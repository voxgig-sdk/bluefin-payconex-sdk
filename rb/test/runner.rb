...
module BluefinPayconexTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("BLUEFINPAYCONEX_TEST_LIVE")
    override = getenv("BLUEFINPAYCONEX_TEST_OVERRIDE")
    ...
    explain = getenv("BLUEFINPAYCONEX_TEST_EXPLAIN")
    m["BLUEFINPAYCONEX_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = BluefinPayconexTestRunner
Helpers = BluefinPayconexHelpers
Vs = VoxgigStruct
