...
#      offline in seeded test mode (BluefinPayconexSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinPayconex_sdk.rb")
  SDK_CLASS = "BluefinPayconexSDK"
