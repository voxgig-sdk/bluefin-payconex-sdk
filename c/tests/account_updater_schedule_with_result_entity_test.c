// Generated instance test for the account_updater_schedule_with_result entity.
...
int main(void) {
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "account_updater_schedule_with_result",
        cmap(2,
  ...
  TEST_SUMMARY("account_updater_schedule_with_result_entity");
}
