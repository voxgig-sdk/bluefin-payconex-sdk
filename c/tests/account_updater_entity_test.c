...
int main(void) {
  ...
  Entity* e = bluefin_payconex_account_updater(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_account_updater(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = account_updater_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_account_updater(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = account_updater_stream(pe, "list", NULL, NULL, &perr);
