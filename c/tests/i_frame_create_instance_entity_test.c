...
int main(void) {
  ...
  Entity* e = bluefin_payconex_i_frame_create_instance(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "i_frame_create_instance",
        cmap(2,
    ...
    Entity* se = bluefin_payconex_i_frame_create_instance(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = i_frame_create_instance_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_i_frame_create_instance(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = i_frame_create_instance_stream(pe, "list", NULL, NULL, &perr);
