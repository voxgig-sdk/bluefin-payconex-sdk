// Generated direct-call test for the three_d_secure_status entity (mirrors the
...
static voxgig_value* three_d_secure_status_mock(void* ud, voxgig_value* args) {
  CALLS++;
...
static BluefinPayconexSDK* three_d_secure_status_direct_setup(voxgig_value* mockres) {
  voxgig_value* opts = cmap(2,
    "base", v_str("http://localhost:8080"),
    "system", cmap(1, "fetch", vfn(three_d_secure_status_mock, mockres)));
...
int main(void) {
  ...
  // LOAD
  {
    ...
    BluefinPayconexSDK* sdk = three_d_secure_status_direct_setup(mockres);
    voxgig_value* params = v_map();
    setp(params, "3_d_id", v_str("direct01"));
    setp(params, "account_id", v_str("direct02"));
    PNError* err = NULL;
    voxgig_value* result = sdk_direct(sdk, cmap(3,
      "path", v_str("api/v4/accounts/{account_id}/3DS/{3_d_id}/status"),
      "method", v_str("GET"),
      "params", params), &err);
  ...
  TEST_SUMMARY("bluefin_payconex_three_d_secure_status_direct");
}
