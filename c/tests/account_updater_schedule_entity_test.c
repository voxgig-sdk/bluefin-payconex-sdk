...
int main(void) {
  ...
  Entity* e = bluefin_payconex_account_updater_schedule(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "account_updater_schedule",
        cmap(2,
    ...
    Entity* se = bluefin_payconex_account_updater_schedule(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = account_updater_schedule_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_account_updater_schedule(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = account_updater_schedule_stream(pe, "list", NULL, NULL, &perr);
