...
static void test_primary_fetcher_live(void) {
  ...
  BluefinPayconexSDK* live = bluefinpayconex_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinPayconexSDK* blocked = bluefinpayconex_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinPayconexSDK* client = bluefinpayconex_sdk_new(v_undef());
