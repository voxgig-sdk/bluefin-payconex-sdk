...
int main(void) {
  ...
  Entity* e = bluefin_payconex_payment_iframe(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_payment_iframe(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = payment_iframe_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_payment_iframe(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = payment_iframe_stream(pe, "list", NULL, NULL, &perr);
