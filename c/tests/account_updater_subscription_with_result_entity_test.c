...
int main(void) {
  ...
  Entity* e = bluefin_payconex_account_updater_subscription_with_result(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    voxgig_value* seed = cmap(1, "entity",
      cmap(1, "account_updater_subscription_with_result",
        cmap(2,
    ...
    Entity* se = bluefin_payconex_account_updater_subscription_with_result(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = account_updater_subscription_with_result_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_account_updater_subscription_with_result(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = account_updater_subscription_with_result_stream(pe, "list", NULL, NULL, &perr);
