// Generated instance test for the three_d_secure_auth entity.
...
int main(void) {
  ...
  Entity* e = bluefin_payconex_three_d_secure_auth(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "three_d_secure_auth", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_three_d_secure_auth(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = three_d_secure_auth_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_three_d_secure_auth(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = three_d_secure_auth_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("three_d_secure_auth_entity");
}
