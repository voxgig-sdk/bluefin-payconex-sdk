// Behavioural feature-test harness for the BluefinPayconex SDK (C port of the
...
#ifndef BLUEFINPAYCONEX_FEATURE_HARNESS_H
#define BLUEFINPAYCONEX_FEATURE_HARNESS_H
...
#endif // BLUEFINPAYCONEX_FEATURE_HARNESS_H
