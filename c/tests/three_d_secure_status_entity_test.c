// Generated instance test for the three_d_secure_status entity.
...
int main(void) {
  ...
  Entity* e = bluefin_payconex_three_d_secure_status(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "three_d_secure_status", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_three_d_secure_status(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = three_d_secure_status_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_three_d_secure_status(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = three_d_secure_status_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("three_d_secure_status_entity");
}
