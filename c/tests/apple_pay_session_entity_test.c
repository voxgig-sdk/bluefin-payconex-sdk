...
int main(void) {
  ...
  Entity* e = bluefin_payconex_apple_pay_session(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_apple_pay_session(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = apple_pay_session_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_apple_pay_session(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = apple_pay_session_stream(pe, "list", NULL, NULL, &perr);
