...
int main(void) {
  ...
  Entity* e = bluefin_payconex_init(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_init(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = init_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_init(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = init_stream(pe, "list", NULL, NULL, &perr);
