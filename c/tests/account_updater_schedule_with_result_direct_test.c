// Generated direct-call test for the account_updater_schedule_with_result entity (mirrors the
...
static voxgig_value* account_updater_schedule_with_result_mock(void* ud, voxgig_value* args) {
  CALLS++;
...
static BluefinPayconexSDK* account_updater_schedule_with_result_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LIST
  {
    ...
    BluefinPayconexSDK* sdk = account_updater_schedule_with_result_direct_setup(mockres);
    voxgig_value* params = v_map();
    setp(params, "account_id", v_str("direct01"));
    setp(params, "schedule_id", v_str("direct02"));
    PNError* err = NULL;
    voxgig_value* result = sdk_direct(sdk, cmap(3,
      "path", v_str("api/v4/accounts/{account_id}/account-updater/schedules/{schedule_id}/results"),
      "method", v_str("GET"),
      "params", params), &err);
