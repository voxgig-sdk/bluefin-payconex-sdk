...
int main(void) {
  ...
  Entity* e = bluefin_payconex_transaction_detail(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_transaction_detail(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = transaction_detail_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_transaction_detail(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = transaction_detail_stream(pe, "list", NULL, NULL, &perr);
