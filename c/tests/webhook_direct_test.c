// Generated direct-call test for the webhook entity (mirrors the
...
static voxgig_value* webhook_mock(void* ud, voxgig_value* args) {
  CALLS++;
...
static BluefinPayconexSDK* webhook_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LOAD
  {
    ...
    PNError* err = NULL;
    voxgig_value* result = sdk_direct(sdk, cmap(3,
      "path", v_str("api/v4/accounts/{account_id}/webhooks/{id}"),
      "method", v_str("GET"),
      "params", params), &err);
