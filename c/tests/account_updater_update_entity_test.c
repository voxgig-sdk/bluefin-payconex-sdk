// Generated instance test for the account_updater_update entity.
...
int main(void) {
  ...
  Entity* e = bluefin_payconex_account_updater_update(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "account_updater_update", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_account_updater_update(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = account_updater_update_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_account_updater_update(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = account_updater_update_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("account_updater_update_entity");
}
