// Generated instance test for the api_key entity.
...
int main(void) {
  ...
  Entity* e = bluefin_payconex_api_key(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "api_key", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_api_key(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = api_key_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_api_key(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = api_key_stream(pe, "list", NULL, NULL, &perr);
