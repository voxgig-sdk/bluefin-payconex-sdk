// Generated instance test for the i_frame_instance entity.
...
int main(void) {
  ...
  Entity* e = bluefin_payconex_i_frame_instance(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "i_frame_instance", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_payconex_i_frame_instance(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = i_frame_instance_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_payconex_i_frame_instance(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = i_frame_instance_stream(pe, "list", NULL, NULL, &perr);
  ...
  TEST_SUMMARY("i_frame_instance_entity");
}
