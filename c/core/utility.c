...
// ---- SDK client-base generic helpers (Main.fragment BluefinPayconexSDK) -------
...
voxgig_value* sdk_options_map(BluefinPayconexSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinPayconexSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinPayconexSDK* sdk) { return sdk->rootctx; }
