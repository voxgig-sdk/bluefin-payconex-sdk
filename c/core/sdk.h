// BluefinPayconex SDK — umbrella runtime header (template; BluefinPayconex tokens
...
#ifndef BLUEFINPAYCONEX_SDK_H
#define BLUEFINPAYCONEX_SDK_H
...
typedef struct BluefinPayconexSDK BluefinPayconexSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinPayconexError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinPayconex"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinPayconexEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinPayconexEntity). On error set *err.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinPayconexSDK) — generic fields.
// ===========================================================================

struct BluefinPayconexSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinPayconexSDK* sdk, Feature* f);
void sdk_features_insert(BluefinPayconexSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinPayconexSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinPayconexSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinPayconexSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinPayconexSDK* sdk);
