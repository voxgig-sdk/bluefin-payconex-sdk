// DynamicDescriptor entity client (generated — mirrors the rust Entity fragment).
...
typedef struct dynamic_descriptor_entity {
  ...
  Context* entctx;
} dynamic_descriptor_entity;

typedef void (*dynamic_descriptor_postdone_fn)(dynamic_descriptor_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT dynamic_descriptor_VT;
static const char* dynamic_descriptor_get_name(Entity* e);
static Entity* dynamic_descriptor_make(Entity* e);
static voxgig_value* dynamic_descriptor_data(Entity* e, voxgig_value* args);
static voxgig_value* dynamic_descriptor_matchv(Entity* e, voxgig_value* args);
static voxgig_value* dynamic_descriptor_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* dynamic_descriptor_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* dynamic_descriptor_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* dynamic_descriptor_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* dynamic_descriptor_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* dynamic_descriptor_ent_ctx(dynamic_descriptor_entity* self) {
  return self->entctx;
}
...
Entity* dynamic_descriptor_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  dynamic_descriptor_entity* self = (dynamic_descriptor_entity*)calloc(1, sizeof(dynamic_descriptor_entity));
  self->base.vt = &dynamic_descriptor_VT;
  self->name = strdup("dynamic_descriptor");
  self->client = client;
...
static voxgig_value* dynamic_descriptor_run_op(dynamic_descriptor_entity* self, Context* ctx,
                                    dynamic_descriptor_postdone_fn post_done, PNError** err) {
...
voxgig_value* dynamic_descriptor_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  dynamic_descriptor_entity* self = (dynamic_descriptor_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, dynamic_descriptor_ent_ctx(self));
...
static const char* dynamic_descriptor_get_name(Entity* e) {
  return ((dynamic_descriptor_entity*)e)->name;
}
...
static Entity* dynamic_descriptor_make(Entity* e) {
  ...
  return dynamic_descriptor_entity_new(self->client, opts);
}
...
static voxgig_value* dynamic_descriptor_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(dynamic_descriptor_ent_ctx(self), "SetData");
  }
  feature_hook_util(dynamic_descriptor_ent_ctx(self), "GetData");
...
static voxgig_value* dynamic_descriptor_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(dynamic_descriptor_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(dynamic_descriptor_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void dynamic_descriptor_load_postdone(dynamic_descriptor_entity* self, Context* ctx) {
...
static voxgig_value* dynamic_descriptor_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, dynamic_descriptor_ent_ctx(self));
  return dynamic_descriptor_run_op(self, ctx, dynamic_descriptor_load_postdone, err);
}



static void dynamic_descriptor_list_postdone(dynamic_descriptor_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static voxgig_value* dynamic_descriptor_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, dynamic_descriptor_ent_ctx(self));
  return dynamic_descriptor_run_op(self, ctx, dynamic_descriptor_list_postdone, err);
}



static void dynamic_descriptor_create_postdone(dynamic_descriptor_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static voxgig_value* dynamic_descriptor_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, dynamic_descriptor_ent_ctx(self));
  return dynamic_descriptor_run_op(self, ctx, dynamic_descriptor_create_postdone, err);
}



static void dynamic_descriptor_update_postdone(dynamic_descriptor_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* dynamic_descriptor_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, dynamic_descriptor_ent_ctx(self));
  return dynamic_descriptor_run_op(self, ctx, dynamic_descriptor_update_postdone, err);
}



static void dynamic_descriptor_remove_postdone(dynamic_descriptor_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* dynamic_descriptor_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, dynamic_descriptor_ent_ctx(self));
  return dynamic_descriptor_run_op(self, ctx, dynamic_descriptor_remove_postdone, err);
}


static const EntityVT dynamic_descriptor_VT = {
  dynamic_descriptor_get_name,
  dynamic_descriptor_make,
  dynamic_descriptor_data,
  dynamic_descriptor_matchv,
  dynamic_descriptor_load,
  dynamic_descriptor_list,
  dynamic_descriptor_create,
  dynamic_descriptor_update,
  dynamic_descriptor_remove,
};
