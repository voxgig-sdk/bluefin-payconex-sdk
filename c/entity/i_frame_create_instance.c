// IFrameCreateInstance entity client (generated — mirrors the rust Entity fragment).
...
typedef struct i_frame_create_instance_entity {
  ...
  Context* entctx;
} i_frame_create_instance_entity;

typedef void (*i_frame_create_instance_postdone_fn)(i_frame_create_instance_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT i_frame_create_instance_VT;
static const char* i_frame_create_instance_get_name(Entity* e);
static Entity* i_frame_create_instance_make(Entity* e);
static voxgig_value* i_frame_create_instance_data(Entity* e, voxgig_value* args);
static voxgig_value* i_frame_create_instance_matchv(Entity* e, voxgig_value* args);
static voxgig_value* i_frame_create_instance_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* i_frame_create_instance_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* i_frame_create_instance_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* i_frame_create_instance_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* i_frame_create_instance_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* i_frame_create_instance_ent_ctx(i_frame_create_instance_entity* self) {
  return self->entctx;
}
...
Entity* i_frame_create_instance_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  i_frame_create_instance_entity* self = (i_frame_create_instance_entity*)calloc(1, sizeof(i_frame_create_instance_entity));
  self->base.vt = &i_frame_create_instance_VT;
  self->name = strdup("i_frame_create_instance");
  self->client = client;
...
static voxgig_value* i_frame_create_instance_run_op(i_frame_create_instance_entity* self, Context* ctx,
                                    i_frame_create_instance_postdone_fn post_done, PNError** err) {
...
voxgig_value* i_frame_create_instance_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  i_frame_create_instance_entity* self = (i_frame_create_instance_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, i_frame_create_instance_ent_ctx(self));
...
static const char* i_frame_create_instance_get_name(Entity* e) {
  return ((i_frame_create_instance_entity*)e)->name;
}
...
static Entity* i_frame_create_instance_make(Entity* e) {
  ...
  return i_frame_create_instance_entity_new(self->client, opts);
}
...
static voxgig_value* i_frame_create_instance_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(i_frame_create_instance_ent_ctx(self), "SetData");
  }
  feature_hook_util(i_frame_create_instance_ent_ctx(self), "GetData");
...
static voxgig_value* i_frame_create_instance_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(i_frame_create_instance_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(i_frame_create_instance_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* i_frame_create_instance_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "i_frame_create_instance");
  return NULL;
}

static voxgig_value* i_frame_create_instance_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "i_frame_create_instance");
  return NULL;
}


static void i_frame_create_instance_create_postdone(i_frame_create_instance_entity* self, Context* ctx) {
...
static voxgig_value* i_frame_create_instance_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, i_frame_create_instance_ent_ctx(self));
  return i_frame_create_instance_run_op(self, ctx, i_frame_create_instance_create_postdone, err);
}


static voxgig_value* i_frame_create_instance_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "i_frame_create_instance");
  return NULL;
}

static voxgig_value* i_frame_create_instance_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "i_frame_create_instance");
  return NULL;
}

static const EntityVT i_frame_create_instance_VT = {
  i_frame_create_instance_get_name,
  i_frame_create_instance_make,
  i_frame_create_instance_data,
  i_frame_create_instance_matchv,
  i_frame_create_instance_load,
  i_frame_create_instance_list,
  i_frame_create_instance_create,
  i_frame_create_instance_update,
  i_frame_create_instance_remove,
};
