// ListApiKeyScopesEntry entity client (generated — mirrors the rust Entity fragment).
...
typedef struct list_api_key_scopes_entry_entity {
  ...
  Context* entctx;
} list_api_key_scopes_entry_entity;

typedef void (*list_api_key_scopes_entry_postdone_fn)(list_api_key_scopes_entry_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT list_api_key_scopes_entry_VT;
static const char* list_api_key_scopes_entry_get_name(Entity* e);
static Entity* list_api_key_scopes_entry_make(Entity* e);
static voxgig_value* list_api_key_scopes_entry_data(Entity* e, voxgig_value* args);
static voxgig_value* list_api_key_scopes_entry_matchv(Entity* e, voxgig_value* args);
static voxgig_value* list_api_key_scopes_entry_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* list_api_key_scopes_entry_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* list_api_key_scopes_entry_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* list_api_key_scopes_entry_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* list_api_key_scopes_entry_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* list_api_key_scopes_entry_ent_ctx(list_api_key_scopes_entry_entity* self) {
  return self->entctx;
}
...
Entity* list_api_key_scopes_entry_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  list_api_key_scopes_entry_entity* self = (list_api_key_scopes_entry_entity*)calloc(1, sizeof(list_api_key_scopes_entry_entity));
  self->base.vt = &list_api_key_scopes_entry_VT;
  self->name = strdup("list_api_key_scopes_entry");
  self->client = client;
...
static voxgig_value* list_api_key_scopes_entry_run_op(list_api_key_scopes_entry_entity* self, Context* ctx,
                                    list_api_key_scopes_entry_postdone_fn post_done, PNError** err) {
...
voxgig_value* list_api_key_scopes_entry_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  list_api_key_scopes_entry_entity* self = (list_api_key_scopes_entry_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, list_api_key_scopes_entry_ent_ctx(self));
...
static const char* list_api_key_scopes_entry_get_name(Entity* e) {
  return ((list_api_key_scopes_entry_entity*)e)->name;
}
...
static Entity* list_api_key_scopes_entry_make(Entity* e) {
  ...
  return list_api_key_scopes_entry_entity_new(self->client, opts);
}
...
static voxgig_value* list_api_key_scopes_entry_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(list_api_key_scopes_entry_ent_ctx(self), "SetData");
  }
  feature_hook_util(list_api_key_scopes_entry_ent_ctx(self), "GetData");
...
static voxgig_value* list_api_key_scopes_entry_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(list_api_key_scopes_entry_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(list_api_key_scopes_entry_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* list_api_key_scopes_entry_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "list_api_key_scopes_entry");
  return NULL;
}


static void list_api_key_scopes_entry_list_postdone(list_api_key_scopes_entry_entity* self, Context* ctx) {
...
static voxgig_value* list_api_key_scopes_entry_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, list_api_key_scopes_entry_ent_ctx(self));
  return list_api_key_scopes_entry_run_op(self, ctx, list_api_key_scopes_entry_list_postdone, err);
}


static voxgig_value* list_api_key_scopes_entry_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "list_api_key_scopes_entry");
  return NULL;
}

static voxgig_value* list_api_key_scopes_entry_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "list_api_key_scopes_entry");
  return NULL;
}

static voxgig_value* list_api_key_scopes_entry_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "list_api_key_scopes_entry");
  return NULL;
}

static const EntityVT list_api_key_scopes_entry_VT = {
  list_api_key_scopes_entry_get_name,
  list_api_key_scopes_entry_make,
  list_api_key_scopes_entry_data,
  list_api_key_scopes_entry_matchv,
  list_api_key_scopes_entry_load,
  list_api_key_scopes_entry_list,
  list_api_key_scopes_entry_create,
  list_api_key_scopes_entry_update,
  list_api_key_scopes_entry_remove,
};
