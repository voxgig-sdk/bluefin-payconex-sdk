// TransactionDetail entity client (generated — mirrors the rust Entity fragment).
...
typedef struct transaction_detail_entity {
  ...
  Context* entctx;
} transaction_detail_entity;

typedef void (*transaction_detail_postdone_fn)(transaction_detail_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT transaction_detail_VT;
static const char* transaction_detail_get_name(Entity* e);
static Entity* transaction_detail_make(Entity* e);
static voxgig_value* transaction_detail_data(Entity* e, voxgig_value* args);
static voxgig_value* transaction_detail_matchv(Entity* e, voxgig_value* args);
static voxgig_value* transaction_detail_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* transaction_detail_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* transaction_detail_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* transaction_detail_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* transaction_detail_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* transaction_detail_ent_ctx(transaction_detail_entity* self) {
  return self->entctx;
}
...
Entity* transaction_detail_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  transaction_detail_entity* self = (transaction_detail_entity*)calloc(1, sizeof(transaction_detail_entity));
  self->base.vt = &transaction_detail_VT;
  self->name = strdup("transaction_detail");
  self->client = client;
...
static voxgig_value* transaction_detail_run_op(transaction_detail_entity* self, Context* ctx,
                                    transaction_detail_postdone_fn post_done, PNError** err) {
...
voxgig_value* transaction_detail_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  transaction_detail_entity* self = (transaction_detail_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, transaction_detail_ent_ctx(self));
...
static const char* transaction_detail_get_name(Entity* e) {
  return ((transaction_detail_entity*)e)->name;
}
...
static Entity* transaction_detail_make(Entity* e) {
  ...
  return transaction_detail_entity_new(self->client, opts);
}
...
static voxgig_value* transaction_detail_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(transaction_detail_ent_ctx(self), "SetData");
  }
  feature_hook_util(transaction_detail_ent_ctx(self), "GetData");
...
static voxgig_value* transaction_detail_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(transaction_detail_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(transaction_detail_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void transaction_detail_load_postdone(transaction_detail_entity* self, Context* ctx) {
...
static voxgig_value* transaction_detail_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, transaction_detail_ent_ctx(self));
  return transaction_detail_run_op(self, ctx, transaction_detail_load_postdone, err);
}


static voxgig_value* transaction_detail_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "transaction_detail");
  return NULL;
}

static voxgig_value* transaction_detail_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "transaction_detail");
  return NULL;
}


static void transaction_detail_update_postdone(transaction_detail_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* transaction_detail_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, transaction_detail_ent_ctx(self));
  return transaction_detail_run_op(self, ctx, transaction_detail_update_postdone, err);
}


static voxgig_value* transaction_detail_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "transaction_detail");
  return NULL;
}

static const EntityVT transaction_detail_VT = {
  transaction_detail_get_name,
  transaction_detail_make,
  transaction_detail_data,
  transaction_detail_matchv,
  transaction_detail_load,
  transaction_detail_list,
  transaction_detail_create,
  transaction_detail_update,
  transaction_detail_remove,
};
