// ThreeDSecureBrowserInit entity client (generated — mirrors the rust Entity fragment).
...
typedef struct three_d_secure_browser_init_entity {
  ...
  Context* entctx;
} three_d_secure_browser_init_entity;

typedef void (*three_d_secure_browser_init_postdone_fn)(three_d_secure_browser_init_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT three_d_secure_browser_init_VT;
static const char* three_d_secure_browser_init_get_name(Entity* e);
static Entity* three_d_secure_browser_init_make(Entity* e);
static voxgig_value* three_d_secure_browser_init_data(Entity* e, voxgig_value* args);
static voxgig_value* three_d_secure_browser_init_matchv(Entity* e, voxgig_value* args);
static voxgig_value* three_d_secure_browser_init_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* three_d_secure_browser_init_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* three_d_secure_browser_init_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* three_d_secure_browser_init_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* three_d_secure_browser_init_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* three_d_secure_browser_init_ent_ctx(three_d_secure_browser_init_entity* self) {
  return self->entctx;
}
...
Entity* three_d_secure_browser_init_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  three_d_secure_browser_init_entity* self = (three_d_secure_browser_init_entity*)calloc(1, sizeof(three_d_secure_browser_init_entity));
  self->base.vt = &three_d_secure_browser_init_VT;
  self->name = strdup("three_d_secure_browser_init");
  self->client = client;
...
static voxgig_value* three_d_secure_browser_init_run_op(three_d_secure_browser_init_entity* self, Context* ctx,
                                    three_d_secure_browser_init_postdone_fn post_done, PNError** err) {
...
voxgig_value* three_d_secure_browser_init_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  three_d_secure_browser_init_entity* self = (three_d_secure_browser_init_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, three_d_secure_browser_init_ent_ctx(self));
...
static const char* three_d_secure_browser_init_get_name(Entity* e) {
  return ((three_d_secure_browser_init_entity*)e)->name;
}
...
static Entity* three_d_secure_browser_init_make(Entity* e) {
  ...
  return three_d_secure_browser_init_entity_new(self->client, opts);
}
...
static voxgig_value* three_d_secure_browser_init_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(three_d_secure_browser_init_ent_ctx(self), "SetData");
  }
  feature_hook_util(three_d_secure_browser_init_ent_ctx(self), "GetData");
...
static voxgig_value* three_d_secure_browser_init_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(three_d_secure_browser_init_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(three_d_secure_browser_init_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* three_d_secure_browser_init_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "three_d_secure_browser_init");
  return NULL;
}

static voxgig_value* three_d_secure_browser_init_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "three_d_secure_browser_init");
  return NULL;
}


static void three_d_secure_browser_init_create_postdone(three_d_secure_browser_init_entity* self, Context* ctx) {
...
static voxgig_value* three_d_secure_browser_init_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, three_d_secure_browser_init_ent_ctx(self));
  return three_d_secure_browser_init_run_op(self, ctx, three_d_secure_browser_init_create_postdone, err);
}


static voxgig_value* three_d_secure_browser_init_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "three_d_secure_browser_init");
  return NULL;
}

static voxgig_value* three_d_secure_browser_init_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "three_d_secure_browser_init");
  return NULL;
}

static const EntityVT three_d_secure_browser_init_VT = {
  three_d_secure_browser_init_get_name,
  three_d_secure_browser_init_make,
  three_d_secure_browser_init_data,
  three_d_secure_browser_init_matchv,
  three_d_secure_browser_init_load,
  three_d_secure_browser_init_list,
  three_d_secure_browser_init_create,
  three_d_secure_browser_init_update,
  three_d_secure_browser_init_remove,
};
