// PaymentIframe entity client (generated — mirrors the rust Entity fragment).
...
typedef struct payment_iframe_entity {
  ...
  Context* entctx;
} payment_iframe_entity;

typedef void (*payment_iframe_postdone_fn)(payment_iframe_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT payment_iframe_VT;
static const char* payment_iframe_get_name(Entity* e);
static Entity* payment_iframe_make(Entity* e);
static voxgig_value* payment_iframe_data(Entity* e, voxgig_value* args);
static voxgig_value* payment_iframe_matchv(Entity* e, voxgig_value* args);
static voxgig_value* payment_iframe_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* payment_iframe_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* payment_iframe_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* payment_iframe_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* payment_iframe_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* payment_iframe_ent_ctx(payment_iframe_entity* self) {
  return self->entctx;
}
...
Entity* payment_iframe_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  payment_iframe_entity* self = (payment_iframe_entity*)calloc(1, sizeof(payment_iframe_entity));
  self->base.vt = &payment_iframe_VT;
  self->name = strdup("payment_iframe");
  self->client = client;
...
static voxgig_value* payment_iframe_run_op(payment_iframe_entity* self, Context* ctx,
                                    payment_iframe_postdone_fn post_done, PNError** err) {
...
voxgig_value* payment_iframe_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  payment_iframe_entity* self = (payment_iframe_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, payment_iframe_ent_ctx(self));
...
static const char* payment_iframe_get_name(Entity* e) {
  return ((payment_iframe_entity*)e)->name;
}
...
static Entity* payment_iframe_make(Entity* e) {
  ...
  return payment_iframe_entity_new(self->client, opts);
}
...
static voxgig_value* payment_iframe_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(payment_iframe_ent_ctx(self), "SetData");
  }
  feature_hook_util(payment_iframe_ent_ctx(self), "GetData");
...
static voxgig_value* payment_iframe_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(payment_iframe_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(payment_iframe_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* payment_iframe_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "payment_iframe");
  return NULL;
}

static voxgig_value* payment_iframe_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "payment_iframe");
  return NULL;
}

static voxgig_value* payment_iframe_create(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("create", "payment_iframe");
  return NULL;
}

static voxgig_value* payment_iframe_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "payment_iframe");
  return NULL;
}


static void payment_iframe_remove_postdone(payment_iframe_entity* self, Context* ctx) {
...
static voxgig_value* payment_iframe_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, payment_iframe_ent_ctx(self));
  return payment_iframe_run_op(self, ctx, payment_iframe_remove_postdone, err);
}


static const EntityVT payment_iframe_VT = {
  payment_iframe_get_name,
  payment_iframe_make,
  payment_iframe_data,
  payment_iframe_matchv,
  payment_iframe_load,
  payment_iframe_list,
  payment_iframe_create,
  payment_iframe_update,
  payment_iframe_remove,
};
