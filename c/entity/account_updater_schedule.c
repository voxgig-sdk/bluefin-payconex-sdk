// AccountUpdaterSchedule entity client (generated — mirrors the rust Entity fragment).
...
typedef struct account_updater_schedule_entity {
  ...
  Context* entctx;
} account_updater_schedule_entity;

typedef void (*account_updater_schedule_postdone_fn)(account_updater_schedule_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT account_updater_schedule_VT;
static const char* account_updater_schedule_get_name(Entity* e);
static Entity* account_updater_schedule_make(Entity* e);
static voxgig_value* account_updater_schedule_data(Entity* e, voxgig_value* args);
static voxgig_value* account_updater_schedule_matchv(Entity* e, voxgig_value* args);
static voxgig_value* account_updater_schedule_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* account_updater_schedule_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* account_updater_schedule_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* account_updater_schedule_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* account_updater_schedule_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* account_updater_schedule_ent_ctx(account_updater_schedule_entity* self) {
  return self->entctx;
}
...
Entity* account_updater_schedule_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  account_updater_schedule_entity* self = (account_updater_schedule_entity*)calloc(1, sizeof(account_updater_schedule_entity));
  self->base.vt = &account_updater_schedule_VT;
  self->name = strdup("account_updater_schedule");
  self->client = client;
...
static voxgig_value* account_updater_schedule_run_op(account_updater_schedule_entity* self, Context* ctx,
                                    account_updater_schedule_postdone_fn post_done, PNError** err) {
...
voxgig_value* account_updater_schedule_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  account_updater_schedule_entity* self = (account_updater_schedule_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, account_updater_schedule_ent_ctx(self));
...
static const char* account_updater_schedule_get_name(Entity* e) {
  return ((account_updater_schedule_entity*)e)->name;
}
...
static Entity* account_updater_schedule_make(Entity* e) {
  ...
  return account_updater_schedule_entity_new(self->client, opts);
}
...
static voxgig_value* account_updater_schedule_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(account_updater_schedule_ent_ctx(self), "SetData");
  }
  feature_hook_util(account_updater_schedule_ent_ctx(self), "GetData");
...
static voxgig_value* account_updater_schedule_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(account_updater_schedule_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(account_updater_schedule_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* account_updater_schedule_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "account_updater_schedule");
  return NULL;
}

static voxgig_value* account_updater_schedule_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "account_updater_schedule");
  return NULL;
}


static void account_updater_schedule_create_postdone(account_updater_schedule_entity* self, Context* ctx) {
...
static voxgig_value* account_updater_schedule_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, account_updater_schedule_ent_ctx(self));
  return account_updater_schedule_run_op(self, ctx, account_updater_schedule_create_postdone, err);
}


static voxgig_value* account_updater_schedule_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "account_updater_schedule");
  return NULL;
}

static voxgig_value* account_updater_schedule_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "account_updater_schedule");
  return NULL;
}

static const EntityVT account_updater_schedule_VT = {
  account_updater_schedule_get_name,
  account_updater_schedule_make,
  account_updater_schedule_data,
  account_updater_schedule_matchv,
  account_updater_schedule_load,
  account_updater_schedule_list,
  account_updater_schedule_create,
  account_updater_schedule_update,
  account_updater_schedule_remove,
};
