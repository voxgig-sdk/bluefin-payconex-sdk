// ApiKey entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*api_key_postdone_fn)(api_key_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT api_key_VT;
static const char* api_key_get_name(Entity* e);
static Entity* api_key_make(Entity* e);
static voxgig_value* api_key_data(Entity* e, voxgig_value* args);
static voxgig_value* api_key_matchv(Entity* e, voxgig_value* args);
static voxgig_value* api_key_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* api_key_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* api_key_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* api_key_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* api_key_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* api_key_ent_ctx(api_key_entity* self) {
  return self->entctx;
}
...
Entity* api_key_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  api_key_entity* self = (api_key_entity*)calloc(1, sizeof(api_key_entity));
  self->base.vt = &api_key_VT;
  self->name = strdup("api_key");
  self->client = client;
...
static voxgig_value* api_key_run_op(api_key_entity* self, Context* ctx,
                                    api_key_postdone_fn post_done, PNError** err) {
...
voxgig_value* api_key_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  api_key_entity* self = (api_key_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, api_key_ent_ctx(self));
...
static Entity* api_key_make(Entity* e) {
  ...
  return api_key_entity_new(self->client, opts);
}
...
static voxgig_value* api_key_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(api_key_ent_ctx(self), "SetData");
  }
  feature_hook_util(api_key_ent_ctx(self), "GetData");
...
static voxgig_value* api_key_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(api_key_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(api_key_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void api_key_load_postdone(api_key_entity* self, Context* ctx) {
...
static voxgig_value* api_key_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, api_key_ent_ctx(self));
  return api_key_run_op(self, ctx, api_key_load_postdone, err);
}



static void api_key_list_postdone(api_key_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static voxgig_value* api_key_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, api_key_ent_ctx(self));
  return api_key_run_op(self, ctx, api_key_list_postdone, err);
}



static void api_key_create_postdone(api_key_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static voxgig_value* api_key_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, api_key_ent_ctx(self));
  return api_key_run_op(self, ctx, api_key_create_postdone, err);
}



static void api_key_update_postdone(api_key_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* api_key_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, api_key_ent_ctx(self));
  return api_key_run_op(self, ctx, api_key_update_postdone, err);
}



static void api_key_remove_postdone(api_key_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* api_key_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, api_key_ent_ctx(self));
  return api_key_run_op(self, ctx, api_key_remove_postdone, err);
}
