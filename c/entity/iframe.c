// Iframe entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*iframe_postdone_fn)(iframe_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT iframe_VT;
static const char* iframe_get_name(Entity* e);
static Entity* iframe_make(Entity* e);
static voxgig_value* iframe_data(Entity* e, voxgig_value* args);
static voxgig_value* iframe_matchv(Entity* e, voxgig_value* args);
static voxgig_value* iframe_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* iframe_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* iframe_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* iframe_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* iframe_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* iframe_ent_ctx(iframe_entity* self) {
  return self->entctx;
}
...
Entity* iframe_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  iframe_entity* self = (iframe_entity*)calloc(1, sizeof(iframe_entity));
  self->base.vt = &iframe_VT;
  self->name = strdup("iframe");
  self->client = client;
...
static voxgig_value* iframe_run_op(iframe_entity* self, Context* ctx,
                                    iframe_postdone_fn post_done, PNError** err) {
...
voxgig_value* iframe_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  iframe_entity* self = (iframe_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, iframe_ent_ctx(self));
...
static Entity* iframe_make(Entity* e) {
  ...
  return iframe_entity_new(self->client, opts);
}
...
static voxgig_value* iframe_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(iframe_ent_ctx(self), "SetData");
  }
  feature_hook_util(iframe_ent_ctx(self), "GetData");
...
static voxgig_value* iframe_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(iframe_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(iframe_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void iframe_load_postdone(iframe_entity* self, Context* ctx) {
...
static voxgig_value* iframe_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, iframe_ent_ctx(self));
  return iframe_run_op(self, ctx, iframe_load_postdone, err);
}



static void iframe_list_postdone(iframe_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static voxgig_value* iframe_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, iframe_ent_ctx(self));
  return iframe_run_op(self, ctx, iframe_list_postdone, err);
}



static void iframe_create_postdone(iframe_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static voxgig_value* iframe_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, iframe_ent_ctx(self));
  return iframe_run_op(self, ctx, iframe_create_postdone, err);
}



static void iframe_update_postdone(iframe_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* iframe_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, iframe_ent_ctx(self));
  return iframe_run_op(self, ctx, iframe_update_postdone, err);
}


static voxgig_value* iframe_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "iframe");
  return NULL;
}
