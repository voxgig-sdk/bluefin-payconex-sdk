// Webhook entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*webhook_postdone_fn)(webhook_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT webhook_VT;
static const char* webhook_get_name(Entity* e);
static Entity* webhook_make(Entity* e);
static voxgig_value* webhook_data(Entity* e, voxgig_value* args);
static voxgig_value* webhook_matchv(Entity* e, voxgig_value* args);
static voxgig_value* webhook_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* webhook_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* webhook_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* webhook_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* webhook_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* webhook_ent_ctx(webhook_entity* self) {
  return self->entctx;
}
...
Entity* webhook_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  webhook_entity* self = (webhook_entity*)calloc(1, sizeof(webhook_entity));
  self->base.vt = &webhook_VT;
  self->name = strdup("webhook");
  self->client = client;
...
static voxgig_value* webhook_run_op(webhook_entity* self, Context* ctx,
                                    webhook_postdone_fn post_done, PNError** err) {
...
voxgig_value* webhook_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  webhook_entity* self = (webhook_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, webhook_ent_ctx(self));
...
static Entity* webhook_make(Entity* e) {
  ...
  return webhook_entity_new(self->client, opts);
}
...
static voxgig_value* webhook_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(webhook_ent_ctx(self), "SetData");
  }
  feature_hook_util(webhook_ent_ctx(self), "GetData");
...
static voxgig_value* webhook_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(webhook_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(webhook_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void webhook_load_postdone(webhook_entity* self, Context* ctx) {
...
static voxgig_value* webhook_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, webhook_ent_ctx(self));
  return webhook_run_op(self, ctx, webhook_load_postdone, err);
}



static void webhook_list_postdone(webhook_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static voxgig_value* webhook_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, webhook_ent_ctx(self));
  return webhook_run_op(self, ctx, webhook_list_postdone, err);
}



static void webhook_create_postdone(webhook_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static voxgig_value* webhook_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, webhook_ent_ctx(self));
  return webhook_run_op(self, ctx, webhook_create_postdone, err);
}



static void webhook_update_postdone(webhook_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* webhook_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, webhook_ent_ctx(self));
  return webhook_run_op(self, ctx, webhook_update_postdone, err);
}



static void webhook_remove_postdone(webhook_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* webhook_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, webhook_ent_ctx(self));
  return webhook_run_op(self, ctx, webhook_remove_postdone, err);
}
