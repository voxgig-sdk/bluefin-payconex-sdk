// Init entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*init_postdone_fn)(init_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT init_VT;
static const char* init_get_name(Entity* e);
static Entity* init_make(Entity* e);
static voxgig_value* init_data(Entity* e, voxgig_value* args);
static voxgig_value* init_matchv(Entity* e, voxgig_value* args);
static voxgig_value* init_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* init_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* init_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* init_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* init_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* init_ent_ctx(init_entity* self) {
  return self->entctx;
}
...
Entity* init_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  init_entity* self = (init_entity*)calloc(1, sizeof(init_entity));
  self->base.vt = &init_VT;
  self->name = strdup("init");
  self->client = client;
...
static voxgig_value* init_run_op(init_entity* self, Context* ctx,
                                    init_postdone_fn post_done, PNError** err) {
...
voxgig_value* init_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  init_entity* self = (init_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, init_ent_ctx(self));
...
static Entity* init_make(Entity* e) {
  ...
  return init_entity_new(self->client, opts);
}
...
static voxgig_value* init_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(init_ent_ctx(self), "SetData");
  }
  feature_hook_util(init_ent_ctx(self), "GetData");
...
static voxgig_value* init_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(init_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(init_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* init_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "init");
  return NULL;
}

static voxgig_value* init_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "init");
  return NULL;
}


static void init_create_postdone(init_entity* self, Context* ctx) {
...
static voxgig_value* init_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, init_ent_ctx(self));
  return init_run_op(self, ctx, init_create_postdone, err);
}


static voxgig_value* init_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "init");
  return NULL;
}

static voxgig_value* init_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "init");
  return NULL;
}
