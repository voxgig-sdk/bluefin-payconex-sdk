// ApplePaySession entity client (generated — mirrors the rust Entity fragment).
...
typedef struct apple_pay_session_entity {
  ...
  Context* entctx;
} apple_pay_session_entity;

typedef void (*apple_pay_session_postdone_fn)(apple_pay_session_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT apple_pay_session_VT;
static const char* apple_pay_session_get_name(Entity* e);
static Entity* apple_pay_session_make(Entity* e);
static voxgig_value* apple_pay_session_data(Entity* e, voxgig_value* args);
static voxgig_value* apple_pay_session_matchv(Entity* e, voxgig_value* args);
static voxgig_value* apple_pay_session_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* apple_pay_session_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* apple_pay_session_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* apple_pay_session_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* apple_pay_session_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* apple_pay_session_ent_ctx(apple_pay_session_entity* self) {
  return self->entctx;
}
...
Entity* apple_pay_session_entity_new(BluefinPayconexSDK* client, voxgig_value* entopts) {
  ...
  apple_pay_session_entity* self = (apple_pay_session_entity*)calloc(1, sizeof(apple_pay_session_entity));
  self->base.vt = &apple_pay_session_VT;
  self->name = strdup("apple_pay_session");
  self->client = client;
...
static voxgig_value* apple_pay_session_run_op(apple_pay_session_entity* self, Context* ctx,
                                    apple_pay_session_postdone_fn post_done, PNError** err) {
...
voxgig_value* apple_pay_session_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  apple_pay_session_entity* self = (apple_pay_session_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, apple_pay_session_ent_ctx(self));
...
static const char* apple_pay_session_get_name(Entity* e) {
  return ((apple_pay_session_entity*)e)->name;
}
...
static Entity* apple_pay_session_make(Entity* e) {
  ...
  return apple_pay_session_entity_new(self->client, opts);
}
...
static voxgig_value* apple_pay_session_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(apple_pay_session_ent_ctx(self), "SetData");
  }
  feature_hook_util(apple_pay_session_ent_ctx(self), "GetData");
...
static voxgig_value* apple_pay_session_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(apple_pay_session_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(apple_pay_session_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* apple_pay_session_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "apple_pay_session");
  return NULL;
}

static voxgig_value* apple_pay_session_list(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("list", "apple_pay_session");
  return NULL;
}


static void apple_pay_session_create_postdone(apple_pay_session_entity* self, Context* ctx) {
...
static voxgig_value* apple_pay_session_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, apple_pay_session_ent_ctx(self));
  return apple_pay_session_run_op(self, ctx, apple_pay_session_create_postdone, err);
}


static voxgig_value* apple_pay_session_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "apple_pay_session");
  return NULL;
}

static voxgig_value* apple_pay_session_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "apple_pay_session");
  return NULL;
}

static const EntityVT apple_pay_session_VT = {
  apple_pay_session_get_name,
  apple_pay_session_make,
  apple_pay_session_data,
  apple_pay_session_matchv,
  apple_pay_session_load,
  apple_pay_session_list,
  apple_pay_session_create,
  apple_pay_session_update,
  apple_pay_session_remove,
};
