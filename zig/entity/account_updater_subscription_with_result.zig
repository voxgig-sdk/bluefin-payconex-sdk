// AccountUpdaterSubscriptionWithResult entity client (generated — mirrors the go/rust Entity fragment).
...
pub const AccountUpdaterSubscriptionWithResultEntity = struct {
    name: []const u8 = "account_updater_subscription_with_result",
    ...
    pub fn new(client: *sdk.BluefinPayconexSDK, entopts_in: Value) *AccountUpdaterSubscriptionWithResultEntity {
        ...
        const e = h.A().create(AccountUpdaterSubscriptionWithResultEntity) catch unreachable;
        e.* = .{
    ...
    fn ent_ctx(self: *AccountUpdaterSubscriptionWithResultEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *AccountUpdaterSubscriptionWithResultEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *AccountUpdaterSubscriptionWithResultEntity, ctx: *Context) OpResult {
        const v = self.utility.done(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn run_op(self: *AccountUpdaterSubscriptionWithResultEntity, ctx: *Context, post_done: *const fn (*AccountUpdaterSubscriptionWithResultEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *AccountUpdaterSubscriptionWithResultEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *AccountUpdaterSubscriptionWithResultEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return AccountUpdaterSubscriptionWithResultEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *AccountUpdaterSubscriptionWithResultEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *AccountUpdaterSubscriptionWithResultEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *AccountUpdaterSubscriptionWithResultEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *AccountUpdaterSubscriptionWithResultEntity, reqmatch: Value, ctrl: Value) OpResult {
    ...
    fn load_post_done(self: *AccountUpdaterSubscriptionWithResultEntity, ctx: *Context) void {
    ...
    pub fn create(self: *AccountUpdaterSubscriptionWithResultEntity, reqdata: Value, ctrl: Value) OpResult {
        const ctx = self.utility.make_context(CtxSpec{
            .opname = "create",
            .ctrl = ctrl,
            .mtch = self.mtch,
    ...
    fn create_post_done(self: *AccountUpdaterSubscriptionWithResultEntity, ctx: *Context) void {
        if (ctx.result) |result| {
            const resdata = result.resdata;
            if (!h.is_noval(resdata)) {
                const cm = h.to_map(h.clone(resdata));
    ...
    pub fn update(self: *AccountUpdaterSubscriptionWithResultEntity, reqdata: Value, ctrl: Value) OpResult {
        const ctx = self.utility.make_context(CtxSpec{
            .opname = "update",
            .ctrl = ctrl,
            .mtch = self.mtch,
    ...
    fn update_post_done(self: *AccountUpdaterSubscriptionWithResultEntity, ctx: *Context) void {
        if (ctx.result) |result| {
            const resmatch = result.resmatch;
            const resdata = result.resdata;
            if (resmatch == .object) self.mtch = resmatch;
