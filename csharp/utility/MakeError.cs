// BluefinPayconex SDK utility: makeError - the single error surface of the
// pipeline. Throws the wrapped BluefinPayconexError unless the per-call ctrl
// disables throwing (ctrl.throw == false), in which case it returns the
// (possibly nil) result data instead.

namespace BluefinPayconexSdk.Util;
...
public static partial class SdkUtility
{
    internal static object? MakeErrorUtil(Context ctx, Exception? err)
    {
        ...
        var msg = "BluefinPayconexSDK: " + opname + ": " + errmsg;
        ...
        var sdkErr = new BluefinPayconexError(
            err is BluefinPayconexError se ? se.Code : "", msg, ctx)
        {
