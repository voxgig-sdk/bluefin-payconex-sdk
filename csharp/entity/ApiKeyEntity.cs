// ApiKey entity client for the BluefinPayconex SDK.

using Voxgig.Struct;

namespace BluefinPayconexSdk.Entity;

public class ApiKeyEntity : BluefinPayconexEntityBase
{
    public ApiKeyEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "api_key")
    {
    }

    public override IEntity Make()
    {
        return new ApiKeyEntity(client, CloneOpts());
    }
