// AccountUpdaterUpdate entity client for the BluefinPayconex SDK.

using Voxgig.Struct;

namespace BluefinPayconexSdk.Entity;

public class AccountUpdaterUpdateEntity : BluefinPayconexEntityBase
{
    public AccountUpdaterUpdateEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "account_updater_update")
    {
    }

    public override IEntity Make()
    {
        return new AccountUpdaterUpdateEntity(client, CloneOpts());
    }
