// IFrameInstance entity client for the BluefinPayconex SDK.

using Voxgig.Struct;

namespace BluefinPayconexSdk.Entity;

public class IFrameInstanceEntity : BluefinPayconexEntityBase
{
    public IFrameInstanceEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "i_frame_instance")
    {
    }

    public override IEntity Make()
    {
        return new IFrameInstanceEntity(client, CloneOpts());
    }
