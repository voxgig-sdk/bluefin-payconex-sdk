...
public class ThreeDSecureAuthEntity : BluefinPayconexEntityBase
{
    public ThreeDSecureAuthEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "three_d_secure_auth")
    {
    }

    public override IEntity Make()
    {
        return new ThreeDSecureAuthEntity(client, CloneOpts());
    }
