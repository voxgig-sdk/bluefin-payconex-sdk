...
public class WebhookEntity : BluefinPayconexEntityBase
{
    public WebhookEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "webhook")
    {
    }

    public override IEntity Make()
    {
        return new WebhookEntity(client, CloneOpts());
    }
