...
public class TransactionDetailEntity : BluefinPayconexEntityBase
{
    public TransactionDetailEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "transaction_detail")
    {
    }

    public override IEntity Make()
    {
        return new TransactionDetailEntity(client, CloneOpts());
    }
