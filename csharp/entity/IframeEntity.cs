...
public class IframeEntity : BluefinPayconexEntityBase
{
    public IframeEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "iframe")
    {
    }

    public override IEntity Make()
    {
        return new IframeEntity(client, CloneOpts());
    }
