...
public class InitEntity : BluefinPayconexEntityBase
{
    public InitEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "init")
    {
    }

    public override IEntity Make()
    {
        return new InitEntity(client, CloneOpts());
    }
