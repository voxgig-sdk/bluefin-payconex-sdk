...
public class ThreeDSecureBrowserInitEntity : BluefinPayconexEntityBase
{
    public ThreeDSecureBrowserInitEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "three_d_secure_browser_init")
    {
    }

    public override IEntity Make()
    {
        return new ThreeDSecureBrowserInitEntity(client, CloneOpts());
    }
