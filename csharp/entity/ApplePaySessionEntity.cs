...
public class ApplePaySessionEntity : BluefinPayconexEntityBase
{
    public ApplePaySessionEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "apple_pay_session")
    {
    }

    public override IEntity Make()
    {
        return new ApplePaySessionEntity(client, CloneOpts());
    }
