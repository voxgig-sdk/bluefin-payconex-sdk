...
public class AccountUpdaterSubscriptionWithResultEntity : BluefinPayconexEntityBase
{
    public AccountUpdaterSubscriptionWithResultEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "account_updater_subscription_with_result")
    {
    }

    public override IEntity Make()
    {
        return new AccountUpdaterSubscriptionWithResultEntity(client, CloneOpts());
    }
