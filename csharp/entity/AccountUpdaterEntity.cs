...
public class AccountUpdaterEntity : BluefinPayconexEntityBase
{
    public AccountUpdaterEntity(BluefinPayconexSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "account_updater")
    {
    }

    public override IEntity Make()
    {
        return new AccountUpdaterEntity(client, CloneOpts());
    }
