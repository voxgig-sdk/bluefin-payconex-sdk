// BluefinPayconex SDK test runner - shared infrastructure for the generated
...
public static class TestRunner
{
    ...
    {
        if (Environment.GetEnvironmentVariable("BLUEFINPAYCONEX_TEST_LIVE") == "TRUE" ||
            Environment.GetEnvironmentVariable("BLUEFINPAYCONEX_TEST_OVERRIDE") == "TRUE")
        {
        ...
        var explain = Environment.GetEnvironmentVariable("BLUEFINPAYCONEX_TEST_EXPLAIN");
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinPayconexSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
    ...
    public static Context MakeCtxFromMap(Dictionary<string, object?>? ctxmap,
        BluefinPayconexSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinPayconexError("", msg, null);
            }
        }
    ...
    public static void FixCtx(Context ctx, BluefinPayconexSDK client)
    {
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinPayconexError(code, msg, null);
    }
