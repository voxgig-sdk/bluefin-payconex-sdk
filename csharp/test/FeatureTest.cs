...
internal static class Fh
{
    ...
    {
        return err is BluefinPayconexError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinPayconexSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinPayconexSdk.Helpers.ToInt(paging["totalCount"]));
