// i_frame_instance direct API tests (generated from the API model).
...
public class IFrameInstanceDirectTest
{
    ...
    {
        var setup = IFrameInstanceDirectSetup(
            new Dictionary<string, object?> { ["id"] = "direct01" });
        var _mode = setup.Live ? "live" : "unit";
        var (_shouldSkip, _) = TestRunner.IsControlSkipped(
            "direct", "direct-load-i_frame_instance", _mode);
        if (_shouldSkip)
        {
        ...
        if (setup.Live)
        {
            ...
            pathParams["id"] = "ifri_2a08d8fc30b64a8a9d8b9f0ec37b59c9";
            pathParams["payment_iframe_id"] = "ifr_2a08d8fc30b64a8a9d8b9f0ec37b59c9";
        }
        else
        {
            pathParams["account_id"] = "direct01";
            pathParams["id"] = "direct02";
            pathParams["payment_iframe_id"] = "direct03";
        }
    ...
    private class IFrameInstanceDirectSetupResult
    {
    ...
    private static IFrameInstanceDirectSetupResult IFrameInstanceDirectSetup(object? mockres)
    {
        ...
        {
            ["BLUEFINPAYCONEX_TEST_I_FRAME_INSTANCE_ENTID"] = new Dictionary<string, object?>(),
        ...
        if (live)
        {
            ...
            var entidRaw = env["BLUEFINPAYCONEX_TEST_I_FRAME_INSTANCE_ENTID"];
            ...
            return new IFrameInstanceDirectSetupResult
            {
                Client = liveClient,
                Calls = calls,
                Live = true,
