...
public abstract class BluefinPayconexEntityBase : IEntity
{
    protected string name;
    protected BluefinPayconexSDK client;
    ...
    protected BluefinPayconexEntityBase(BluefinPayconexSDK client,
