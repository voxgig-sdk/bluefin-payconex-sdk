;; BluefinPayconex SDK AccountUpdater entity (generated by @voxgig/sdkgen).
(ns sdk.entity.account_updater
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "account_updater" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "account_updater")
...
;; Canonical facade: (AccountUpdater client data) accessor delegates here.
...
;; Remove an AccountUpdater matching the criteria (reqmatch: id/query fields).
