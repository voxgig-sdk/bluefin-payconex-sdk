;; BluefinPayconex SDK PaymentIframe entity (generated by @voxgig/sdkgen).
(ns sdk.entity.payment_iframe
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "payment_iframe" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "payment_iframe")
...
;; Canonical facade: (PaymentIframe client data) accessor delegates here.
...
;; Remove an PaymentIframe matching the criteria (reqmatch: id/query fields).
