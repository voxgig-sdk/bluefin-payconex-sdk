;; BluefinPayconex SDK TransactionDetail entity (generated by @voxgig/sdkgen).
(ns sdk.entity.transaction_detail
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "transaction_detail" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "transaction_detail")
...
;; Canonical facade: (TransactionDetail client data) accessor delegates here.
...
;; Load a single TransactionDetail (reqmatch: id/query fields; nil = empty match).
...
;; Update an existing TransactionDetail (reqdata: body data).
