;; BluefinPayconex SDK AccountUpdaterScheduleWithResult entity (generated by @voxgig/sdkgen).
(ns sdk.entity.account_updater_schedule_with_result
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "account_updater_schedule_with_result" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "account_updater_schedule_with_result")
...
;; Canonical facade: (AccountUpdaterScheduleWithResult client data) accessor delegates here.
...
;; List AccountUpdaterScheduleWithResult items matching a filter (reqmatch: any subset of fields).
...
;; Create a new AccountUpdaterScheduleWithResult (reqdata: body data).
