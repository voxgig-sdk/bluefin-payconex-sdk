;; BluefinPayconex SDK IFrameInstance entity (generated by @voxgig/sdkgen).
(ns sdk.entity.i_frame_instance
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "i_frame_instance" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "i_frame_instance")
...
;; Canonical facade: (IFrameInstance client data) accessor delegates here.
...
;; Load a single IFrameInstance (reqmatch: id/query fields; nil = empty match).
