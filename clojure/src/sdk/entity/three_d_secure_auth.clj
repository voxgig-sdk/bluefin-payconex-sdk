...
(ns sdk.entity.three_d_secure_auth
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "three_d_secure_auth" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "three_d_secure_auth")
...
;; Canonical facade: (ThreeDSecureAuth client data) accessor delegates here.
...
;; Create a new ThreeDSecureAuth (reqdata: body data).
