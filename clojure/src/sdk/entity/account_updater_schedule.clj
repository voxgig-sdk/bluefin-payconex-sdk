...
(ns sdk.entity.account_updater_schedule
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "account_updater_schedule" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "account_updater_schedule")
...
;; Canonical facade: (AccountUpdaterSchedule client data) accessor delegates here.
...
;; Create a new AccountUpdaterSchedule (reqdata: body data).
