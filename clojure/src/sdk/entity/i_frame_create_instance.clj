...
(ns sdk.entity.i_frame_create_instance
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "i_frame_create_instance" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "i_frame_create_instance")
...
;; Canonical facade: (IFrameCreateInstance client data) accessor delegates here.
...
;; Create a new IFrameCreateInstance (reqdata: body data).
