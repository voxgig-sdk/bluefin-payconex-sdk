;; BluefinPayconex SDK ApplePayMerchantDetail entity (generated by @voxgig/sdkgen).
(ns sdk.entity.apple_pay_merchant_detail
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "apple_pay_merchant_detail" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "apple_pay_merchant_detail")
...
;; Canonical facade: (ApplePayMerchantDetail client data) accessor delegates here.
...
;; List ApplePayMerchantDetail items matching a filter (reqmatch: any subset of fields).
...
;; Create a new ApplePayMerchantDetail (reqdata: body data).
