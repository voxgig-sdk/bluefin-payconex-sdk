;; BluefinPayconex SDK AccountUpdaterSubscriptionWithResult entity (generated by @voxgig/sdkgen).
(ns sdk.entity.account_updater_subscription_with_result
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "account_updater_subscription_with_result" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "account_updater_subscription_with_result")
...
;; Canonical facade: (AccountUpdaterSubscriptionWithResult client data) accessor delegates here.
...
;; Load a single AccountUpdaterSubscriptionWithResult (reqmatch: id/query fields; nil = empty match).
...
;; Create a new AccountUpdaterSubscriptionWithResult (reqdata: body data).
...
;; Update an existing AccountUpdaterSubscriptionWithResult (reqdata: body data).
