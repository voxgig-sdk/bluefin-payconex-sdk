...
(ns sdk.entity.three_d_secure_browser_init
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "three_d_secure_browser_init" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "three_d_secure_browser_init")
...
;; Canonical facade: (ThreeDSecureBrowserInit client data) accessor delegates here.
...
;; Create a new ThreeDSecureBrowserInit (reqdata: body data).
