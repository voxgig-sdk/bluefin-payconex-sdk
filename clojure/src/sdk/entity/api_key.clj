;; BluefinPayconex SDK ApiKey entity (generated by @voxgig/sdkgen).
(ns sdk.entity.api_key
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "api_key" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (ApiKey client data) accessor delegates here.
...
;; Load a single ApiKey (reqmatch: id/query fields; nil = empty match).
...
;; List ApiKey items matching a filter (reqmatch: any subset of fields).
...
;; Create a new ApiKey (reqdata: body data).
...
;; Update an existing ApiKey (reqdata: body data).
...
;; Remove an ApiKey matching the criteria (reqmatch: id/query fields).
