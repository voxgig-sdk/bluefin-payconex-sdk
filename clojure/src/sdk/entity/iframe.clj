;; BluefinPayconex SDK Iframe entity (generated by @voxgig/sdkgen).
(ns sdk.entity.iframe
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "iframe" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Iframe client data) accessor delegates here.
...
;; Load a single Iframe (reqmatch: id/query fields; nil = empty match).
...
;; List Iframe items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Iframe (reqdata: body data).
...
;; Update an existing Iframe (reqdata: body data).
