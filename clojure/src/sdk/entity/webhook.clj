;; BluefinPayconex SDK Webhook entity (generated by @voxgig/sdkgen).
(ns sdk.entity.webhook
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "webhook" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Webhook client data) accessor delegates here.
...
;; Load a single Webhook (reqmatch: id/query fields; nil = empty match).
...
;; List Webhook items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Webhook (reqdata: body data).
...
;; Update an existing Webhook (reqdata: body data).
...
;; Remove an Webhook matching the criteria (reqmatch: id/query fields).
