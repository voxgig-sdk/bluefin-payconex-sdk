;; BluefinPayconex SDK ThreeDSecureStatus entity (generated by @voxgig/sdkgen).
(ns sdk.entity.three_d_secure_status
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "three_d_secure_status" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "three_d_secure_status")
...
;; Canonical facade: (ThreeDSecureStatus client data) accessor delegates here.
...
;; Load a single ThreeDSecureStatus (reqmatch: id/query fields; nil = empty match).
