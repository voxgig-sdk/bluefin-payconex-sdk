;; BluefinPayconex SDK ListApiKeyScopesEntry entity (generated by @voxgig/sdkgen).
(ns sdk.entity.list_api_key_scopes_entry
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "list_api_key_scopes_entry" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "list_api_key_scopes_entry")
...
;; Canonical facade: (ListApiKeyScopesEntry client data) accessor delegates here.
...
;; List ListApiKeyScopesEntry items matching a filter (reqmatch: any subset of fields).
