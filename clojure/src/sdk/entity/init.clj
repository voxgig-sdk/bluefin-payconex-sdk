...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "init" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Init client data) accessor delegates here.
...
;; Create a new Init (reqdata: body data).
