...
(ns sdk.entity.apple_pay_session
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "apple_pay_session" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "apple_pay_session")
...
;; Canonical facade: (ApplePaySession client data) accessor delegates here.
...
;; Create a new ApplePaySession (reqdata: body data).
