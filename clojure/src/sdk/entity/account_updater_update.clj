;; BluefinPayconex SDK AccountUpdaterUpdate entity (generated by @voxgig/sdkgen).
(ns sdk.entity.account_updater_update
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "account_updater_update" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "account_updater_update")
...
;; Canonical facade: (AccountUpdaterUpdate client data) accessor delegates here.
...
;; Load a single AccountUpdaterUpdate (reqmatch: id/query fields; nil = empty match).
