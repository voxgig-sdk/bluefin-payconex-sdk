;; BluefinPayconex SDK DynamicDescriptor entity (generated by @voxgig/sdkgen).
(ns sdk.entity.dynamic_descriptor
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "dynamic_descriptor" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "dynamic_descriptor")
...
;; Canonical facade: (DynamicDescriptor client data) accessor delegates here.
...
;; Load a single DynamicDescriptor (reqmatch: id/query fields; nil = empty match).
...
;; List DynamicDescriptor items matching a filter (reqmatch: any subset of fields).
...
;; Create a new DynamicDescriptor (reqdata: body data).
...
;; Update an existing DynamicDescriptor (reqdata: body data).
...
;; Remove an DynamicDescriptor matching the criteria (reqmatch: id/query fields).
