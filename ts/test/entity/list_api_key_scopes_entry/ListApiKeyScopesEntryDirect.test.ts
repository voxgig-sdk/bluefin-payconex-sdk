...
describe('ListApiKeyScopesEntryDirect', async () => {
  ...
  test('direct-list-list_api_key_scopes_entry', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-list_api_key_scopes_entry', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['BLUEFINPAYCONEX_TEST_LIST_API_KEY_SCOPES_ENTRY_ENTID']
