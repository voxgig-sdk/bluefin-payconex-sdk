...
describe('AccountUpdaterUpdateDirect', async () => {
  ...
  test('direct-load-account_updater_update', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-account_updater_update', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['BLUEFINPAYCONEX_TEST_ACCOUNT_UPDATER_UPDATE_ENTID']
