...
describe('TransactionDetailDirect', async () => {
  ...
  test('direct-load-transaction_detail', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-transaction_detail', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['BLUEFINPAYCONEX_TEST_TRANSACTION_DETAIL_ENTID']
