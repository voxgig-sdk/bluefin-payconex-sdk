...
describe('ApplePayMerchantDetailDirect', async () => {
  ...
  test('direct-list-apple_pay_merchant_detail', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-apple_pay_merchant_detail', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['BLUEFINPAYCONEX_TEST_APPLE_PAY_MERCHANT_DETAIL_ENTID']
