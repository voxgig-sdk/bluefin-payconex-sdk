...
const SDK_NAME = 'BluefinPayconexSDK'
...
const TEST_SEED = {"entity":{"account_updater":{"test01":{"id":"test01"}},"account_updater_schedule":{"test01":{"id":"test01"}},"account_updater_schedule_with_result":{"test01":{"id":"test01"}},"account_updater_subscription_with_result":{"test01":{"id":"test01"}},"account_updater_update":{"test01":{"id":"test01"}},"api_key":{"test01":{"id":"test01"}},"apple_pay_merchant_detail":{"test01":{"id":"test01"}},"apple_pay_session":{"test01":{"id":"test01"}},"dynamic_descriptor":{"test01":{"id":"test01"}},"i_frame_create_instance":{"test01":{"id":"test01"}},"i_frame_instance":{"test01":{"id":"test01"}},"iframe":{"test01":{"id":"test01"}},"init":{"test01":{"id":"test01"}},"list_api_key_scopes_entry":{"test01":{"id":"test01"}},"payment_iframe":{"test01":{"id":"test01"}},"three_d_secure_auth":{"test01":{"id":"test01"}},"three_d_secure_browser_init":{"test01":{"id":"test01"}},"three_d_secure_status":{"test01":{"id":"test01"}},"transaction_detail":{"test01":{"id":"test01"}},"webhook":{"test01":{"id":"test01"}}}}
...
function isRunnable(code: string): boolean {
  return (
    /new\s+BluefinPayconexSDK\b/.test(code) ||
    /\bBluefinPayconexSDK\.test\b/.test(code) ||
    /\bclient\s*\./.test(code)
  )
}
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+BluefinPayconexSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/BluefinPayconexSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
