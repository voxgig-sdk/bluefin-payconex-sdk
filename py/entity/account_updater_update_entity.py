...
class AccountUpdaterUpdateEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AccountUpdaterUpdateEntity(self._client, opts)
    ...
    def data_get(self) -> AccountUpdaterUpdate:
    ...
    def match_get(self) -> AccountUpdaterUpdate:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AccountUpdaterUpdate:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AccountUpdaterUpdate().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
