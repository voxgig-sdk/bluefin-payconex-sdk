...
from bluefinpayconex_types import (
    DynamicDescriptor,
...
class DynamicDescriptorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DynamicDescriptorEntity(self._client, opts)
    ...
    def data_get(self) -> DynamicDescriptor:
    ...
    def match_get(self) -> DynamicDescriptor:
    ...
    def load(self, reqmatch=None, ctrl=None) -> DynamicDescriptor:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.DynamicDescriptor().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DynamicDescriptor]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DynamicDescriptor().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def create(self, reqdata: DynamicDescriptorCreateData, ctrl=None) -> DynamicDescriptor:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: DynamicDescriptorUpdateData, ctrl=None) -> DynamicDescriptor:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
    ...
    def remove(self, reqmatch=None, ctrl=None) -> DynamicDescriptor:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key removes with no
        # match. Treat None as an empty match so client.DynamicDescriptor().remove()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
