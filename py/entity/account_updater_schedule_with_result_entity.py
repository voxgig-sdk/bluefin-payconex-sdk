...
class AccountUpdaterScheduleWithResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AccountUpdaterScheduleWithResultEntity(self._client, opts)
    ...
    def data_get(self) -> AccountUpdaterScheduleWithResult:
    ...
    def match_get(self) -> AccountUpdaterScheduleWithResult:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AccountUpdaterScheduleWithResult]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AccountUpdaterScheduleWithResult().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: AccountUpdaterScheduleWithResultCreateData, ctrl=None) -> AccountUpdaterScheduleWithResult:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
