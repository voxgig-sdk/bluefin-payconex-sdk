...
class ThreeDSecureBrowserInitEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ThreeDSecureBrowserInitEntity(self._client, opts)
    ...
    def data_get(self) -> ThreeDSecureBrowserInit:
    ...
    def match_get(self) -> ThreeDSecureBrowserInit:
    ...
    def create(self, reqdata: ThreeDSecureBrowserInitCreateData, ctrl=None) -> ThreeDSecureBrowserInit:
        utility = self._utility
