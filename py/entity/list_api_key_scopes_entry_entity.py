...
class ListApiKeyScopesEntryEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ListApiKeyScopesEntryEntity(self._client, opts)
    ...
    def data_get(self) -> ListApiKeyScopesEntry:
    ...
    def match_get(self) -> ListApiKeyScopesEntry:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ListApiKeyScopesEntry]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ListApiKeyScopesEntry().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
