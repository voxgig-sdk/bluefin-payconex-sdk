...
class ThreeDSecureAuthEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ThreeDSecureAuthEntity(self._client, opts)
    ...
    def data_get(self) -> ThreeDSecureAuth:
    ...
    def match_get(self) -> ThreeDSecureAuth:
    ...
    def create(self, reqdata: ThreeDSecureAuthCreateData, ctrl=None) -> ThreeDSecureAuth:
        utility = self._utility
