...
class ApplePaySessionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ApplePaySessionEntity(self._client, opts)
    ...
    def data_get(self) -> ApplePaySession:
    ...
    def match_get(self) -> ApplePaySession:
    ...
    def create(self, reqdata: ApplePaySessionCreateData, ctrl=None) -> ApplePaySession:
        utility = self._utility
