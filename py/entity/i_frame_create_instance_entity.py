...
class IFrameCreateInstanceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return IFrameCreateInstanceEntity(self._client, opts)
    ...
    def data_get(self) -> IFrameCreateInstance:
    ...
    def match_get(self) -> IFrameCreateInstance:
    ...
    def create(self, reqdata: IFrameCreateInstanceCreateData, ctrl=None) -> IFrameCreateInstance:
        utility = self._utility
