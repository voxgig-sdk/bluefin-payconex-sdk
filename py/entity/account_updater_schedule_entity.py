...
class AccountUpdaterScheduleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AccountUpdaterScheduleEntity(self._client, opts)
    ...
    def data_get(self) -> AccountUpdaterSchedule:
    ...
    def match_get(self) -> AccountUpdaterSchedule:
    ...
    def create(self, reqdata: AccountUpdaterScheduleCreateData, ctrl=None) -> AccountUpdaterSchedule:
        utility = self._utility
