...
class ThreeDSecureStatusEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ThreeDSecureStatusEntity(self._client, opts)
    ...
    def data_get(self) -> ThreeDSecureStatus:
    ...
    def match_get(self) -> ThreeDSecureStatus:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ThreeDSecureStatus:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ThreeDSecureStatus().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
