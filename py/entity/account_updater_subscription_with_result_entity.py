...
class AccountUpdaterSubscriptionWithResultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AccountUpdaterSubscriptionWithResultEntity(self._client, opts)
    ...
    def data_get(self) -> AccountUpdaterSubscriptionWithResult:
    ...
    def match_get(self) -> AccountUpdaterSubscriptionWithResult:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AccountUpdaterSubscriptionWithResult:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AccountUpdaterSubscriptionWithResult().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: AccountUpdaterSubscriptionWithResultCreateData, ctrl=None) -> AccountUpdaterSubscriptionWithResult:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: AccountUpdaterSubscriptionWithResultUpdateData, ctrl=None) -> AccountUpdaterSubscriptionWithResult:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
