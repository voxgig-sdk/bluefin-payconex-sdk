# BluefinPayconex SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinPayconexSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinPayconexSDK(...) and BluefinPayconexSDK.test(...) become
#      BluefinPayconexSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefinpayconex_sdk"
_SDK_CLASS = "BluefinPayconexSDK"
...
_ENTITIES = {
    ...
    "AccountUpdaterSchedule": "account_updater_schedule",
    "AccountUpdaterScheduleWithResult": "account_updater_schedule_with_result",
    "AccountUpdaterSubscriptionWithResult": "account_updater_subscription_with_result",
    "AccountUpdaterUpdate": "account_updater_update",
    "ApiKey": "api_key",
    "ApplePayMerchantDetail": "apple_pay_merchant_detail",
    "ApplePaySession": "apple_pay_session",
    "DynamicDescriptor": "dynamic_descriptor",
    "IFrameCreateInstance": "i_frame_create_instance",
    "IFrameInstance": "i_frame_instance",
    "Iframe": "iframe",
    "Init": "init",
    "ListApiKeyScopesEntry": "list_api_key_scopes_entry",
    "PaymentIframe": "payment_iframe",
    "ThreeDSecureAuth": "three_d_secure_auth",
    "ThreeDSecureBrowserInit": "three_d_secure_browser_init",
