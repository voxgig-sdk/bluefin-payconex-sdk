...
function envOverride(m) {
  if (
    'TRUE' === process.env.BLUEFINPAYCONEX_TEST_LIVE ||
    'TRUE' === process.env.BLUEFINPAYCONEX_TEST_OVERRIDE
  ) {
  ...
  m.BLUEFINPAYCONEX_TEST_EXPLAIN = process.env.BLUEFINPAYCONEX_TEST_EXPLAIN || m.BLUEFINPAYCONEX_TEST_EXPLAIN
