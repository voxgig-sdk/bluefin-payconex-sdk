...
describe('AccountUpdaterScheduleWithResultDirect', async () => {
  ...
  test('direct-list-account_updater_schedule_with_result', async () => {
...
function directSetup(mockres) {
  ...
  if (live) {
    ...
    let idmap = env['BLUEFINPAYCONEX_TEST_ACCOUNT_UPDATER_SCHEDULE_WITH_RESULT_ENTID']
