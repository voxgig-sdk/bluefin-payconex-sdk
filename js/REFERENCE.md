# BluefinPayconex JavaScript SDK Reference

Complete API reference for the BluefinPayconex JavaScript SDK.
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `ach_setting` | `Object` | No |  |
| `allowed_parent_domain` | `Array` | Yes |  |
| `allowed_payment_method` | `Array` | Yes |  |
| `card_setting` | `Object` | No |  |
| `click_to_pay_setting` | `Object` | No |  |
| `currency` | `string` | No |  |
| `id` | `string` | No |  |
| `label` | `string` | Yes |  |
| `language` | `string` | No |  |
