...
class ApiKeyEntity extends BluefinPayconexEntityBase {
  ...
  /**
   * @param {ApiKeyLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {ApiKeyListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<ApiKey[]>}
   */
  ...
  /**
   * @param {ApiKeyCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<ApiKey>}
   */
  ...
  /**
   * @param {ApiKeyUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<ApiKey>}
   */
  ...
  /**
   * @param {ApiKeyRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<ApiKey>}
   */
