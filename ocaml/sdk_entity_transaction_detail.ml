...
let rec make (client : sdk_client) (entopts_in : value) : entity_obj =
  ...
  ent.e_list <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"list\" not supported by entity \"transaction_detail\".")));
  ent.e_create <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"create\" not supported by entity \"transaction_detail\".")));
  ...
  ent.e_remove <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"remove\" not supported by entity \"transaction_detail\".")));
  ent
