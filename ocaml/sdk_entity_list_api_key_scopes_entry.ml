...
let rec make (client : sdk_client) (entopts_in : value) : entity_obj =
  ...
  let ent = {
    e_name = "list_api_key_scopes_entry";
    e_client = client;
    e_utility = utility;
    e_entopts = entopts;
    e_data = empty_map ();
  ...
  ent.e_load <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"load\" not supported by entity \"list_api_key_scopes_entry\".")));
  ...
  ent.e_create <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"create\" not supported by entity \"list_api_key_scopes_entry\".")));
  ent.e_update <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"update\" not supported by entity \"list_api_key_scopes_entry\".")));
  ent.e_remove <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"remove\" not supported by entity \"list_api_key_scopes_entry\".")));
  ent
