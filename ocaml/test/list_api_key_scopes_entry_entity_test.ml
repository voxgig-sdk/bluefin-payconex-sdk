(* Generated list_api_key_scopes_entry entity test. *)
...
let () =
  test "list_api_key_scopes_entry.entity_instance" (fun () ->
      let client = Sdk_client.test () in
      let ent = Sdk_client.list_api_key_scopes_entry client Noval in
      check_str "name" ent.e_name "list_api_key_scopes_entry")

let () =
  test "list_api_key_scopes_entry.seeded_ops" (fun () ->
      let record = jo [("id", Str "list_api_key_scopes_entry01")] in
      let seed = jo [("list_api_key_scopes_entry",
                      jo [("list_api_key_scopes_entry01", record)])] in
...
let () =
  test "list_api_key_scopes_entry.stream" (fun () ->
      let mk_seed () =
        jo [("list_api_key_scopes_entry",
      ...
      let ent2 = Sdk_client.list_api_key_scopes_entry client2 Noval in
      let n = ref 0 in
      ...
      if has_streaming then begin
        ...
        let sent = Sdk_client.list_api_key_scopes_entry sclient Noval in
        ...
        let cent = Sdk_client.list_api_key_scopes_entry cclient Noval in
