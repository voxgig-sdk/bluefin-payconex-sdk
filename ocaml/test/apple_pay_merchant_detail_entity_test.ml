(* Generated apple_pay_merchant_detail entity test. *)
...
let () =
  test "apple_pay_merchant_detail.entity_instance" (fun () ->
      let client = Sdk_client.test () in
      let ent = Sdk_client.apple_pay_merchant_detail client Noval in
      check_str "name" ent.e_name "apple_pay_merchant_detail")

let () =
  test "apple_pay_merchant_detail.seeded_ops" (fun () ->
      let record = jo [("id", Str "apple_pay_merchant_detail01")] in
      let seed = jo [("apple_pay_merchant_detail",
                      jo [("apple_pay_merchant_detail01", record)])] in
...
let () =
  test "apple_pay_merchant_detail.stream" (fun () ->
      let mk_seed () =
        jo [("apple_pay_merchant_detail",
      ...
      let ent2 = Sdk_client.apple_pay_merchant_detail client2 Noval in
      let n = ref 0 in
      ...
      if has_streaming then begin
        ...
        let sent = Sdk_client.apple_pay_merchant_detail sclient Noval in
        ...
        let cent = Sdk_client.apple_pay_merchant_detail cclient Noval in
