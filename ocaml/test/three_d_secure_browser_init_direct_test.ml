(* Generated three_d_secure_browser_init direct-call test. *)
...
let () =
  test "three_d_secure_browser_init.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/three_d_secure_browser_init"); ("method", Str "GET")]) in
