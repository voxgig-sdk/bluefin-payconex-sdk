(* Generated apple_pay_merchant_detail direct-call test. *)
...
let () =
  test "apple_pay_merchant_detail.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/apple_pay_merchant_detail"); ("method", Str "GET")]) in
