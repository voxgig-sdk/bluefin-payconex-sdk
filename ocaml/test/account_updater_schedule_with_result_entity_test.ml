(* Generated account_updater_schedule_with_result entity test. *)
...
let () =
  test "account_updater_schedule_with_result.entity_instance" (fun () ->
      let client = Sdk_client.test () in
      let ent = Sdk_client.account_updater_schedule_with_result client Noval in
      check_str "name" ent.e_name "account_updater_schedule_with_result")

let () =
  test "account_updater_schedule_with_result.seeded_ops" (fun () ->
      let record = jo [("id", Str "account_updater_schedule_with_result01")] in
      let seed = jo [("account_updater_schedule_with_result",
                      jo [("account_updater_schedule_with_result01", record)])] in
...
let () =
  test "account_updater_schedule_with_result.stream" (fun () ->
      let mk_seed () =
        jo [("account_updater_schedule_with_result",
      ...
      let ent2 = Sdk_client.account_updater_schedule_with_result client2 Noval in
      let n = ref 0 in
      ...
      if has_streaming then begin
        ...
        let sent = Sdk_client.account_updater_schedule_with_result sclient Noval in
        ...
        let cent = Sdk_client.account_updater_schedule_with_result cclient Noval in
