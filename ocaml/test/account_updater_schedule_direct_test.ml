(* Generated account_updater_schedule direct-call test. *)
...
let () =
  test "account_updater_schedule.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/account_updater_schedule"); ("method", Str "GET")]) in
