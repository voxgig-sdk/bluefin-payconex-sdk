(* Generated list_api_key_scopes_entry direct-call test. *)
...
let () =
  test "list_api_key_scopes_entry.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/list_api_key_scopes_entry"); ("method", Str "GET")]) in
