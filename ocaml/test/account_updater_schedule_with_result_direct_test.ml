(* Generated account_updater_schedule_with_result direct-call test. *)
...
let () =
  test "account_updater_schedule_with_result.direct_call" (fun () ->
      let calls = ref [] in
      ...
      let result = Sdk_client.direct client
          (jo [("path", Str "/account_updater_schedule_with_result"); ("method", Str "GET")]) in
