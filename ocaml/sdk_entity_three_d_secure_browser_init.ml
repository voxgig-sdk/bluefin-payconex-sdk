(* BluefinPayconex SDK ThreeDSecureBrowserInit entity (generated by @voxgig/sdkgen).
 *
...
let rec make (client : sdk_client) (entopts_in : value) : entity_obj =
  ...
  let ent = {
    e_name = "three_d_secure_browser_init";
    e_client = client;
    e_utility = utility;
    e_entopts = entopts;
    e_data = empty_map ();
  ...
  ent.e_load <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"load\" not supported by entity \"three_d_secure_browser_init\".")));
  ent.e_list <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"list\" not supported by entity \"three_d_secure_browser_init\".")));
  ...
  ent.e_update <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"update\" not supported by entity \"three_d_secure_browser_init\".")));
  ent.e_remove <- (fun _ _ ->
      raise (Sdk_error_exc (mk_error "unsupported_op"
        "Operation \"remove\" not supported by entity \"three_d_secure_browser_init\".")));
  ent
