// ApiKey entity client (generated). Shared entity runtime (data/match
...
class ApiKeyEntity : public EntityBase {
public:
  ApiKeyEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("api_key", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ApiKeyEntity>(this->client, opts);
  }
