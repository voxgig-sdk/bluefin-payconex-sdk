// Init entity client (generated). Shared entity runtime (data/match
...
class InitEntity : public EntityBase {
public:
  InitEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("init", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<InitEntity>(this->client, opts);
  }
