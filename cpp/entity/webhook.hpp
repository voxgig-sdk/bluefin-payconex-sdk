// Webhook entity client (generated). Shared entity runtime (data/match
...
class WebhookEntity : public EntityBase {
public:
  WebhookEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("webhook", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<WebhookEntity>(this->client, opts);
  }
