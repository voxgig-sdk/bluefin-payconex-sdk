// AccountUpdaterSubscriptionWithResult entity client (generated). Shared entity runtime (data/match
...
class AccountUpdaterSubscriptionWithResultEntity : public EntityBase {
public:
  AccountUpdaterSubscriptionWithResultEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("account_updater_subscription_with_result", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<AccountUpdaterSubscriptionWithResultEntity>(this->client, opts);
  }
