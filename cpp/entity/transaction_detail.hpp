// TransactionDetail entity client (generated). Shared entity runtime (data/match
...
class TransactionDetailEntity : public EntityBase {
public:
  TransactionDetailEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("transaction_detail", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TransactionDetailEntity>(this->client, opts);
  }
