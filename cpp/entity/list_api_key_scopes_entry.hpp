// ListApiKeyScopesEntry entity client (generated). Shared entity runtime (data/match
...
class ListApiKeyScopesEntryEntity : public EntityBase {
public:
  ListApiKeyScopesEntryEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("list_api_key_scopes_entry", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ListApiKeyScopesEntryEntity>(this->client, opts);
  }
