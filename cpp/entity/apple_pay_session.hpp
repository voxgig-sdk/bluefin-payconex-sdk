// ApplePaySession entity client (generated). Shared entity runtime (data/match
...
class ApplePaySessionEntity : public EntityBase {
public:
  ApplePaySessionEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("apple_pay_session", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ApplePaySessionEntity>(this->client, opts);
  }
