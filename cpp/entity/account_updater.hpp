// AccountUpdater entity client (generated). Shared entity runtime (data/match
...
class AccountUpdaterEntity : public EntityBase {
public:
  AccountUpdaterEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("account_updater", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<AccountUpdaterEntity>(this->client, opts);
  }
