// ThreeDSecureAuth entity client (generated). Shared entity runtime (data/match
...
class ThreeDSecureAuthEntity : public EntityBase {
public:
  ThreeDSecureAuthEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("three_d_secure_auth", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ThreeDSecureAuthEntity>(this->client, opts);
  }
