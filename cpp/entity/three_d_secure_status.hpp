// ThreeDSecureStatus entity client (generated). Shared entity runtime (data/match
...
class ThreeDSecureStatusEntity : public EntityBase {
public:
  ThreeDSecureStatusEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("three_d_secure_status", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ThreeDSecureStatusEntity>(this->client, opts);
  }
