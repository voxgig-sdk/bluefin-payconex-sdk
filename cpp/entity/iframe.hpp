// Iframe entity client (generated). Shared entity runtime (data/match
...
class IframeEntity : public EntityBase {
public:
  IframeEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("iframe", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<IframeEntity>(this->client, opts);
  }
