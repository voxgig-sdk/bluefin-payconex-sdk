// AccountUpdaterUpdate entity client (generated). Shared entity runtime (data/match
...
class AccountUpdaterUpdateEntity : public EntityBase {
public:
  AccountUpdaterUpdateEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("account_updater_update", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<AccountUpdaterUpdateEntity>(this->client, opts);
  }
