// ThreeDSecureBrowserInit entity client (generated). Shared entity runtime (data/match
...
class ThreeDSecureBrowserInitEntity : public EntityBase {
public:
  ThreeDSecureBrowserInitEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("three_d_secure_browser_init", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ThreeDSecureBrowserInitEntity>(this->client, opts);
  }
