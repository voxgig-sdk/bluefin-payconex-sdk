// IFrameCreateInstance entity client (generated). Shared entity runtime (data/match
...
class IFrameCreateInstanceEntity : public EntityBase {
public:
  IFrameCreateInstanceEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("i_frame_create_instance", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<IFrameCreateInstanceEntity>(this->client, opts);
  }
