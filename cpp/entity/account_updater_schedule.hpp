// AccountUpdaterSchedule entity client (generated). Shared entity runtime (data/match
...
class AccountUpdaterScheduleEntity : public EntityBase {
public:
  AccountUpdaterScheduleEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("account_updater_schedule", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<AccountUpdaterScheduleEntity>(this->client, opts);
  }
