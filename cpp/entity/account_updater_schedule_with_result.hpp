// AccountUpdaterScheduleWithResult entity client (generated). Shared entity runtime (data/match
...
class AccountUpdaterScheduleWithResultEntity : public EntityBase {
public:
  AccountUpdaterScheduleWithResultEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("account_updater_schedule_with_result", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<AccountUpdaterScheduleWithResultEntity>(this->client, opts);
  }
