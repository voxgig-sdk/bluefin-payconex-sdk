// ApplePayMerchantDetail entity client (generated). Shared entity runtime (data/match
...
class ApplePayMerchantDetailEntity : public EntityBase {
public:
  ApplePayMerchantDetailEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("apple_pay_merchant_detail", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ApplePayMerchantDetailEntity>(this->client, opts);
  }
