// DynamicDescriptor entity client (generated). Shared entity runtime (data/match
...
class DynamicDescriptorEntity : public EntityBase {
public:
  DynamicDescriptorEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("dynamic_descriptor", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<DynamicDescriptorEntity>(this->client, opts);
  }
