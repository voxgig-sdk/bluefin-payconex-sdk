// IFrameInstance entity client (generated). Shared entity runtime (data/match
...
class IFrameInstanceEntity : public EntityBase {
public:
  IFrameInstanceEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("i_frame_instance", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<IFrameInstanceEntity>(this->client, opts);
  }
