...
func registerSDKWords(r *eng.Registry, client *sdk.BluefinPayconexSDK) {
...
func runOp(client *sdk.BluefinPayconexSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
