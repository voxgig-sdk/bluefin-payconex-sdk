...
public class AccountUpdaterEntity extends EntityBase {

  public AccountUpdaterEntity(SdkClient client, Map<String, Object> entopts) {
    super("account_updater", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new AccountUpdaterEntity(this.client, opts);
  }
