...
public class TransactionDetailEntity extends EntityBase {

  public TransactionDetailEntity(SdkClient client, Map<String, Object> entopts) {
    super("transaction_detail", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new TransactionDetailEntity(this.client, opts);
  }
