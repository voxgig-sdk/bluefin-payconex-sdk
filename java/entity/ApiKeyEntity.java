...
public class ApiKeyEntity extends EntityBase {

  public ApiKeyEntity(SdkClient client, Map<String, Object> entopts) {
    super("api_key", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ApiKeyEntity(this.client, opts);
  }
