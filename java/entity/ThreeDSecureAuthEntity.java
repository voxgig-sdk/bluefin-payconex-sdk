...
public class ThreeDSecureAuthEntity extends EntityBase {

  public ThreeDSecureAuthEntity(SdkClient client, Map<String, Object> entopts) {
    super("three_d_secure_auth", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ThreeDSecureAuthEntity(this.client, opts);
  }
