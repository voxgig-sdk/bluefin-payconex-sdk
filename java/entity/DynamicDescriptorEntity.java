...
public class DynamicDescriptorEntity extends EntityBase {

  public DynamicDescriptorEntity(SdkClient client, Map<String, Object> entopts) {
    super("dynamic_descriptor", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new DynamicDescriptorEntity(this.client, opts);
  }
