...
public class AccountUpdaterUpdateEntity extends EntityBase {

  public AccountUpdaterUpdateEntity(SdkClient client, Map<String, Object> entopts) {
    super("account_updater_update", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new AccountUpdaterUpdateEntity(this.client, opts);
  }
