...
public class IframeEntity extends EntityBase {

  public IframeEntity(SdkClient client, Map<String, Object> entopts) {
    super("iframe", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new IframeEntity(this.client, opts);
  }
