...
public class PaymentIframeEntity extends EntityBase {

  public PaymentIframeEntity(SdkClient client, Map<String, Object> entopts) {
    super("payment_iframe", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new PaymentIframeEntity(this.client, opts);
  }
