...
public class ApplePayMerchantDetailEntity extends EntityBase {

  public ApplePayMerchantDetailEntity(SdkClient client, Map<String, Object> entopts) {
    super("apple_pay_merchant_detail", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ApplePayMerchantDetailEntity(this.client, opts);
  }
