...
public class AccountUpdaterScheduleWithResultEntity extends EntityBase {

  public AccountUpdaterScheduleWithResultEntity(SdkClient client, Map<String, Object> entopts) {
    super("account_updater_schedule_with_result", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new AccountUpdaterScheduleWithResultEntity(this.client, opts);
  }
