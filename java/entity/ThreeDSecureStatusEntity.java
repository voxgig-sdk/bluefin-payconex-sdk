...
public class ThreeDSecureStatusEntity extends EntityBase {

  public ThreeDSecureStatusEntity(SdkClient client, Map<String, Object> entopts) {
    super("three_d_secure_status", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ThreeDSecureStatusEntity(this.client, opts);
  }
