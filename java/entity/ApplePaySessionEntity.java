...
/** ApplePaySession entity client for the BluefinPayconex SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class ApplePaySessionEntity extends EntityBase {

  public ApplePaySessionEntity(SdkClient client, Map<String, Object> entopts) {
    super("apple_pay_session", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ApplePaySessionEntity(this.client, opts);
  }
