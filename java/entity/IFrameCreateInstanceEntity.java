...
public class IFrameCreateInstanceEntity extends EntityBase {

  public IFrameCreateInstanceEntity(SdkClient client, Map<String, Object> entopts) {
    super("i_frame_create_instance", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new IFrameCreateInstanceEntity(this.client, opts);
  }
