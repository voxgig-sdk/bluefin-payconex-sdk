...
public class ThreeDSecureBrowserInitEntity extends EntityBase {

  public ThreeDSecureBrowserInitEntity(SdkClient client, Map<String, Object> entopts) {
    super("three_d_secure_browser_init", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ThreeDSecureBrowserInitEntity(this.client, opts);
  }
