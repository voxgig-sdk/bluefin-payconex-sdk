...
public class AccountUpdaterSubscriptionWithResultEntity extends EntityBase {

  public AccountUpdaterSubscriptionWithResultEntity(SdkClient client, Map<String, Object> entopts) {
    super("account_updater_subscription_with_result", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new AccountUpdaterSubscriptionWithResultEntity(this.client, opts);
  }
