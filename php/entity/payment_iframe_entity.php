...
class PaymentIframeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PaymentIframeEntity($this->_client, $opts);
    }

    /**
     * @param PaymentIframe|array $args PaymentIframe data (assoc-array) to store.
     */
    ...
    /**
     * @return PaymentIframe|array The current PaymentIframe data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PaymentIframe fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PaymentIframe fields).
     */
     ...
     *
     * @param PaymentIframeRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PaymentIframeRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PaymentIframe|array The removed PaymentIframe as an assoc-array at the
