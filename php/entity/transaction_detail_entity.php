...
// BluefinPayconex SDK TransactionDetail entity
...
class TransactionDetailEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TransactionDetailEntity($this->_client, $opts);
    }

    /**
     * @param TransactionDetail|array $args TransactionDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return TransactionDetail|array The current TransactionDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TransactionDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TransactionDetail fields).
     */
    ...
    /**
     * Load a single TransactionDetail.
     *
     * @param TransactionDetailLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TransactionDetailLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransactionDetail|array The loaded TransactionDetail as an assoc-array at the
     ...
     *
     * @param TransactionDetailUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed TransactionDetailUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TransactionDetail|array The updated TransactionDetail as an assoc-array at the
     *   SDK boundary; throws BluefinPayconexError on failure (item-5 convention).
     */
