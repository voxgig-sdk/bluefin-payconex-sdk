...
class ThreeDSecureAuthEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "three_d_secure_auth";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ThreeDSecureAuthEntity($this->_client, $opts);
    }

    /**
     * @param ThreeDSecureAuth|array $args ThreeDSecureAuth data (assoc-array) to store.
     */
    ...
    /**
     * @return ThreeDSecureAuth|array The current ThreeDSecureAuth data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ThreeDSecureAuth fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ThreeDSecureAuth fields).
     */
     ...
     *
     * @param ThreeDSecureAuthCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ThreeDSecureAuthCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ThreeDSecureAuth|array The created ThreeDSecureAuth as an assoc-array at the
