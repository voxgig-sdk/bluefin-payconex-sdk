...
// BluefinPayconex SDK IFrameCreateInstance entity
...
class IFrameCreateInstanceEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "i_frame_create_instance";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new IFrameCreateInstanceEntity($this->_client, $opts);
    }

    /**
     * @param IFrameCreateInstance|array $args IFrameCreateInstance data (assoc-array) to store.
     */
    ...
    /**
     * @return IFrameCreateInstance|array The current IFrameCreateInstance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IFrameCreateInstance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IFrameCreateInstance fields).
     */
    ...
    /**
     * Create a new IFrameCreateInstance.
     *
     * @param IFrameCreateInstanceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IFrameCreateInstanceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IFrameCreateInstance|array The created IFrameCreateInstance as an assoc-array at the
