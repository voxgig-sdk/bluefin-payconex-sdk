...
class ApplePaySessionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApplePaySessionEntity($this->_client, $opts);
    }

    /**
     * @param ApplePaySession|array $args ApplePaySession data (assoc-array) to store.
     */
    ...
    /**
     * @return ApplePaySession|array The current ApplePaySession data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApplePaySession fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApplePaySession fields).
     */
     ...
     *
     * @param ApplePaySessionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApplePaySessionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApplePaySession|array The created ApplePaySession as an assoc-array at the
