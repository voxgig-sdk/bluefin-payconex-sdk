...
// BluefinPayconex SDK AccountUpdaterScheduleWithResult entity
...
class AccountUpdaterScheduleWithResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "account_updater_schedule_with_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AccountUpdaterScheduleWithResultEntity($this->_client, $opts);
    }

    /**
     * @param AccountUpdaterScheduleWithResult|array $args AccountUpdaterScheduleWithResult data (assoc-array) to store.
     */
    ...
    /**
     * @return AccountUpdaterScheduleWithResult|array The current AccountUpdaterScheduleWithResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccountUpdaterScheduleWithResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccountUpdaterScheduleWithResult fields).
     */
    ...
    /**
     * List AccountUpdaterScheduleWithResult items matching the given filter.
     *
     * @param AccountUpdaterScheduleWithResultListMatch|array|null $reqmatch Match filter (any subset
     *   of AccountUpdaterScheduleWithResult fields) as an assoc-array; AccountUpdaterScheduleWithResultListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountUpdaterScheduleWithResult[]|array A list of AccountUpdaterScheduleWithResult items as assoc-arrays at
    ...
    /**
     * Create a new AccountUpdaterScheduleWithResult.
     *
     * @param AccountUpdaterScheduleWithResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AccountUpdaterScheduleWithResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountUpdaterScheduleWithResult|array The created AccountUpdaterScheduleWithResult as an assoc-array at the
