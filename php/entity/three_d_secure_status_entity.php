...
// BluefinPayconex SDK ThreeDSecureStatus entity
...
class ThreeDSecureStatusEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "three_d_secure_status";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ThreeDSecureStatusEntity($this->_client, $opts);
    }

    /**
     * @param ThreeDSecureStatus|array $args ThreeDSecureStatus data (assoc-array) to store.
     */
    ...
    /**
     * @return ThreeDSecureStatus|array The current ThreeDSecureStatus data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ThreeDSecureStatus fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ThreeDSecureStatus fields).
     */
    ...
    /**
     * Load a single ThreeDSecureStatus.
     *
     * @param ThreeDSecureStatusLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ThreeDSecureStatusLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ThreeDSecureStatus|array The loaded ThreeDSecureStatus as an assoc-array at the
