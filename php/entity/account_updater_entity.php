...
class AccountUpdaterEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AccountUpdaterEntity($this->_client, $opts);
    }

    /**
     * @param AccountUpdater|array $args AccountUpdater data (assoc-array) to store.
     */
    ...
    /**
     * @return AccountUpdater|array The current AccountUpdater data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccountUpdater fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccountUpdater fields).
     */
     ...
     *
     * @param AccountUpdaterRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AccountUpdaterRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountUpdater|array The removed AccountUpdater as an assoc-array at the
