...
// BluefinPayconex SDK AccountUpdaterSubscriptionWithResult entity
...
class AccountUpdaterSubscriptionWithResultEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "account_updater_subscription_with_result";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AccountUpdaterSubscriptionWithResultEntity($this->_client, $opts);
    }

    /**
     * @param AccountUpdaterSubscriptionWithResult|array $args AccountUpdaterSubscriptionWithResult data (assoc-array) to store.
     */
    ...
    /**
     * @return AccountUpdaterSubscriptionWithResult|array The current AccountUpdaterSubscriptionWithResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccountUpdaterSubscriptionWithResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccountUpdaterSubscriptionWithResult fields).
     */
    ...
    /**
     * Load a single AccountUpdaterSubscriptionWithResult.
     *
     * @param AccountUpdaterSubscriptionWithResultLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AccountUpdaterSubscriptionWithResultLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountUpdaterSubscriptionWithResult|array The loaded AccountUpdaterSubscriptionWithResult as an assoc-array at the
    ...
    /**
     * Create a new AccountUpdaterSubscriptionWithResult.
     *
     * @param AccountUpdaterSubscriptionWithResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AccountUpdaterSubscriptionWithResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountUpdaterSubscriptionWithResult|array The created AccountUpdaterSubscriptionWithResult as an assoc-array at the
     *   SDK boundary; throws BluefinPayconexError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing AccountUpdaterSubscriptionWithResult.
     *
     * @param AccountUpdaterSubscriptionWithResultUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AccountUpdaterSubscriptionWithResultUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountUpdaterSubscriptionWithResult|array The updated AccountUpdaterSubscriptionWithResult as an assoc-array at the
     *   SDK boundary; throws BluefinPayconexError on failure (item-5 convention).
     */
