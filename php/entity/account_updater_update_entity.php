...
// BluefinPayconex SDK AccountUpdaterUpdate entity
...
class AccountUpdaterUpdateEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "account_updater_update";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AccountUpdaterUpdateEntity($this->_client, $opts);
    }

    /**
     * @param AccountUpdaterUpdate|array $args AccountUpdaterUpdate data (assoc-array) to store.
     */
    ...
    /**
     * @return AccountUpdaterUpdate|array The current AccountUpdaterUpdate data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccountUpdaterUpdate fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccountUpdaterUpdate fields).
     */
    ...
    /**
     * Load a single AccountUpdaterUpdate.
     *
     * @param AccountUpdaterUpdateLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AccountUpdaterUpdateLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountUpdaterUpdate|array The loaded AccountUpdaterUpdate as an assoc-array at the
