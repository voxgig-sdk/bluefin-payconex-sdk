...
// BluefinPayconex SDK AccountUpdaterSchedule entity
...
class AccountUpdaterScheduleEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "account_updater_schedule";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AccountUpdaterScheduleEntity($this->_client, $opts);
    }

    /**
     * @param AccountUpdaterSchedule|array $args AccountUpdaterSchedule data (assoc-array) to store.
     */
    ...
    /**
     * @return AccountUpdaterSchedule|array The current AccountUpdaterSchedule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccountUpdaterSchedule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccountUpdaterSchedule fields).
     */
    ...
    /**
     * Create a new AccountUpdaterSchedule.
     *
     * @param AccountUpdaterScheduleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AccountUpdaterScheduleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccountUpdaterSchedule|array The created AccountUpdaterSchedule as an assoc-array at the
