...
// BluefinPayconex SDK IFrameInstance entity
...
class IFrameInstanceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IFrameInstanceEntity($this->_client, $opts);
    }

    /**
     * @param IFrameInstance|array $args IFrameInstance data (assoc-array) to store.
     */
    ...
    /**
     * @return IFrameInstance|array The current IFrameInstance data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of IFrameInstance fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of IFrameInstance fields).
     */
    ...
    /**
     * Load a single IFrameInstance.
     *
     * @param IFrameInstanceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IFrameInstanceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return IFrameInstance|array The loaded IFrameInstance as an assoc-array at the
