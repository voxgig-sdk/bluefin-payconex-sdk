...
class InitEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InitEntity($this->_client, $opts);
    }

    /**
     * @param Init|array $args Init data (assoc-array) to store.
     */
    ...
    /**
     * @return Init|array The current Init data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Init fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Init fields).
     */
     ...
     * Create a new Init.
     *
     * @param InitCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed InitCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Init|array The created Init as an assoc-array at the
