...
// BluefinPayconex SDK ApplePayMerchantDetail entity
...
class ApplePayMerchantDetailEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "apple_pay_merchant_detail";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ApplePayMerchantDetailEntity($this->_client, $opts);
    }

    /**
     * @param ApplePayMerchantDetail|array $args ApplePayMerchantDetail data (assoc-array) to store.
     */
    ...
    /**
     * @return ApplePayMerchantDetail|array The current ApplePayMerchantDetail data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApplePayMerchantDetail fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApplePayMerchantDetail fields).
     */
    ...
    /**
     * List ApplePayMerchantDetail items matching the given filter.
     *
     * @param ApplePayMerchantDetailListMatch|array|null $reqmatch Match filter (any subset
     *   of ApplePayMerchantDetail fields) as an assoc-array; ApplePayMerchantDetailListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApplePayMerchantDetail[]|array A list of ApplePayMerchantDetail items as assoc-arrays at
    ...
    /**
     * Create a new ApplePayMerchantDetail.
     *
     * @param ApplePayMerchantDetailCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApplePayMerchantDetailCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApplePayMerchantDetail|array The created ApplePayMerchantDetail as an assoc-array at the
