...
// BluefinPayconex SDK ThreeDSecureBrowserInit entity
...
class ThreeDSecureBrowserInitEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "three_d_secure_browser_init";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ThreeDSecureBrowserInitEntity($this->_client, $opts);
    }

    /**
     * @param ThreeDSecureBrowserInit|array $args ThreeDSecureBrowserInit data (assoc-array) to store.
     */
    ...
    /**
     * @return ThreeDSecureBrowserInit|array The current ThreeDSecureBrowserInit data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ThreeDSecureBrowserInit fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ThreeDSecureBrowserInit fields).
     */
    ...
    /**
     * Create a new ThreeDSecureBrowserInit.
     *
     * @param ThreeDSecureBrowserInitCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ThreeDSecureBrowserInitCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ThreeDSecureBrowserInit|array The created ThreeDSecureBrowserInit as an assoc-array at the
