...
class ListApiKeyScopesEntryEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "list_api_key_scopes_entry";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ListApiKeyScopesEntryEntity($this->_client, $opts);
    }

    /**
     * @param ListApiKeyScopesEntry|array $args ListApiKeyScopesEntry data (assoc-array) to store.
     */
    ...
    /**
     * @return ListApiKeyScopesEntry|array The current ListApiKeyScopesEntry data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListApiKeyScopesEntry fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListApiKeyScopesEntry fields).
     */
     ...
     *
     * @param ListApiKeyScopesEntryListMatch|array|null $reqmatch Match filter (any subset
     *   of ListApiKeyScopesEntry fields) as an assoc-array; ListApiKeyScopesEntryListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListApiKeyScopesEntry[]|array A list of ListApiKeyScopesEntry items as assoc-arrays at
