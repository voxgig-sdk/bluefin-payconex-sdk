...
class ApiKeyEntity
{
     ...
     *
     * @param ApiKeyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiKeyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiKey|array The loaded ApiKey as an assoc-array at the
     ...
     *
     * @param ApiKeyListMatch|array|null $reqmatch Match filter (any subset
     *   of ApiKey fields) as an assoc-array; ApiKeyListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiKey[]|array A list of ApiKey items as assoc-arrays at
     ...
     *
     * @param ApiKeyUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ApiKeyUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiKey|array The updated ApiKey as an assoc-array at the
     *   SDK boundary; throws BluefinPayconexError on failure (item-5 convention).
     */
     ...
     *
     * @param ApiKeyRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ApiKeyRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiKey|array The removed ApiKey as an assoc-array at the
     *   SDK boundary; throws BluefinPayconexError on failure (item-5 convention).
     */
