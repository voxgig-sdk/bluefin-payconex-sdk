...
// BluefinPayconex SDK Iframe entity
...
class IframeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IframeEntity($this->_client, $opts);
    }

    /**
     * @param Iframe|array $args Iframe data (assoc-array) to store.
     */
    ...
    /**
     * @return Iframe|array The current Iframe data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Iframe fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Iframe fields).
     */
     ...
     *
     * @param IframeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IframeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iframe|array The loaded Iframe as an assoc-array at the
    ...
    /**
     * List Iframe items matching the given filter.
     *
     * @param IframeListMatch|array|null $reqmatch Match filter (any subset
     *   of Iframe fields) as an assoc-array; IframeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iframe[]|array A list of Iframe items as assoc-arrays at
     ...
     * Create a new Iframe.
     *
     * @param IframeCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IframeCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iframe|array The created Iframe as an assoc-array at the
     *   SDK boundary; throws BluefinPayconexError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Iframe.
     *
     * @param IframeUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IframeUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Iframe|array The updated Iframe as an assoc-array at the
     *   SDK boundary; throws BluefinPayconexError on failure (item-5 convention).
     */
