...
//      EXECUTED offline in seeded test mode (BluefinPayconexSDK::test)
...
{
    private const SDK_CLASS = 'BluefinPayconexSDK';
    ...
    private const SDK_BASE = 'bluefinpayconex_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bluefinpayconex_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
