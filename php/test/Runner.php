...
class BluefinPayconexTestRunner
{
    ...
    {
        $live = self::getenv('BLUEFINPAYCONEX_TEST_LIVE');
        $override = self::getenv('BLUEFINPAYCONEX_TEST_OVERRIDE');
        ...
        $explain = self::getenv('BLUEFINPAYCONEX_TEST_EXPLAIN');
...
class_alias('BluefinPayconexTestRunner', 'Runner');
class_alias('BluefinPayconexHelpers', 'Helpers');
