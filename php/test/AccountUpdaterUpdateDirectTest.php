...
class AccountUpdaterUpdateDirectTest extends TestCase
{
    public function test_direct_load_account_updater_update(): void
    {
        $setup = account_updater_update_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-account_updater_update", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
