...
class ApplePayMerchantDetailDirectTest extends TestCase
{
    public function test_direct_list_apple_pay_merchant_detail(): void
    {
        $setup = apple_pay_merchant_detail_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-apple_pay_merchant_detail", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
