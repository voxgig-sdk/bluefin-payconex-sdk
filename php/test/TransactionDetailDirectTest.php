...
class TransactionDetailDirectTest extends TestCase
{
    public function test_direct_load_transaction_detail(): void
    {
        $setup = transaction_detail_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-transaction_detail", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
