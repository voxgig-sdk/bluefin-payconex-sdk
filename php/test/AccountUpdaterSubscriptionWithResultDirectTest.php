...
class AccountUpdaterSubscriptionWithResultDirectTest extends TestCase
{
    public function test_direct_load_account_updater_subscription_with_result(): void
    {
        $setup = account_updater_subscription_with_result_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-account_updater_subscription_with_result", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
