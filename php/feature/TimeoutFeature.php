...
// BluefinPayconex SDK timeout feature
...
class BluefinPayconexTimeoutFeature extends BluefinPayconexBaseFeature
{
    ...
    private function _with_timeout(BluefinPayconexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinPayconexContext $_ctx, float $ms): void
    {
        $client = $this->client;
