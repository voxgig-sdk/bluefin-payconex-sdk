...
// BluefinPayconex SDK ratelimit feature
...
class BluefinPayconexRatelimitFeature extends BluefinPayconexBaseFeature
{
    ...
    private function _acquire(BluefinPayconexContext $ctx): void
    {
    ...
    private function _track(BluefinPayconexContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
