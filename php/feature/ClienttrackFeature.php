...
class BluefinPayconexClienttrackFeature extends BluefinPayconexBaseFeature
{
    ...
    public function PostConstruct(BluefinPayconexContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinPayconex-SDK';
