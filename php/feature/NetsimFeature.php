...
// BluefinPayconex SDK netsim feature
...
class BluefinPayconexNetsimFeature extends BluefinPayconexBaseFeature
{
    ...
    private function _simulate(BluefinPayconexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinPayconexContext $ctx, array $applied): void
    {
        $client = $this->client;
