...
class BluefinPayconexStreamingFeature extends BluefinPayconexBaseFeature
{
    ...
    private function _iterate(BluefinPayconexResult $result): \Generator
    {
    ...
    private function _streamable(BluefinPayconexContext $ctx): bool
    {
