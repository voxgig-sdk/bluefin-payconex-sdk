...
class BluefinPayconexFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinPayconexSDK/1.0)';
    ...
    public static function call(BluefinPayconexContext $ctx, string $fullurl, array $fetchdef): array
    {
