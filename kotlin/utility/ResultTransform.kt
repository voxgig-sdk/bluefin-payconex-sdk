...
fun resultBasic(ctx: Context): voxgig.bluefinpayconexsdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefinpayconexsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefinpayconexsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
