...
class AccountUpdaterScheduleWithResultEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("account_updater_schedule_with_result", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return AccountUpdaterScheduleWithResultEntity(this.client, opts)
  }
