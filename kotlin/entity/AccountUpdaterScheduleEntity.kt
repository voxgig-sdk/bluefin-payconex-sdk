...
class AccountUpdaterScheduleEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("account_updater_schedule", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return AccountUpdaterScheduleEntity(this.client, opts)
  }
