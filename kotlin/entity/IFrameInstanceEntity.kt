...
class IFrameInstanceEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("i_frame_instance", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return IFrameInstanceEntity(this.client, opts)
  }
