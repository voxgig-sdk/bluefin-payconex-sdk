...
class DynamicDescriptorEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("dynamic_descriptor", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return DynamicDescriptorEntity(this.client, opts)
  }
