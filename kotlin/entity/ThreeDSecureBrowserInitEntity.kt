...
class ThreeDSecureBrowserInitEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("three_d_secure_browser_init", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return ThreeDSecureBrowserInitEntity(this.client, opts)
  }
