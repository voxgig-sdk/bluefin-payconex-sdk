...
class AccountUpdaterUpdateEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("account_updater_update", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return AccountUpdaterUpdateEntity(this.client, opts)
  }
