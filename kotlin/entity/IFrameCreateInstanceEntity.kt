...
class IFrameCreateInstanceEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("i_frame_create_instance", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return IFrameCreateInstanceEntity(this.client, opts)
  }
