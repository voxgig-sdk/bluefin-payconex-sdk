...
class ThreeDSecureStatusEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("three_d_secure_status", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return ThreeDSecureStatusEntity(this.client, opts)
  }
