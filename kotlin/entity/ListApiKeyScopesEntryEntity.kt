...
class ListApiKeyScopesEntryEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("list_api_key_scopes_entry", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return ListApiKeyScopesEntryEntity(this.client, opts)
  }
