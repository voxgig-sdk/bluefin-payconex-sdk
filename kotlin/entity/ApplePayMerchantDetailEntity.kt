...
class ApplePayMerchantDetailEntity(clientIn: SdkClient, entoptsIn: MutableMap<String, Any?>?) :
  EntityBase("apple_pay_merchant_detail", clientIn, entoptsIn) {

  override fun make(): Entity {
    val opts = LinkedHashMap(this.entopts)
    return ApplePayMerchantDetailEntity(this.client, opts)
  }
