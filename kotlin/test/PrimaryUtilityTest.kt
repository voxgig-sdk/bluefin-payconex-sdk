...
import voxgig.bluefinpayconexsdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefinpayconexsdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefinpayconexsdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefinpayconexsdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinPayconexSDK = BluefinPayconexSDK.testSDK()

  private fun makeTestCtx(client: BluefinPayconexSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinPayconexSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinPayconexSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinPayconexSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinPayconexSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinPayconexSDK.testSDK(null, setupOpts)
