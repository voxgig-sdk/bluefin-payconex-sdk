...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): BluefinPayconexSDK {
    return BluefinPayconexSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: BluefinPayconexSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: BluefinPayconexSDK): String {
