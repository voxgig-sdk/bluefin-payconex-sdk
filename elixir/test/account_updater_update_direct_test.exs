# AccountUpdaterUpdate direct test (offline, mock system.fetch)

defmodule BluefinPayconex.AccountUpdaterUpdateDirectTest do
  use ExUnit.Case
  ...
  test "should direct load account_updater_update" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinPayconex.direct(sdk, H.deep(%{"path" => "/account_updater_update/direct01", "method" => "GET", "params" => %{}}))
