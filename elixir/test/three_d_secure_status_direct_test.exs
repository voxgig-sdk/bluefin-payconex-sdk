# ThreeDSecureStatus direct test (offline, mock system.fetch)

defmodule BluefinPayconex.ThreeDSecureStatusDirectTest do
  use ExUnit.Case
  ...
  test "should direct load three_d_secure_status" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinPayconex.direct(sdk, H.deep(%{"path" => "/three_d_secure_status/direct01", "method" => "GET", "params" => %{}}))
