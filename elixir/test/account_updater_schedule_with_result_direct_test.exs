# AccountUpdaterScheduleWithResult direct test (offline, mock system.fetch)

defmodule BluefinPayconex.AccountUpdaterScheduleWithResultDirectTest do
  use ExUnit.Case
  ...
  test "should direct list account_updater_schedule_with_result" do
    canned = S.jt([S.jm(["id", "direct01"]), S.jm(["id", "direct02"])])
    sdk = mk(canned)
    res = BluefinPayconex.direct(sdk, H.deep(%{"path" => "/account_updater_schedule_with_result", "method" => "GET", "params" => %{}}))
