# IFrameInstance direct test (offline, mock system.fetch)

defmodule BluefinPayconex.IFrameInstanceDirectTest do
  use ExUnit.Case
  ...
  test "should direct load i_frame_instance" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinPayconex.direct(sdk, H.deep(%{"path" => "/i_frame_instance/direct01", "method" => "GET", "params" => %{}}))
