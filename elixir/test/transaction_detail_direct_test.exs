# TransactionDetail direct test (offline, mock system.fetch)

defmodule BluefinPayconex.TransactionDetailDirectTest do
  use ExUnit.Case
  ...
  test "should direct load transaction_detail" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinPayconex.direct(sdk, H.deep(%{"path" => "/transaction_detail/direct01", "method" => "GET", "params" => %{}}))
