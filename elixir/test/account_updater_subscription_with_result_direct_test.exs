# AccountUpdaterSubscriptionWithResult direct test (offline, mock system.fetch)

defmodule BluefinPayconex.AccountUpdaterSubscriptionWithResultDirectTest do
  use ExUnit.Case
  ...
  test "should direct load account_updater_subscription_with_result" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinPayconex.direct(sdk, H.deep(%{"path" => "/account_updater_subscription_with_result/direct01", "method" => "GET", "params" => %{}}))
