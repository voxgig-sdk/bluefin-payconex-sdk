...
defmodule BluefinPayconex.Entity.ApiKey do
  ...
  # Returns the api_key entity map (BluefinPayconex.Types.api_key/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinPayconex.Types.api_key_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of api_key entity maps (BluefinPayconex.Types.api_key/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinPayconex.Types.api_key_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created api_key entity map (BluefinPayconex.Types.api_key/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinPayconex.Types.api_key_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the updated api_key entity map (BluefinPayconex.Types.api_key/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec update(map(), BluefinPayconex.Types.api_key_update_data() | nil, map() | nil) :: term()
  ...
  # Returns the removed api_key entity map (BluefinPayconex.Types.api_key/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec remove(map(), BluefinPayconex.Types.api_key_remove_match() | nil, map() | nil) :: term()
