...
defmodule BluefinPayconex.Entity.AccountUpdaterScheduleWithResult do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "account_updater_schedule_with_result", entopts)
  end
  ...
  # Returns a list of account_updater_schedule_with_result entity maps (BluefinPayconex.Types.account_updater_schedule_with_result/0)
  ...
  @spec list(map(), BluefinPayconex.Types.account_updater_schedule_with_result_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created account_updater_schedule_with_result entity map (BluefinPayconex.Types.account_updater_schedule_with_result/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinPayconex.Types.account_updater_schedule_with_result_create_data() | nil, map() | nil) :: term()
