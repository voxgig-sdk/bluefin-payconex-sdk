...
defmodule BluefinPayconex.Entity.ApplePayMerchantDetail do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "apple_pay_merchant_detail", entopts)
  end
  ...
  # Returns a list of apple_pay_merchant_detail entity maps (BluefinPayconex.Types.apple_pay_merchant_detail/0)
  ...
  @spec list(map(), BluefinPayconex.Types.apple_pay_merchant_detail_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created apple_pay_merchant_detail entity map (BluefinPayconex.Types.apple_pay_merchant_detail/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinPayconex.Types.apple_pay_merchant_detail_create_data() | nil, map() | nil) :: term()
