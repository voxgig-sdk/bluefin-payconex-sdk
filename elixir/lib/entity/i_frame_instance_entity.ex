...
defmodule BluefinPayconex.Entity.IFrameInstance do
  ...
  # Returns the i_frame_instance entity map (BluefinPayconex.Types.i_frame_instance/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinPayconex.Types.i_frame_instance_load_match() | nil, map() | nil) :: term()
