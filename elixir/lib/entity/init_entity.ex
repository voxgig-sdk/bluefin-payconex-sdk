...
defmodule BluefinPayconex.Entity.Init do
  ...
  # Returns the created init entity map (BluefinPayconex.Types.init/0)
  ...
  @spec create(map(), BluefinPayconex.Types.init_create_data() | nil, map() | nil) :: term()
