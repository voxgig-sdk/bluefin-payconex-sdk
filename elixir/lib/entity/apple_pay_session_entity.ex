...
defmodule BluefinPayconex.Entity.ApplePaySession do
  ...
  # Returns the created apple_pay_session entity map (BluefinPayconex.Types.apple_pay_session/0)
  ...
  @spec create(map(), BluefinPayconex.Types.apple_pay_session_create_data() | nil, map() | nil) :: term()
