...
defmodule BluefinPayconex.Entity.Iframe do
  ...
  # Returns the iframe entity map (BluefinPayconex.Types.iframe/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinPayconex.Types.iframe_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of iframe entity maps (BluefinPayconex.Types.iframe/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinPayconex.Types.iframe_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created iframe entity map (BluefinPayconex.Types.iframe/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinPayconex.Types.iframe_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the updated iframe entity map (BluefinPayconex.Types.iframe/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec update(map(), BluefinPayconex.Types.iframe_update_data() | nil, map() | nil) :: term()
