...
defmodule BluefinPayconex.Entity.AccountUpdaterSchedule do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "account_updater_schedule", entopts)
  end
  ...
  # Returns the created account_updater_schedule entity map (BluefinPayconex.Types.account_updater_schedule/0)
  ...
  @spec create(map(), BluefinPayconex.Types.account_updater_schedule_create_data() | nil, map() | nil) :: term()
