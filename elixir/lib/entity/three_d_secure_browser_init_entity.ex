...
defmodule BluefinPayconex.Entity.ThreeDSecureBrowserInit do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "three_d_secure_browser_init", entopts)
  end
  ...
  # Returns the created three_d_secure_browser_init entity map (BluefinPayconex.Types.three_d_secure_browser_init/0)
  ...
  @spec create(map(), BluefinPayconex.Types.three_d_secure_browser_init_create_data() | nil, map() | nil) :: term()
