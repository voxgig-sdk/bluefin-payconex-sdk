...
defmodule BluefinPayconex.Entity.IFrameCreateInstance do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "i_frame_create_instance", entopts)
  end
  ...
  # Returns the created i_frame_create_instance entity map (BluefinPayconex.Types.i_frame_create_instance/0)
  ...
  @spec create(map(), BluefinPayconex.Types.i_frame_create_instance_create_data() | nil, map() | nil) :: term()
