...
defmodule BluefinPayconex.Entity.Webhook do
  ...
  # Returns the webhook entity map (BluefinPayconex.Types.webhook/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinPayconex.Types.webhook_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of webhook entity maps (BluefinPayconex.Types.webhook/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinPayconex.Types.webhook_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created webhook entity map (BluefinPayconex.Types.webhook/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinPayconex.Types.webhook_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the updated webhook entity map (BluefinPayconex.Types.webhook/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec update(map(), BluefinPayconex.Types.webhook_update_data() | nil, map() | nil) :: term()
  ...
  # Returns the removed webhook entity map (BluefinPayconex.Types.webhook/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec remove(map(), BluefinPayconex.Types.webhook_remove_match() | nil, map() | nil) :: term()
