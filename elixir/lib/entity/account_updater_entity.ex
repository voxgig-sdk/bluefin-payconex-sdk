...
defmodule BluefinPayconex.Entity.AccountUpdater do
  ...
  # Returns the removed account_updater entity map (BluefinPayconex.Types.account_updater/0)
  ...
  @spec remove(map(), BluefinPayconex.Types.account_updater_remove_match() | nil, map() | nil) :: term()
