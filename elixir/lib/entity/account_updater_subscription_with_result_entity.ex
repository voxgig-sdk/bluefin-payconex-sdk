...
defmodule BluefinPayconex.Entity.AccountUpdaterSubscriptionWithResult do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "account_updater_subscription_with_result", entopts)
  end
  ...
  # Returns the account_updater_subscription_with_result entity map (BluefinPayconex.Types.account_updater_subscription_with_result/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinPayconex.Types.account_updater_subscription_with_result_load_match() | nil, map() | nil) :: term()
  ...
  # Returns the created account_updater_subscription_with_result entity map (BluefinPayconex.Types.account_updater_subscription_with_result/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinPayconex.Types.account_updater_subscription_with_result_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the updated account_updater_subscription_with_result entity map (BluefinPayconex.Types.account_updater_subscription_with_result/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec update(map(), BluefinPayconex.Types.account_updater_subscription_with_result_update_data() | nil, map() | nil) :: term()
