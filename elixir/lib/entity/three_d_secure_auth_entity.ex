...
defmodule BluefinPayconex.Entity.ThreeDSecureAuth do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "three_d_secure_auth", entopts)
  end
  ...
  # Returns the created three_d_secure_auth entity map (BluefinPayconex.Types.three_d_secure_auth/0)
  ...
  @spec create(map(), BluefinPayconex.Types.three_d_secure_auth_create_data() | nil, map() | nil) :: term()
