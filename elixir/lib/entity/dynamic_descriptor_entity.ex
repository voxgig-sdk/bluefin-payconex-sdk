...
defmodule BluefinPayconex.Entity.DynamicDescriptor do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{EntityBase, Context, Pipeline}

  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "dynamic_descriptor", entopts)
  end
  ...
  # Returns the dynamic_descriptor entity map (BluefinPayconex.Types.dynamic_descriptor/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinPayconex.Types.dynamic_descriptor_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of dynamic_descriptor entity maps (BluefinPayconex.Types.dynamic_descriptor/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinPayconex.Types.dynamic_descriptor_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created dynamic_descriptor entity map (BluefinPayconex.Types.dynamic_descriptor/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinPayconex.Types.dynamic_descriptor_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the updated dynamic_descriptor entity map (BluefinPayconex.Types.dynamic_descriptor/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec update(map(), BluefinPayconex.Types.dynamic_descriptor_update_data() | nil, map() | nil) :: term()
  ...
  # Returns the removed dynamic_descriptor entity map (BluefinPayconex.Types.dynamic_descriptor/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec remove(map(), BluefinPayconex.Types.dynamic_descriptor_remove_match() | nil, map() | nil) :: term()
