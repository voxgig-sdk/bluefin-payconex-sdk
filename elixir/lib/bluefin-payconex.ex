...
defmodule BluefinPayconex do
  alias Voxgig.Struct, as: S
  alias BluefinPayconex.Helpers, as: H
  alias BluefinPayconex.{Utility, Context, Spec}
  ...
  def new(options \\ nil) do
    ...
    config = BluefinPayconex.Config.make_config()
    ...
    if S.islist(feature_order) and S.size(feature_order) > 0 do
      Enum.each(0..(S.size(feature_order) - 1), fn i ->
        ...
        if fom != nil and S.getprop(fom, "active") == true do
          Utility.feature_add(rootctx, BluefinPayconex.Features.make_feature(fname))
        end
      end)
    end
      ...
      _ ->
        ...
        cond do
          ...
          S.ismap(fetched) ->
            ...
            content_length =
              if S.ismap(headers), do: BluefinPayconex.Feature.header_get(headers, "content-length"), else: nil
  ...
  @doc "Entity factory for account_updater."
  def account_updater(client, entopts \\ nil) do
    BluefinPayconex.Entity.AccountUpdater.new(client, entopts)
  end

  @doc "Entity factory for account_updater_schedule."
  def account_updater_schedule(client, entopts \\ nil) do
    BluefinPayconex.Entity.AccountUpdaterSchedule.new(client, entopts)
  end

  @doc "Entity factory for account_updater_schedule_with_result."
  def account_updater_schedule_with_result(client, entopts \\ nil) do
    BluefinPayconex.Entity.AccountUpdaterScheduleWithResult.new(client, entopts)
  end

  @doc "Entity factory for account_updater_subscription_with_result."
  def account_updater_subscription_with_result(client, entopts \\ nil) do
    BluefinPayconex.Entity.AccountUpdaterSubscriptionWithResult.new(client, entopts)
  end

  @doc "Entity factory for account_updater_update."
  def account_updater_update(client, entopts \\ nil) do
    BluefinPayconex.Entity.AccountUpdaterUpdate.new(client, entopts)
  end

  @doc "Entity factory for api_key."
  def api_key(client, entopts \\ nil) do
    BluefinPayconex.Entity.ApiKey.new(client, entopts)
  end

  @doc "Entity factory for apple_pay_merchant_detail."
  def apple_pay_merchant_detail(client, entopts \\ nil) do
    BluefinPayconex.Entity.ApplePayMerchantDetail.new(client, entopts)
  end

  @doc "Entity factory for apple_pay_session."
  def apple_pay_session(client, entopts \\ nil) do
    BluefinPayconex.Entity.ApplePaySession.new(client, entopts)
  end

  @doc "Entity factory for dynamic_descriptor."
  def dynamic_descriptor(client, entopts \\ nil) do
    BluefinPayconex.Entity.DynamicDescriptor.new(client, entopts)
  end

  @doc "Entity factory for i_frame_create_instance."
  def i_frame_create_instance(client, entopts \\ nil) do
    BluefinPayconex.Entity.IFrameCreateInstance.new(client, entopts)
  end

  @doc "Entity factory for i_frame_instance."
  def i_frame_instance(client, entopts \\ nil) do
    BluefinPayconex.Entity.IFrameInstance.new(client, entopts)
  end

  @doc "Entity factory for iframe."
  def iframe(client, entopts \\ nil) do
    BluefinPayconex.Entity.Iframe.new(client, entopts)
  end

  @doc "Entity factory for init."
  def init(client, entopts \\ nil) do
    BluefinPayconex.Entity.Init.new(client, entopts)
  end

  @doc "Entity factory for list_api_key_scopes_entry."
  def list_api_key_scopes_entry(client, entopts \\ nil) do
    BluefinPayconex.Entity.ListApiKeyScopesEntry.new(client, entopts)
  end

  @doc "Entity factory for payment_iframe."
  def payment_iframe(client, entopts \\ nil) do
    BluefinPayconex.Entity.PaymentIframe.new(client, entopts)
  end

  @doc "Entity factory for three_d_secure_auth."
  def three_d_secure_auth(client, entopts \\ nil) do
    BluefinPayconex.Entity.ThreeDSecureAuth.new(client, entopts)
  end

  @doc "Entity factory for three_d_secure_browser_init."
  def three_d_secure_browser_init(client, entopts \\ nil) do
    BluefinPayconex.Entity.ThreeDSecureBrowserInit.new(client, entopts)
  end

  @doc "Entity factory for three_d_secure_status."
  def three_d_secure_status(client, entopts \\ nil) do
    BluefinPayconex.Entity.ThreeDSecureStatus.new(client, entopts)
  end

  @doc "Entity factory for transaction_detail."
  def transaction_detail(client, entopts \\ nil) do
    BluefinPayconex.Entity.TransactionDetail.new(client, entopts)
  end

  @doc "Entity factory for webhook."
  def webhook(client, entopts \\ nil) do
    BluefinPayconex.Entity.Webhook.new(client, entopts)
  end
