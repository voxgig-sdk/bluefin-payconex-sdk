# BluefinPayconex SDK core runtime objects.
#
...
defmodule BluefinPayconex.Control do
...
defmodule BluefinPayconex.Spec do
  alias Voxgig.Struct, as: S
...
defmodule BluefinPayconex.Result do
  alias Voxgig.Struct, as: S
...
defmodule BluefinPayconex.Response do
  alias Voxgig.Struct, as: S
...
defmodule BluefinPayconex.Operation do
  alias Voxgig.Struct, as: S
