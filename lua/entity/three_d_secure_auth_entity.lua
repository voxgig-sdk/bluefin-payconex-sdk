...
local ThreeDSecureAuthEntity = {}
ThreeDSecureAuthEntity.__index = ThreeDSecureAuthEntity


function ThreeDSecureAuthEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ThreeDSecureAuthEntity)
  self._name = "three_d_secure_auth"
  self._client = client
...
function ThreeDSecureAuthEntity:get_name()
  return self._name
end


function ThreeDSecureAuthEntity:make()
  local opts = {}
...
function ThreeDSecureAuthEntity:data_set(args)
  if args ~= nil then
...
function ThreeDSecureAuthEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ThreeDSecureAuthEntity:match_set(args)
  if args ~= nil then
...
function ThreeDSecureAuthEntity:match_get()
...
function ThreeDSecureAuthEntity:stream(action, args, callopts)
...
---@param reqdata ThreeDSecureAuthCreateData
---@param ctrl? table
---@return ThreeDSecureAuth
---@return string? err
function ThreeDSecureAuthEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ThreeDSecureAuthEntity:_run_op(ctx, post_done)
  local utility = self._utility
