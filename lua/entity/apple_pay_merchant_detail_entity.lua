...
local ApplePayMerchantDetailEntity = {}
ApplePayMerchantDetailEntity.__index = ApplePayMerchantDetailEntity


function ApplePayMerchantDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApplePayMerchantDetailEntity)
  self._name = "apple_pay_merchant_detail"
  self._client = client
...
function ApplePayMerchantDetailEntity:get_name()
  return self._name
end


function ApplePayMerchantDetailEntity:make()
  local opts = {}
...
function ApplePayMerchantDetailEntity:data_set(args)
  if args ~= nil then
...
function ApplePayMerchantDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApplePayMerchantDetailEntity:match_set(args)
  if args ~= nil then
...
function ApplePayMerchantDetailEntity:match_get()
...
function ApplePayMerchantDetailEntity:stream(action, args, callopts)
...
---@param reqmatch ApplePayMerchantDetailListMatch
---@param ctrl? table
---@return ApplePayMerchantDetail[]
---@return string? err
function ApplePayMerchantDetailEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ApplePayMerchantDetailCreateData
---@param ctrl? table
---@return ApplePayMerchantDetail
---@return string? err
function ApplePayMerchantDetailEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ApplePayMerchantDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ApplePayMerchantDetailEntity
