...
local PaymentIframeEntity = {}
PaymentIframeEntity.__index = PaymentIframeEntity


function PaymentIframeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PaymentIframeEntity)
  self._name = "payment_iframe"
  self._client = client
...
function PaymentIframeEntity:get_name()
  return self._name
end


function PaymentIframeEntity:make()
  local opts = {}
...
function PaymentIframeEntity:data_set(args)
  if args ~= nil then
...
function PaymentIframeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PaymentIframeEntity:match_set(args)
  if args ~= nil then
...
function PaymentIframeEntity:match_get()
...
function PaymentIframeEntity:stream(action, args, callopts)
...
---@param reqmatch PaymentIframeRemoveMatch
---@param ctrl? table
---@return PaymentIframe
---@return string? err
function PaymentIframeEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function PaymentIframeEntity:_run_op(ctx, post_done)
  local utility = self._utility
