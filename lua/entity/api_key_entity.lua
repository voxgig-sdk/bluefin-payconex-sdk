...
---@param reqmatch ApiKeyLoadMatch
---@param ctrl? table
---@return ApiKey
---@return string? err
function ApiKeyEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ApiKeyListMatch
---@param ctrl? table
---@return ApiKey[]
---@return string? err
function ApiKeyEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ApiKeyUpdateData
---@param ctrl? table
---@return ApiKey
---@return string? err
function ApiKeyEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ApiKeyRemoveMatch
---@param ctrl? table
---@return ApiKey
---@return string? err
function ApiKeyEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
