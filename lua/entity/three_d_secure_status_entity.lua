...
local ThreeDSecureStatusEntity = {}
ThreeDSecureStatusEntity.__index = ThreeDSecureStatusEntity


function ThreeDSecureStatusEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ThreeDSecureStatusEntity)
  self._name = "three_d_secure_status"
  self._client = client
...
function ThreeDSecureStatusEntity:get_name()
  return self._name
end


function ThreeDSecureStatusEntity:make()
  local opts = {}
...
function ThreeDSecureStatusEntity:data_set(args)
  if args ~= nil then
...
function ThreeDSecureStatusEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ThreeDSecureStatusEntity:match_set(args)
  if args ~= nil then
...
function ThreeDSecureStatusEntity:match_get()
...
function ThreeDSecureStatusEntity:stream(action, args, callopts)
...
---@param reqmatch ThreeDSecureStatusLoadMatch
---@param ctrl? table
---@return ThreeDSecureStatus
---@return string? err
function ThreeDSecureStatusEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ThreeDSecureStatusEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ThreeDSecureStatusEntity
