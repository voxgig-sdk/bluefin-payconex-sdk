...
local AccountUpdaterScheduleWithResultEntity = {}
AccountUpdaterScheduleWithResultEntity.__index = AccountUpdaterScheduleWithResultEntity


function AccountUpdaterScheduleWithResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccountUpdaterScheduleWithResultEntity)
  self._name = "account_updater_schedule_with_result"
  self._client = client
...
function AccountUpdaterScheduleWithResultEntity:get_name()
  return self._name
end


function AccountUpdaterScheduleWithResultEntity:make()
  local opts = {}
...
function AccountUpdaterScheduleWithResultEntity:data_set(args)
  if args ~= nil then
...
function AccountUpdaterScheduleWithResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccountUpdaterScheduleWithResultEntity:match_set(args)
  if args ~= nil then
...
function AccountUpdaterScheduleWithResultEntity:match_get()
...
function AccountUpdaterScheduleWithResultEntity:stream(action, args, callopts)
...
---@param reqmatch AccountUpdaterScheduleWithResultListMatch
---@param ctrl? table
---@return AccountUpdaterScheduleWithResult[]
---@return string? err
function AccountUpdaterScheduleWithResultEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AccountUpdaterScheduleWithResultCreateData
---@param ctrl? table
---@return AccountUpdaterScheduleWithResult
---@return string? err
function AccountUpdaterScheduleWithResultEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function AccountUpdaterScheduleWithResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AccountUpdaterScheduleWithResultEntity
