...
local AccountUpdaterSubscriptionWithResultEntity = {}
AccountUpdaterSubscriptionWithResultEntity.__index = AccountUpdaterSubscriptionWithResultEntity


function AccountUpdaterSubscriptionWithResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccountUpdaterSubscriptionWithResultEntity)
  self._name = "account_updater_subscription_with_result"
  self._client = client
...
function AccountUpdaterSubscriptionWithResultEntity:get_name()
  return self._name
end


function AccountUpdaterSubscriptionWithResultEntity:make()
  local opts = {}
...
function AccountUpdaterSubscriptionWithResultEntity:data_set(args)
  if args ~= nil then
...
function AccountUpdaterSubscriptionWithResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccountUpdaterSubscriptionWithResultEntity:match_set(args)
  if args ~= nil then
...
function AccountUpdaterSubscriptionWithResultEntity:match_get()
...
function AccountUpdaterSubscriptionWithResultEntity:stream(action, args, callopts)
...
---@param reqmatch AccountUpdaterSubscriptionWithResultLoadMatch
---@param ctrl? table
---@return AccountUpdaterSubscriptionWithResult
---@return string? err
function AccountUpdaterSubscriptionWithResultEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AccountUpdaterSubscriptionWithResultCreateData
---@param ctrl? table
---@return AccountUpdaterSubscriptionWithResult
---@return string? err
function AccountUpdaterSubscriptionWithResultEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AccountUpdaterSubscriptionWithResultUpdateData
---@param ctrl? table
---@return AccountUpdaterSubscriptionWithResult
---@return string? err
function AccountUpdaterSubscriptionWithResultEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function AccountUpdaterSubscriptionWithResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AccountUpdaterSubscriptionWithResultEntity
