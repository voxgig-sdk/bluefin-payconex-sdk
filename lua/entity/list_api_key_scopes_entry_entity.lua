...
local ListApiKeyScopesEntryEntity = {}
ListApiKeyScopesEntryEntity.__index = ListApiKeyScopesEntryEntity


function ListApiKeyScopesEntryEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListApiKeyScopesEntryEntity)
  self._name = "list_api_key_scopes_entry"
  self._client = client
...
function ListApiKeyScopesEntryEntity:get_name()
  return self._name
end


function ListApiKeyScopesEntryEntity:make()
  local opts = {}
...
function ListApiKeyScopesEntryEntity:data_set(args)
  if args ~= nil then
...
function ListApiKeyScopesEntryEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListApiKeyScopesEntryEntity:match_set(args)
  if args ~= nil then
...
function ListApiKeyScopesEntryEntity:match_get()
...
function ListApiKeyScopesEntryEntity:stream(action, args, callopts)
...
---@param reqmatch ListApiKeyScopesEntryListMatch
---@param ctrl? table
---@return ListApiKeyScopesEntry[]
---@return string? err
function ListApiKeyScopesEntryEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ListApiKeyScopesEntryEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ListApiKeyScopesEntryEntity
