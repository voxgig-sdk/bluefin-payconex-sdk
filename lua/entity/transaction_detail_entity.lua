...
local TransactionDetailEntity = {}
TransactionDetailEntity.__index = TransactionDetailEntity


function TransactionDetailEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TransactionDetailEntity)
  self._name = "transaction_detail"
  self._client = client
...
function TransactionDetailEntity:get_name()
  return self._name
end


function TransactionDetailEntity:make()
  local opts = {}
...
function TransactionDetailEntity:data_set(args)
  if args ~= nil then
...
function TransactionDetailEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TransactionDetailEntity:match_set(args)
  if args ~= nil then
...
function TransactionDetailEntity:match_get()
...
function TransactionDetailEntity:stream(action, args, callopts)
...
---@param reqmatch TransactionDetailLoadMatch
---@param ctrl? table
---@return TransactionDetail
---@return string? err
function TransactionDetailEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata TransactionDetailUpdateData
---@param ctrl? table
---@return TransactionDetail
---@return string? err
function TransactionDetailEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function TransactionDetailEntity:_run_op(ctx, post_done)
  local utility = self._utility
