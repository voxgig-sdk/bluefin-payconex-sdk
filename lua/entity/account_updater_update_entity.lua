...
local AccountUpdaterUpdateEntity = {}
AccountUpdaterUpdateEntity.__index = AccountUpdaterUpdateEntity


function AccountUpdaterUpdateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccountUpdaterUpdateEntity)
  self._name = "account_updater_update"
  self._client = client
...
function AccountUpdaterUpdateEntity:get_name()
  return self._name
end


function AccountUpdaterUpdateEntity:make()
  local opts = {}
...
function AccountUpdaterUpdateEntity:data_set(args)
  if args ~= nil then
...
function AccountUpdaterUpdateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccountUpdaterUpdateEntity:match_set(args)
  if args ~= nil then
...
function AccountUpdaterUpdateEntity:match_get()
...
function AccountUpdaterUpdateEntity:stream(action, args, callopts)
...
---@param reqmatch AccountUpdaterUpdateLoadMatch
---@param ctrl? table
---@return AccountUpdaterUpdate
---@return string? err
function AccountUpdaterUpdateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function AccountUpdaterUpdateEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AccountUpdaterUpdateEntity
