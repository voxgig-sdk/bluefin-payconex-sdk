...
local IFrameInstanceEntity = {}
IFrameInstanceEntity.__index = IFrameInstanceEntity


function IFrameInstanceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IFrameInstanceEntity)
  self._name = "i_frame_instance"
  self._client = client
...
function IFrameInstanceEntity:get_name()
  return self._name
end


function IFrameInstanceEntity:make()
  local opts = {}
...
function IFrameInstanceEntity:data_set(args)
  if args ~= nil then
...
function IFrameInstanceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IFrameInstanceEntity:match_set(args)
  if args ~= nil then
...
function IFrameInstanceEntity:match_get()
...
function IFrameInstanceEntity:stream(action, args, callopts)
...
---@param reqmatch IFrameInstanceLoadMatch
---@param ctrl? table
---@return IFrameInstance
---@return string? err
function IFrameInstanceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function IFrameInstanceEntity:_run_op(ctx, post_done)
  local utility = self._utility
