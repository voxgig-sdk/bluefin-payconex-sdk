...
local DynamicDescriptorEntity = {}
DynamicDescriptorEntity.__index = DynamicDescriptorEntity


function DynamicDescriptorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DynamicDescriptorEntity)
  self._name = "dynamic_descriptor"
  self._client = client
...
function DynamicDescriptorEntity:get_name()
  return self._name
end


function DynamicDescriptorEntity:make()
  local opts = {}
...
function DynamicDescriptorEntity:data_set(args)
  if args ~= nil then
...
function DynamicDescriptorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DynamicDescriptorEntity:match_set(args)
  if args ~= nil then
...
function DynamicDescriptorEntity:match_get()
...
function DynamicDescriptorEntity:stream(action, args, callopts)
...
---@param reqmatch DynamicDescriptorLoadMatch
---@param ctrl? table
---@return DynamicDescriptor
---@return string? err
function DynamicDescriptorEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch DynamicDescriptorListMatch
---@param ctrl? table
---@return DynamicDescriptor[]
---@return string? err
function DynamicDescriptorEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata DynamicDescriptorCreateData
---@param ctrl? table
---@return DynamicDescriptor
---@return string? err
function DynamicDescriptorEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DynamicDescriptorUpdateData
---@param ctrl? table
---@return DynamicDescriptor
---@return string? err
function DynamicDescriptorEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch DynamicDescriptorRemoveMatch
---@param ctrl? table
---@return DynamicDescriptor
---@return string? err
function DynamicDescriptorEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function DynamicDescriptorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return DynamicDescriptorEntity
