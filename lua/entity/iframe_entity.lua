...
local IframeEntity = {}
IframeEntity.__index = IframeEntity


function IframeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IframeEntity)
  self._name = "iframe"
  self._client = client
...
function IframeEntity:get_name()
  return self._name
end


function IframeEntity:make()
  local opts = {}
...
function IframeEntity:data_set(args)
  if args ~= nil then
...
function IframeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IframeEntity:match_set(args)
  if args ~= nil then
...
function IframeEntity:match_get()
...
function IframeEntity:stream(action, args, callopts)
...
---@param reqmatch IframeLoadMatch
---@param ctrl? table
---@return Iframe
---@return string? err
function IframeEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch IframeListMatch
---@param ctrl? table
---@return Iframe[]
---@return string? err
function IframeEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata IframeCreateData
---@param ctrl? table
---@return Iframe
---@return string? err
function IframeEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata IframeUpdateData
---@param ctrl? table
---@return Iframe
---@return string? err
function IframeEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function IframeEntity:_run_op(ctx, post_done)
  local utility = self._utility
