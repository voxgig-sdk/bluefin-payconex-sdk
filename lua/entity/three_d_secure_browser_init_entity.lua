...
local ThreeDSecureBrowserInitEntity = {}
ThreeDSecureBrowserInitEntity.__index = ThreeDSecureBrowserInitEntity


function ThreeDSecureBrowserInitEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ThreeDSecureBrowserInitEntity)
  self._name = "three_d_secure_browser_init"
  self._client = client
...
function ThreeDSecureBrowserInitEntity:get_name()
  return self._name
end


function ThreeDSecureBrowserInitEntity:make()
  local opts = {}
...
function ThreeDSecureBrowserInitEntity:data_set(args)
  if args ~= nil then
...
function ThreeDSecureBrowserInitEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ThreeDSecureBrowserInitEntity:match_set(args)
  if args ~= nil then
...
function ThreeDSecureBrowserInitEntity:match_get()
...
function ThreeDSecureBrowserInitEntity:stream(action, args, callopts)
...
---@param reqdata ThreeDSecureBrowserInitCreateData
---@param ctrl? table
---@return ThreeDSecureBrowserInit
---@return string? err
function ThreeDSecureBrowserInitEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ThreeDSecureBrowserInitEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ThreeDSecureBrowserInitEntity
