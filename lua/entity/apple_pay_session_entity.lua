...
local ApplePaySessionEntity = {}
ApplePaySessionEntity.__index = ApplePaySessionEntity


function ApplePaySessionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ApplePaySessionEntity)
  self._name = "apple_pay_session"
  self._client = client
...
function ApplePaySessionEntity:get_name()
  return self._name
end


function ApplePaySessionEntity:make()
  local opts = {}
...
function ApplePaySessionEntity:data_set(args)
  if args ~= nil then
...
function ApplePaySessionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ApplePaySessionEntity:match_set(args)
  if args ~= nil then
...
function ApplePaySessionEntity:match_get()
...
function ApplePaySessionEntity:stream(action, args, callopts)
...
---@param reqdata ApplePaySessionCreateData
---@param ctrl? table
---@return ApplePaySession
---@return string? err
function ApplePaySessionEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ApplePaySessionEntity:_run_op(ctx, post_done)
  local utility = self._utility
