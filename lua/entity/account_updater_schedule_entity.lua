...
local AccountUpdaterScheduleEntity = {}
AccountUpdaterScheduleEntity.__index = AccountUpdaterScheduleEntity


function AccountUpdaterScheduleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccountUpdaterScheduleEntity)
  self._name = "account_updater_schedule"
  self._client = client
...
function AccountUpdaterScheduleEntity:get_name()
  return self._name
end


function AccountUpdaterScheduleEntity:make()
  local opts = {}
...
function AccountUpdaterScheduleEntity:data_set(args)
  if args ~= nil then
...
function AccountUpdaterScheduleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccountUpdaterScheduleEntity:match_set(args)
  if args ~= nil then
...
function AccountUpdaterScheduleEntity:match_get()
...
function AccountUpdaterScheduleEntity:stream(action, args, callopts)
...
---@param reqdata AccountUpdaterScheduleCreateData
---@param ctrl? table
---@return AccountUpdaterSchedule
---@return string? err
function AccountUpdaterScheduleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function AccountUpdaterScheduleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AccountUpdaterScheduleEntity
