...
local IFrameCreateInstanceEntity = {}
IFrameCreateInstanceEntity.__index = IFrameCreateInstanceEntity


function IFrameCreateInstanceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, IFrameCreateInstanceEntity)
  self._name = "i_frame_create_instance"
  self._client = client
...
function IFrameCreateInstanceEntity:get_name()
  return self._name
end


function IFrameCreateInstanceEntity:make()
  local opts = {}
...
function IFrameCreateInstanceEntity:data_set(args)
  if args ~= nil then
...
function IFrameCreateInstanceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function IFrameCreateInstanceEntity:match_set(args)
  if args ~= nil then
...
function IFrameCreateInstanceEntity:match_get()
...
function IFrameCreateInstanceEntity:stream(action, args, callopts)
...
---@param reqdata IFrameCreateInstanceCreateData
---@param ctrl? table
---@return IFrameCreateInstance
---@return string? err
function IFrameCreateInstanceEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function IFrameCreateInstanceEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return IFrameCreateInstanceEntity
