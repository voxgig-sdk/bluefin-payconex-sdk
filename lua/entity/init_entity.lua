...
local InitEntity = {}
InitEntity.__index = InitEntity


function InitEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, InitEntity)
  self._name = "init"
  self._client = client
...
function InitEntity:get_name()
  return self._name
end


function InitEntity:make()
  local opts = {}
...
function InitEntity:data_set(args)
  if args ~= nil then
...
function InitEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function InitEntity:match_set(args)
  if args ~= nil then
...
function InitEntity:stream(action, args, callopts)
...
---@param reqdata InitCreateData
---@param ctrl? table
---@return Init
---@return string? err
function InitEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function InitEntity:_run_op(ctx, post_done)
  local utility = self._utility
