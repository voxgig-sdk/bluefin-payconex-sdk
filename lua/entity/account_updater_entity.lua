...
local AccountUpdaterEntity = {}
AccountUpdaterEntity.__index = AccountUpdaterEntity


function AccountUpdaterEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccountUpdaterEntity)
  self._name = "account_updater"
  self._client = client
...
function AccountUpdaterEntity:get_name()
  return self._name
end


function AccountUpdaterEntity:make()
  local opts = {}
...
function AccountUpdaterEntity:data_set(args)
  if args ~= nil then
...
function AccountUpdaterEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccountUpdaterEntity:match_set(args)
  if args ~= nil then
...
function AccountUpdaterEntity:match_get()
...
function AccountUpdaterEntity:stream(action, args, callopts)
...
---@param reqmatch AccountUpdaterRemoveMatch
---@param ctrl? table
---@return AccountUpdater
---@return string? err
function AccountUpdaterEntity:remove(reqmatch, ctrl)
  local utility = self._utility
...
function AccountUpdaterEntity:_run_op(ctx, post_done)
  local utility = self._utility
