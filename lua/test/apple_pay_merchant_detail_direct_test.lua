...
describe("ApplePayMerchantDetailDirect", function()
  it("should direct-list-apple_pay_merchant_detail", function()
    local setup = apple_pay_merchant_detail_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-apple_pay_merchant_detail", setup.live and "live" or "unit")
...
function apple_pay_merchant_detail_direct_setup(mockres)
