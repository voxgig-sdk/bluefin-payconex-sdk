...
describe("AccountUpdaterUpdateDirect", function()
  it("should direct-load-account_updater_update", function()
    local setup = account_updater_update_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-account_updater_update", setup.live and "live" or "unit")
...
function account_updater_update_direct_setup(mockres)
