...
describe("ThreeDSecureStatusDirect", function()
  it("should direct-load-three_d_secure_status", function()
    local setup = three_d_secure_status_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-three_d_secure_status", setup.live and "live" or "unit")
