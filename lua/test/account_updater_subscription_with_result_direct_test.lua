...
describe("AccountUpdaterSubscriptionWithResultDirect", function()
  it("should direct-load-account_updater_subscription_with_result", function()
    local setup = account_updater_subscription_with_result_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-account_updater_subscription_with_result", setup.live and "live" or "unit")
...
function account_updater_subscription_with_result_direct_setup(mockres)
