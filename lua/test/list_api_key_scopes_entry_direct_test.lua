...
describe("ListApiKeyScopesEntryDirect", function()
  it("should direct-list-list_api_key_scopes_entry", function()
    local setup = list_api_key_scopes_entry_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-list_api_key_scopes_entry", setup.live and "live" or "unit")
...
function list_api_key_scopes_entry_direct_setup(mockres)
