...
describe("DynamicDescriptorDirect", function()
  it("should direct-list-dynamic_descriptor", function()
    local setup = dynamic_descriptor_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-dynamic_descriptor", setup.live and "live" or "unit")
  ...
  it("should direct-load-dynamic_descriptor", function()
    local setup = dynamic_descriptor_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-dynamic_descriptor", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function dynamic_descriptor_direct_setup(mockres)
