...
describe("WebhookEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set BLUEFINPAYCONEX_TEST_WEBHOOK_ENTID JSON to run live")
      return
    end
    ...
    local webhook_ref01_markdef_up0_name = "event"
...
function webhook_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("BLUEFINPAYCONEX_TEST_WEBHOOK_ENTID")
