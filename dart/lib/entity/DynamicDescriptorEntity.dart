...
// Typed models: see ../BluefinPayconexTypes.dart (DynamicDescriptor and the per-op request/match types).
class DynamicDescriptorEntity extends BluefinPayconexEntityBase {
  DynamicDescriptorEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'dynamic_descriptor';
    name_ = 'dynamic_descriptor';
    Name = 'DynamicDescriptor';
  }

  DynamicDescriptorEntity make() {
    return DynamicDescriptorEntity(client, entopts());
  }


  /// Load a DynamicDescriptor by match (see DynamicDescriptorLoadMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (DynamicDescriptor).
  ...
  /// List DynamicDescriptor entities by match (see DynamicDescriptorListMatch in
  /// BluefinPayconexTypes.dart). Returns a list of DynamicDescriptor entity instances.
  ...
  /// Create a DynamicDescriptor (see DynamicDescriptorCreateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (DynamicDescriptor).
  ...
  /// Update a DynamicDescriptor (see DynamicDescriptorUpdateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (DynamicDescriptor).
  ...
  /// Remove a DynamicDescriptor by match (see DynamicDescriptorRemoveMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (DynamicDescriptor).
