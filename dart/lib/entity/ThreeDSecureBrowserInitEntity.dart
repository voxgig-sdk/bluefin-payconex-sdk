...
// Typed models: see ../BluefinPayconexTypes.dart (ThreeDSecureBrowserInit and the per-op request/match types).
class ThreeDSecureBrowserInitEntity extends BluefinPayconexEntityBase {
  ThreeDSecureBrowserInitEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'three_d_secure_browser_init';
    name_ = 'three_d_secure_browser_init';
    Name = 'ThreeDSecureBrowserInit';
  }

  ThreeDSecureBrowserInitEntity make() {
    return ThreeDSecureBrowserInitEntity(client, entopts());
  }




  /// Create a ThreeDSecureBrowserInit (see ThreeDSecureBrowserInitCreateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (ThreeDSecureBrowserInit).
