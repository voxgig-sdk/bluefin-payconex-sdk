...
// Typed models: see ../BluefinPayconexTypes.dart (ListApiKeyScopesEntry and the per-op request/match types).
class ListApiKeyScopesEntryEntity extends BluefinPayconexEntityBase {
  ListApiKeyScopesEntryEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'list_api_key_scopes_entry';
    name_ = 'list_api_key_scopes_entry';
    Name = 'ListApiKeyScopesEntry';
  }

  ListApiKeyScopesEntryEntity make() {
    return ListApiKeyScopesEntryEntity(client, entopts());
  }



  /// List ListApiKeyScopesEntry entities by match (see ListApiKeyScopesEntryListMatch in
  /// BluefinPayconexTypes.dart). Returns a list of ListApiKeyScopesEntry entity instances.
