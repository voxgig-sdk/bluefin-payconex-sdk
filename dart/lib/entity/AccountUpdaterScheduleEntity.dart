...
// Typed models: see ../BluefinPayconexTypes.dart (AccountUpdaterSchedule and the per-op request/match types).
class AccountUpdaterScheduleEntity extends BluefinPayconexEntityBase {
  AccountUpdaterScheduleEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'account_updater_schedule';
    name_ = 'account_updater_schedule';
    Name = 'AccountUpdaterSchedule';
  }

  AccountUpdaterScheduleEntity make() {
    return AccountUpdaterScheduleEntity(client, entopts());
  }




  /// Create a AccountUpdaterSchedule (see AccountUpdaterScheduleCreateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (AccountUpdaterSchedule).
