...
// Typed models: see ../BluefinPayconexTypes.dart (AccountUpdaterUpdate and the per-op request/match types).
class AccountUpdaterUpdateEntity extends BluefinPayconexEntityBase {
  AccountUpdaterUpdateEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'account_updater_update';
    name_ = 'account_updater_update';
    Name = 'AccountUpdaterUpdate';
  }

  AccountUpdaterUpdateEntity make() {
    return AccountUpdaterUpdateEntity(client, entopts());
  }


  /// Load a AccountUpdaterUpdate by match (see AccountUpdaterUpdateLoadMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (AccountUpdaterUpdate).
