...
// Typed models: see ../BluefinPayconexTypes.dart (PaymentIframe and the per-op request/match types).
class PaymentIframeEntity extends BluefinPayconexEntityBase {
  PaymentIframeEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'payment_iframe';
    name_ = 'payment_iframe';
    Name = 'PaymentIframe';
  }

  PaymentIframeEntity make() {
    return PaymentIframeEntity(client, entopts());
  }
  ...
  /// Remove a PaymentIframe by match (see PaymentIframeRemoveMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (PaymentIframe).
