...
// Typed models: see ../BluefinPayconexTypes.dart (Init and the per-op request/match types).
class InitEntity extends BluefinPayconexEntityBase {
  InitEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'init';
    name_ = 'init';
    Name = 'Init';
  }
  ...
  InitEntity make() {
    return InitEntity(client, entopts());
  }




  /// Create a Init (see InitCreateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (Init).
