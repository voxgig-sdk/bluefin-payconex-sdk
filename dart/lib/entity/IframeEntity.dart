...
// Typed models: see ../BluefinPayconexTypes.dart (Iframe and the per-op request/match types).
class IframeEntity extends BluefinPayconexEntityBase {
  IframeEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'iframe';
    name_ = 'iframe';
    Name = 'Iframe';
  }
  ...
  IframeEntity make() {
    return IframeEntity(client, entopts());
  }


  /// Load a Iframe by match (see IframeLoadMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (Iframe).
  ...
  /// List Iframe entities by match (see IframeListMatch in
  /// BluefinPayconexTypes.dart). Returns a list of Iframe entity instances.
  ...
  /// Create a Iframe (see IframeCreateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (Iframe).
  ...
  /// Update a Iframe (see IframeUpdateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (Iframe).
