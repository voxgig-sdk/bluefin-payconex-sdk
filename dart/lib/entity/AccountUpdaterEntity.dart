...
// Typed models: see ../BluefinPayconexTypes.dart (AccountUpdater and the per-op request/match types).
class AccountUpdaterEntity extends BluefinPayconexEntityBase {
  AccountUpdaterEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'account_updater';
    name_ = 'account_updater';
    Name = 'AccountUpdater';
  }

  AccountUpdaterEntity make() {
    return AccountUpdaterEntity(client, entopts());
  }
  ...
  /// Remove a AccountUpdater by match (see AccountUpdaterRemoveMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (AccountUpdater).
