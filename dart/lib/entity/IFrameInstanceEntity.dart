...
// Typed models: see ../BluefinPayconexTypes.dart (IFrameInstance and the per-op request/match types).
class IFrameInstanceEntity extends BluefinPayconexEntityBase {
  IFrameInstanceEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'i_frame_instance';
    name_ = 'i_frame_instance';
    Name = 'IFrameInstance';
  }

  IFrameInstanceEntity make() {
    return IFrameInstanceEntity(client, entopts());
  }


  /// Load a IFrameInstance by match (see IFrameInstanceLoadMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (IFrameInstance).
