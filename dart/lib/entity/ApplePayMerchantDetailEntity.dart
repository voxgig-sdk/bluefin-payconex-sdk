...
// Typed models: see ../BluefinPayconexTypes.dart (ApplePayMerchantDetail and the per-op request/match types).
class ApplePayMerchantDetailEntity extends BluefinPayconexEntityBase {
  ApplePayMerchantDetailEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'apple_pay_merchant_detail';
    name_ = 'apple_pay_merchant_detail';
    Name = 'ApplePayMerchantDetail';
  }

  ApplePayMerchantDetailEntity make() {
    return ApplePayMerchantDetailEntity(client, entopts());
  }



  /// List ApplePayMerchantDetail entities by match (see ApplePayMerchantDetailListMatch in
  /// BluefinPayconexTypes.dart). Returns a list of ApplePayMerchantDetail entity instances.
  ...
  /// Create a ApplePayMerchantDetail (see ApplePayMerchantDetailCreateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (ApplePayMerchantDetail).
