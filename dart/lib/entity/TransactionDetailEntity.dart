...
// Typed models: see ../BluefinPayconexTypes.dart (TransactionDetail and the per-op request/match types).
class TransactionDetailEntity extends BluefinPayconexEntityBase {
  TransactionDetailEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'transaction_detail';
    name_ = 'transaction_detail';
    Name = 'TransactionDetail';
  }

  TransactionDetailEntity make() {
    return TransactionDetailEntity(client, entopts());
  }


  /// Load a TransactionDetail by match (see TransactionDetailLoadMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (TransactionDetail).
  ...
  /// Update a TransactionDetail (see TransactionDetailUpdateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (TransactionDetail).
