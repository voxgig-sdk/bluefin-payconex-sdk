...
// Typed models: see ../BluefinPayconexTypes.dart (ThreeDSecureAuth and the per-op request/match types).
class ThreeDSecureAuthEntity extends BluefinPayconexEntityBase {
  ThreeDSecureAuthEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'three_d_secure_auth';
    name_ = 'three_d_secure_auth';
    Name = 'ThreeDSecureAuth';
  }

  ThreeDSecureAuthEntity make() {
    return ThreeDSecureAuthEntity(client, entopts());
  }




  /// Create a ThreeDSecureAuth (see ThreeDSecureAuthCreateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (ThreeDSecureAuth).
