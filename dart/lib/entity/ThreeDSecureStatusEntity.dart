...
// Typed models: see ../BluefinPayconexTypes.dart (ThreeDSecureStatus and the per-op request/match types).
class ThreeDSecureStatusEntity extends BluefinPayconexEntityBase {
  ThreeDSecureStatusEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'three_d_secure_status';
    name_ = 'three_d_secure_status';
    Name = 'ThreeDSecureStatus';
  }

  ThreeDSecureStatusEntity make() {
    return ThreeDSecureStatusEntity(client, entopts());
  }


  /// Load a ThreeDSecureStatus by match (see ThreeDSecureStatusLoadMatch in
  /// BluefinPayconexTypes.dart). Returns the entity data map (ThreeDSecureStatus).
