...
// Typed models: see ../BluefinPayconexTypes.dart (ApplePaySession and the per-op request/match types).
class ApplePaySessionEntity extends BluefinPayconexEntityBase {
  ApplePaySessionEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'apple_pay_session';
    name_ = 'apple_pay_session';
    Name = 'ApplePaySession';
  }

  ApplePaySessionEntity make() {
    return ApplePaySessionEntity(client, entopts());
  }




  /// Create a ApplePaySession (see ApplePaySessionCreateData in
  /// BluefinPayconexTypes.dart). Returns the entity data map (ApplePaySession).
