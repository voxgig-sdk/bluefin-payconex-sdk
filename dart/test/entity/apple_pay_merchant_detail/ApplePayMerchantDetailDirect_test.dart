...
void tests() {
  describe('ApplePayMerchantDetailDirect', () {
    ...
    test('direct-list-apple_pay_merchant_detail', (t) async {
      final setup = directSetup([
        {'id': 'direct01'},
        {'id': 'direct02'}
      ]);
      if (maybeSkipControl(
          t, 'direct', 'direct-list-apple_pay_merchant_detail', true == setup['live'])) {
        return;
      }
...
Map<String, dynamic> directSetup([dynamic mockres]) {
  ...
  final env = envOverride({
    'BLUEFINPAYCONEX_TEST_APPLE_PAY_MERCHANT_DETAIL_ENTID': <String, dynamic>{},
  ...
  if (live) {
    ...
    dynamic idmap = env['BLUEFINPAYCONEX_TEST_APPLE_PAY_MERCHANT_DETAIL_ENTID'];
