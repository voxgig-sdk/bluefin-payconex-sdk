// BluefinPayconex SDK — documentation dart-examples presence & completeness gate.
...
const String _sdkClass = 'BluefinPayconexSDK';

// The API's capitalised semantic entities, used to spot a client.<Entity>()
// factory call inside a block.
const List<String> _entities = <String>['AccountUpdater', 'AccountUpdaterSchedule', 'AccountUpdaterScheduleWithResult', 'AccountUpdaterSubscriptionWithResult', 'AccountUpdaterUpdate', 'ApiKey', 'ApplePayMerchantDetail', 'ApplePaySession', 'DynamicDescriptor', 'IFrameCreateInstance', 'IFrameInstance', 'Iframe', 'Init', 'ListApiKeyScopesEntry', 'PaymentIframe', 'ThreeDSecureAuth', 'ThreeDSecureBrowserInit', 'ThreeDSecureStatus', 'TransactionDetail', 'Webhook'];
