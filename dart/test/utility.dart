...
Map<String, dynamic> envOverride(Map<String, dynamic> m) {
  ...
  if ('TRUE' == env['BLUEFINPAYCONEX_TEST_LIVE'] ||
      'TRUE' == env['BLUEFINPAYCONEX_TEST_OVERRIDE']) {
  ...
  m['BLUEFINPAYCONEX_TEST_EXPLAIN'] =
      env['BLUEFINPAYCONEX_TEST_EXPLAIN'] ?? m['BLUEFINPAYCONEX_TEST_EXPLAIN'];
